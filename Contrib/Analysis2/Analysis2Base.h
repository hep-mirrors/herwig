// -*- C++ -*-
//
// Analysis2Base.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_Analysis2Base_H
#define HERWIG_Analysis2Base_H
//
...
/**\ingroup Analysis2
 *
 * Analysis2 is the base class for all Herwig++
...
public:
   ...
   * Herwig++ into the histogram. Events are booked to this
   * channel by default.
   */
   ...
   * data file. A channel Herwig++ is inserted.
   */
  inline void insertObservable (const string& name,
   ...
   * to is named Herwig++
   */
  void book (double evt, const string& name);
   ...
   *
   * If a channel Herwig++ is found, this is normalized
   ...
   * channels named Herwig++-[Multiplicity] are summed up
   * to a channel named "Herwig++", which is in turn normalized
   * as a single Herwig++ channel.
   *
   * If a data channel name is indicated, the ratio
   * and chi2 are computed taking Herwig++ as prediction.
...
template <>
struct BaseClassTrait<Herwig::Analysis2Base,1> {
...
template <>
struct ClassTraits<Herwig::Analysis2Base>
  : public ClassTraitsBase<Herwig::Analysis2Base> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::Analysis2Base"; }
  /**
