// -*- C++ -*-
//
// FourJetCorrelations.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
 ...
 */
class FourJetCorrelations: public Herwig::Analysis2Base {
...
template <>
struct BaseClassTrait<Herwig::FourJetCorrelations,1> {
  /** Typedef of the first base class of FourJetCorrelations. */
  typedef Herwig::Analysis2Base NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the FourJetCorrelations class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::FourJetCorrelations>
  : public ClassTraitsBase<Herwig::FourJetCorrelations> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::FourJetCorrelations"; }
  /**
