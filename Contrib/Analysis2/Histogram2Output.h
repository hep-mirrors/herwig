// -*- C++ -*-
//
// Histogram2Output.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_Histogram2Output_H
#define HERWIG_Histogram2Output_H
//
...
template <>
struct BaseClassTrait<Herwig::Histogram2Output,1> {
...
template <>
struct ClassTraits<Herwig::Histogram2Output>
  : public ClassTraitsBase<Herwig::Histogram2Output> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::Histogram2Output"; }
};
...
#endif /* HERWIG_Histogram2Output_H */
