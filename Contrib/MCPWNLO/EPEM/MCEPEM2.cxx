...
int main() {
  ...
  int seed = user.rseed();
  int nf = user.nf();
  bool massive = user.massive();
  bool resolve = user.resolve();
  bool boost = user.bst();
  if (massive) {boost=false;}
  ...
  mq[6]=0.75; // nominal gluon mass
  
 if (massive) {
      mq[1] = 0.325; mq[2] = 0.325; mq[3] = 0.5; mq[4] = 1.6; mq[5] = 5.;} else 
     {mq[1] = 0.; mq[2] = 0.; mq[3] = 0.; mq[4] = 0.; mq[5] = 0.;} 
...
//               <<"/" << bigwt[ic] << "\t" << xsec << endl;
  ...
  int ICOLUP[3][9],MOTHUP[3][9],ISTUP[9],ISPINUP[9],IDUP[9],NUP;
  NUP=0;
  SCALUP = emcm;
  AQEDUP=0.007297352;
  AQCDUP=0.118;
...
// Parameters for NLO cross-section calculation.
  ...
  if (Jt==1||Jt==3) {
   ...
   double r4=random(seed);
    ...
    double px3 = sqrt(pow(0.5*emcm*x3,2)-pow(mg,2));
	...
	ppt = sqrt (pow(px2,2)-pow(ppl,2));}else {ppt = -sqrt (pow(px2,2)-pow(ppl,2));}
      ...
      if (random(seed) < 0.5) {
	//	cout << "here3" << endl;
	ppt = sqrt (pow(px1,2)-pow(ppl,2));}else {//  cout << "here4" << endl;
	...
	ICOLUP[1][6] = 502;
	ICOLUP[2][6] = 501;
	ICOLUP[1][7] = ICOLUP[1][4];
	ICOLUP[2][7] = ICOLUP[2][4];
	ICOLUP[1][8] = 0;
	ICOLUP[2][8] = 502;
      } else {
      ICOLUP[1][6] = 501;
      ICOLUP[2][6] = 502;
      ICOLUP[1][8] = ICOLUP[1][5];
      ICOLUP[2][8] = ICOLUP[2][5];
      ICOLUP[1][7] = 502;
      ICOLUP[2][7] = 0;
      }
      //Number of particles
    ...
    //Number of particles
     ...
     double pg = sqrt(pow(PUP[1][6],2)+pow(PUP[2][6],2)+pow(PUP[3][6],2));
       ...
       Eg =  sqrt(pow(mb,2)+alpha*pow(pg,2));
       if (NUP==8) {
     ...
     PUP[1][7] =sqrt(alpha)*PUP[1][4];
     PUP[2][7] =sqrt(alpha)*PUP[2][4];
     PUP[3][7] =sqrt(alpha)*PUP[3][4];
     PUP[4][7] =Eq;
     PUP[1][8] =sqrt(alpha)*PUP[1][5];
     PUP[2][8] =sqrt(alpha)*PUP[2][5];
     PUP[3][8] =sqrt(alpha)*PUP[3][5];
     PUP[4][8] =Eqb;
     ...
     if (qg) {
       ...
       PUP[2][4] = PUP[2][7];
       PUP[3][4] = PUP[3][7];
       PUP[4][5] = PUP[4][6]+PUP[4][8];
       PUP[1][5] = PUP[1][6]+PUP[1][8];
       PUP[2][5] = PUP[2][6]+PUP[2][8];
       PUP[3][5] = PUP[3][6]+PUP[3][8];
       if (!massive) {
	 mass[4] = 0.; 
	 mass[7] = 0.;
         mass[8] = 0.;
       ...
       mass[5] = sqrt(pow(PUP[4][5],2)-pow(PUP[3][5],2)-pow(PUP[2][5],2)-pow(PUP[1][5],2));
       } else {
       PUP[4][5] = PUP[4][8];
       PUP[1][5] = PUP[1][8];
       PUP[2][5] = PUP[2][8];
       PUP[3][5] = PUP[3][8];
       PUP[4][4] = PUP[4][6]+PUP[4][7];
       PUP[1][4] = PUP[1][6]+PUP[1][7];
       PUP[2][4] = PUP[2][6]+PUP[2][7];
       PUP[3][4] = PUP[3][6]+PUP[3][7];
       if (!massive) {
	 mass[5] = 0.;
	 mass[7] = 0.;
	 mass[8] = 0.;
       ...
       mass[4] = sqrt(pow(PUP[4][4],2)-pow(PUP[3][4],2)-pow(PUP[2][4],2)-pow(PUP[1][4],2));
       }
     ...
     ISPINUP[7]=ISPINUP[4]; ISPINUP[8]=ISPINUP[5];
