// -*- C++ -*-
//
// GnuplotOutput.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_GnuplotOutput_H
#define HERWIG_GnuplotOutput_H
//
...
template <>
struct BaseClassTrait<Herwig::GnuplotOutput,1> {
  /** Typedef of the first base class of GnuplotOutput. */
  typedef Herwig::Histogram2Output NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the GnuplotOutput class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::GnuplotOutput>
  : public ClassTraitsBase<Herwig::GnuplotOutput> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::GnuplotOutput"; }
  /**
