...
private:
   ...
   */
  static ClassDescription<UEDF1F1P0Vertex> initUEDF1F1P0Vertex;
...
template <>
struct BaseClassTrait<Herwig::Helicity::UEDF1F1P0Vertex,1> {
...
template <>
struct ClassTraits<Herwig::Helicity::UEDF1F1P0Vertex>
  : public ClassTraitsBase<Herwig::Helicity::UEDF1F1P0Vertex> {
