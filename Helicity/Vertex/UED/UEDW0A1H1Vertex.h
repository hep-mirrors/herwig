...
template <>
struct BaseClassTrait<Herwig::Helicity::UEDW0A1H1Vertex,1> {
...
template <>
struct ClassTraits<Herwig::Helicity::UEDW0A1H1Vertex>
  : public ClassTraitsBase<Herwig::Helicity::UEDW0A1H1Vertex> {
   ...
   */
  static string library() { return "UEDVertex.so"; }
};
