...
template <>
struct BaseClassTrait<Herwig::Helicity::UEDF1F1Z0Vertex,1> {
...
template <>
struct ClassTraits<Herwig::Helicity::UEDF1F1Z0Vertex>
  : public ClassTraitsBase<Herwig::Helicity::UEDF1F1Z0Vertex> {
