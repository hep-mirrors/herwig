...
//
// This is the declaration of the <!id>SMFFGVertex<!!id> class.
//
...
public:
  ...
  inline SMFFGVertex();
  inline SMFFGVertex(const SMFFGVertex &);
  virtual ~SMFFGVertex();
...
namespace ThePEG {
  ...
  template <>
  struct BaseClassTrait<Herwig::Helicity::SMFFGVertex,1> {
  ...
  template <>
  struct ClassTraits<Herwig::Helicity::SMFFGVertex>
    : public ClassTraitsBase<Herwig::Helicity::SMFFGVertex> {
    static string className() { return "/Herwig++/Helicity/SMFFGVertex"; }
