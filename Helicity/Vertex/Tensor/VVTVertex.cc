...
void VVTVertex::persistentOutput(PersistentOStream & os) const { }

void VVTVertex::persistentInput(PersistentIStream & is, int) { }

AbstractClassDescription<VVTVertex> VVTVertex::initVVTVertex;
