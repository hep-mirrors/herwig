...
//
// This is the declaration of the <!id>VVTVertex<!!id> class.
//
// CLASSDOC SUBSECTION Description:
//
//  The <!id>VVTVertex<!!id> class is the implementation of the vector-vector-tensor
...
private:
  ...
  static ClassDescription<VVTVertex> initVVTVertex;
