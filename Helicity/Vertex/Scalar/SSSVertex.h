...
//
// This is the declaration of the <!id>SSSVertex<!!id> class.
//
// CLASSDOC SUBSECTION Description:
//
//  The <!id>SSSVertex<!!id> class is the implementation of the interaction of
...
private:
  ...
  static ClassDescription<SSSVertex> initSSSVertex;
