...
//
// This is the declaration of the <!id>VVSVertex<!!id> class.
//
// CLASSDOC SUBSECTION Description:
//
// The <!id>VVSVertex<!!id> class is the implementation of the vector-vector-scalar.
...
private:
  ...
  static ClassDescription<VVSVertex> initVVSVertex;
