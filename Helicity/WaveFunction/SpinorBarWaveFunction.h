...
public:
   ...
   * @param drep The Dirac representation.
   */
  inline SpinorBarWaveFunction(LorentzVector p,const tcPDPtr & part,int ihel,
   ...
   * @param drep The Dirac representation.
   */
  inline SpinorBarWaveFunction(Energy m,const tcPDPtr & part,int ihel,Direction dir,
			       DiracRep drep=defaultDRep);
   ...
   * @param drep The Dirac representation.
   */
  inline SpinorBarWaveFunction(LorentzVector p,Energy m,const tcPDPtr & part,int ihel,
			       Direction dir,DiracRep drep=defaultDRep);
