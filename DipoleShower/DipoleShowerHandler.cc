...
double DipoleShowerHandler::reweightCKKW(int, int,bool fast) {
  
  
 
  //cout<<"\nDipoleShowerHandler::reweightCKKW"; 
  setCurrentHandler();
  ...
  if (theMergingHelper&&!theMergingHelper->reweightCKKWSingle(dynamic_ptr_cast<Ptr<MatchboxXComb>::ptr>(lastXCombPtr()), res,fast))
      return 0.;
