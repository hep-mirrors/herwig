...
public:
   ...
   * Return the binning
   */
  inline vector<pair<double,double> > binning () const;

  /**
   * Return the bin hash map
   */
  inline map<double,unsigned int> binhash () const;
...
template <>
struct BaseClassTrait<Herwig::Histogram2,1> {
...
template <>
struct ClassTraits<Herwig::Histogram2>
  : public ClassTraitsBase<Herwig::Histogram2> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::Histogram2"; }
};
