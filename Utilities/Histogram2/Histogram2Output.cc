// -*- C++ -*-
//
// Histogram2Output.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the Histogram2Output class.
//
...
void Histogram2Output::put (Histogram2Ptr histo, const Histogram2Options& options, const string&) {
  ...
  currentOStream () << "# The following histograms have been produced by\n"
		    ...
		    << "# should be provided along with the Herwig++ source code."
		    << endl;
