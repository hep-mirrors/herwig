...
template <>
struct BaseClassTrait<Herwig::Helicity::UEDZ0A1h1Vertex,1> {
...
template <>
struct ClassTraits<Herwig::Helicity::UEDZ0A1h1Vertex>
  : public ClassTraitsBase<Herwig::Helicity::UEDZ0A1h1Vertex> {
