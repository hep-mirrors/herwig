...
private:
   ...
   */
  static ClassDescription<UEDF1F0G1Vertex> initUEDF1F0G1Vertex;
...
template <>
struct BaseClassTrait<Herwig::Helicity::UEDF1F0G1Vertex,1> {
...
template <>
struct ClassTraits<Herwig::Helicity::UEDF1F0G1Vertex>
  : public ClassTraitsBase<Herwig::Helicity::UEDF1F0G1Vertex> {
