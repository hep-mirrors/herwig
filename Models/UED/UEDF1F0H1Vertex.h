...
template <>
struct BaseClassTrait<Herwig::Helicity::UEDF1F0H1Vertex,1> {
...
template <>
struct ClassTraits<Herwig::Helicity::UEDF1F0H1Vertex>
  : public ClassTraitsBase<Herwig::Helicity::UEDF1F0H1Vertex> {
