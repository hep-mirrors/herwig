// -*- C++ -*-
//
// RPVNNPVertex.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2011 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_RPVNNPVertex_H
#define HERWIG_RPVNNPVertex_H
//
// This is the declaration of the RPVNNPVertex class.
//
 ...
 *
 * @see \ref RPVNNPVertexInterfaces "The interfaces"
 * defined for RPVNNPVertex.
 * @see FFVertex
 */
class RPVNNPVertex: public GeneralFFVVertex {
...
private:
   ...
   */
  RPVNNPVertex & operator=(const RPVNNPVertex &);
...
private:
   ...
   */
  tMixingMatrixPtr Umix_;

  /**
   * Store the V-type chargino mixing matrix
   */
  tMixingMatrixPtr Vmix_;
   ...
   */
  complex<InvEnergy> leftLast_;

  /**
   * Store the value of the right-coupling when it was last evalutated
   */
  complex<InvEnergy> rightLast_;
};
}

#endif /* HERWIG_RPVNNPVertex_H */
