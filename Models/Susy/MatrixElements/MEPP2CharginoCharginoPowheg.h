// -*- C++ -*-
#ifndef HERWIG_MEPP2CharginoCharginoPowheg_H
#define HERWIG_MEPP2CharginoCharginoPowheg_H
//
...
/**
 * The MEPP2CharginoCharginoPowheg class implements the matrix elements
...
private:
   ...
   */
  static ClassDescription<MEPP2CharginoCharginoPowheg> initMEPP2CharginoCharginoPowheg;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  MEPP2CharginoCharginoPowheg & operator=(const MEPP2CharginoCharginoPowheg &);
 ...
 *  base classes of MEPP2CharginoCharginoPowheg. */
template <>
 ...
 *  the MEPP2CharginoCharginoPowheg class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::MEPP2CharginoCharginoPowheg>
  : public ClassTraitsBase<Herwig::MEPP2CharginoCharginoPowheg> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::MEPP2CharginoCharginoPowheg"; }
  /**
   * The name of a file containing the dynamic library where the class
   * MEPP2CharginoCharginoPowheg is implemented. It may also include several, space-separated,
   * libraries if the class MEPP2CharginoCharginoPowheg depends on other classes (base classes
...
#endif /* HERWIG_MEPP2CharginoCharginoPowheg_H */
