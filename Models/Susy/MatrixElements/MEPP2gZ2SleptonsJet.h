...
/**
 * The MEPP2gZ2SleptonsJet class implements the matrix element for the production
 * of a Z boson + a jet including the decay of the Z including \f$Z/\gamma\f$ 
 * interference
 *
 * @see \ref MEPP2gZ2SleptonsJetInterfaces "The interfaces"
 * defined for MEPP2gZ2SleptonsJet.
 */
class MEPP2gZ2SleptonsJet: public MEBase {
...
protected:
  ...
  InvEnergy2 qqbarME(vector<SpinorWaveFunction> & fin,
		     ...
		     ScalarWaveFunction & lm, ScalarWaveFunction & lp,
		     bool me=false) const;
...
private:
   ...
   */
  static ClassDescription<MEPP2gZ2SleptonsJet> initMEPP2gZ2SleptonsJet;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  MEPP2gZ2SleptonsJet & operator=(const MEPP2gZ2SleptonsJet &);
...
private:
   ...
   *  Pointer to the photon vertex
   */
  AbstractVSSVertexPtr _theVSSVertex;
  //@}
  ...
  /**
   *  Option for the treatment of the Z off-shell effects
   */
 ...
 *  base classes of MEPP2gZ2SleptonsJet. */
template <>
struct BaseClassTrait<Herwig::MEPP2gZ2SleptonsJet,1> {
  /** Typedef of the first base class of MEPP2gZ2SleptonsJet. */
  typedef MEBase NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the MEPP2gZ2SleptonsJet class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::MEPP2gZ2SleptonsJet>
  : public ClassTraitsBase<Herwig::MEPP2gZ2SleptonsJet> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::MEPP2gZ2SleptonsJet"; }
  /**
   * The name of a file containing the dynamic library where the class
   * MEPP2gZ2SleptonsJet is implemented. It may also include several, space-separated,
   * libraries if the class MEPP2gZ2SleptonsJet depends on other classes (base classes
...
#endif /* HERWIG_MEPP2gZ2SleptonsJet_H */
