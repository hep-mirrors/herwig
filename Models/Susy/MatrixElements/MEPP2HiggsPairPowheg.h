// -*- C++ -*-
#ifndef HERWIG_MEPP2HiggsPairPowheg_H
#define HERWIG_MEPP2HiggsPairPowheg_H
//
// This is the declaration of the MEPP2HiggsPairPowheg class.
//
...
/**
 * Here is the documentation of the MEPP2HiggsPairPowheg class.
 *
 * @see \ref MEPP2HiggsPairPowhegInterfaces "The interfaces"
 * defined for MEPP2HiggsPairPowheg.
 */
class MEPP2HiggsPairPowheg: public NLODrellYanBase {
...
private:
   ...
   */
  static ClassDescription<MEPP2HiggsPairPowheg> initMEPP2HiggsPairPowheg;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  MEPP2HiggsPairPowheg & operator=(const MEPP2HiggsPairPowheg &);
...
private:
  ...
  /**
   *  Pointer to the \f$Z\f$ higgs vertex
   */
  AbstractVSSVertexPtr ZSSVertex_;
  
  /**
   *  Pointer to the \f$\gamma\f$ higgs vertex
   */
  AbstractVSSVertexPtr PSSVertex_;
  
  /**
   *  Pointer to the \f$W^\pm\f$ higgs vertex
   */
  ...
  /**
   *  Higgs bosons to produce
   */
  //@{
  /**
   *  First  outgoing Higgs
   */
  PDPtr outgoing1_;

  /**
   *  Second outgoing Higgs
   */
  PDPtr outgoing2_;
  //@}
 ...
 *  base classes of MEPP2HiggsPairPowheg. */
template <>
struct BaseClassTrait<Herwig::MEPP2HiggsPairPowheg,1> {
  /** Typedef of the first base class of MEPP2HiggsPairPowheg. */
  typedef Herwig::NLODrellYanBase NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the MEPP2HiggsPairPowheg class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::MEPP2HiggsPairPowheg>
  : public ClassTraitsBase<Herwig::MEPP2HiggsPairPowheg> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::MEPP2HiggsPairPowheg"; }
  /**
   * The name of a file containing the dynamic library where the class
   * MEPP2HiggsPairPowheg is implemented. It may also include several, space-separated,
   * libraries if the class MEPP2HiggsPairPowheg depends on other classes (base classes
...
#endif /* HERWIG_MEPP2HiggsPairPowheg_H */
