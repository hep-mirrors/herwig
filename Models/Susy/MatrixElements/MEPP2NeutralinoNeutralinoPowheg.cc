...
NLODrellYanBase::Singular MEPP2NeutralinoNeutralinoPowheg::virtualME() const {
  ...
  FFVVertexPtr vertex = dynamic_ptr_cast<FFVVertexPtr>(FFZVertex_);
  ...
  vertex = dynamic_ptr_cast<FFVVertexPtr>(NNZVertex_);
  ...
  FFSVertexPtr vertex2=dynamic_ptr_cast<FFSVertexPtr>(NFSVertex_);
