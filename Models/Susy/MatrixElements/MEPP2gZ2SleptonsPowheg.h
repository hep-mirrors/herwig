// -*- C++ -*-
#ifndef HERWIG_MEPP2gZ2SleptonsPowheg_H
#define HERWIG_MEPP2gZ2SleptonsPowheg_H
//
// This is the declaration of the MEPP2gZ2SleptonsPowheg class.
//
 ...
 */
class MEPP2gZ2SleptonsPowheg: public NLODrellYanBase {
...
private:
   ...
   */
  static ClassDescription<MEPP2gZ2SleptonsPowheg> initMEPP2gZ2SleptonsPowheg;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  MEPP2gZ2SleptonsPowheg & operator=(const MEPP2gZ2SleptonsPowheg &);
 ...
 *  base classes of MEPP2gZ2SleptonsPowheg. */
template <>
struct BaseClassTrait<Herwig::MEPP2gZ2SleptonsPowheg,1> {
  /** Typedef of the first base class of MEPP2gZ2SleptonsPowheg. */
  typedef Herwig::NLODrellYanBase NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the MEPP2gZ2SleptonsPowheg class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::MEPP2gZ2SleptonsPowheg>
  : public ClassTraitsBase<Herwig::MEPP2gZ2SleptonsPowheg> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::MEPP2gZ2SleptonsPowheg"; }
  /**
   * The name of a file containing the dynamic library where the class
   * MEPP2gZ2SleptonsPowheg is implemented. It may also include several, space-separated,
   * libraries if the class MEPP2gZ2SleptonsPowheg depends on other classes (base classes
...
#endif /* HERWIG_MEPP2gZ2SleptonsPowheg_H */
