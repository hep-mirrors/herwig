// -*- C++ -*-
#ifndef HERWIG_MEPP2CharginoNeutralinoPowheg_H
#define HERWIG_MEPP2CharginoNeutralinoPowheg_H
//
// This is the declaration of the MEPP2CharginoNeutralinoPowheg class.
//
...
/**
 * The MEPP2CharginoNeutralinoPowheg class implements the matrix elements
 * together with the next-to-leading order corrections for
 * \f$q\bar q\to \gamma Z^0\to \tilde{\ell}\tilde{\ell}^*\f$.
 *
 * @see \ref MEPP2CharginoNeutralinoPowhegInterfaces "The interfaces"
 * defined for MEPP2CharginoNeutralinoPowheg.
 */
class MEPP2CharginoNeutralinoPowheg: public MEPP2GauginoGauginoPowheg {
...
private:
   ...
   */
  static ClassDescription<MEPP2CharginoNeutralinoPowheg> initMEPP2CharginoNeutralinoPowheg;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  MEPP2CharginoNeutralinoPowheg & operator=(const MEPP2CharginoNeutralinoPowheg &);
...
private:
  ...
  /**
   *  Pointer to the fermion-sfermion-chargino vertex
   */
  AbstractFFSVertexPtr CFSVertex_;
 ...
 *  base classes of MEPP2CharginoNeutralinoPowheg. */
template <>
struct BaseClassTrait<Herwig::MEPP2CharginoNeutralinoPowheg,1> {
  /** Typedef of the first base class of MEPP2CharginoNeutralinoPowheg. */
  typedef Herwig::MEPP2GauginoGauginoPowheg NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the MEPP2CharginoNeutralinoPowheg class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::MEPP2CharginoNeutralinoPowheg>
  : public ClassTraitsBase<Herwig::MEPP2CharginoNeutralinoPowheg> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::MEPP2CharginoNeutralinoPowheg"; }
  /**
   * The name of a file containing the dynamic library where the class
   * MEPP2CharginoNeutralinoPowheg is implemented. It may also include several, space-separated,
   * libraries if the class MEPP2CharginoNeutralinoPowheg depends on other classes (base classes
...
#endif /* HERWIG_MEPP2CharginoNeutralinoPowheg_H */
