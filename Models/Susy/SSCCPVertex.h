// -*- C++ -*-
#ifndef HERWIG_SSCCPVertex_H
#define HERWIG_SSCCPVertex_H
//
...
/**
 * This is the implementation of the coupling of a photon to a pair of 
 * charginos. It inherits from FFVVertex and implements the setCoupling 
 * method.
 *
 * @see \ref SSCCPVertexInterfaces "The interfaces"
 * defined for SSCCPVertex.
 * @see FFVVertex
 */
class SSCCPVertex: public FFVVertex {
...
private:
   ...
   */
  static ClassDescription<SSCCPVertex> initSSCCPVertex;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  SSCCPVertex & operator=(const SSCCPVertex &);
...
struct ClassTraits<Herwig::SSCCPVertex>
   ...
   * libraries if the class SSCCPVertex depends on other classes (base classes
...
#include "SSCCPVertex.icc"

#endif /* HERWIG_SSCCPVertex_H */
