...
// functions of the HiddenOneOneOneSplitFn class.
//

#include "HiddenOneOneOneSplitFn.h"
...
void HiddenOneOneOneSplitFn::doinit() {
  ...
  if(!model) throw InitException() << "Must be using the HiddenValleyModel"
				   << " in HiddenOneOneOneSplitFn::doinit()" 
				   << Exception::runerror;
...
IBPtr HiddenOneOneOneSplitFn::clone() const {
  return new_ptr(*this);
}

IBPtr HiddenOneOneOneSplitFn::fullclone() const {
  return new_ptr(*this);
}

NoPIOClassDescription<HiddenOneOneOneSplitFn> HiddenOneOneOneSplitFn::initHiddenOneOneOneSplitFn;
// Definition of the static class description member.

void HiddenOneOneOneSplitFn::Init() {

  static ClassDocumentation<HiddenOneOneOneSplitFn> documentation
    ("There is no documentation for the HiddenOneOneOneSplitFn class");

}

bool HiddenOneOneOneSplitFn::checkColours(const IdList & ids) const {
