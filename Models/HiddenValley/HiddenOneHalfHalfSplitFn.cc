...
// functions of the HiddenOneHalfHalfSplitFn class.
//

#include "HiddenOneHalfHalfSplitFn.h"
...
void HiddenOneHalfHalfSplitFn::doinit() {
  ...
  if(!model) throw InitException() << "Must be using the HiddenValleyModel"
				   << " in HiddenOneHalfHalfSplitFn::doinit()" 
				   << Exception::runerror;
  ...
  OneHalfHalfSplitFn::doinit();
}


IBPtr HiddenOneHalfHalfSplitFn::clone() const {
  return new_ptr(*this);
}

IBPtr HiddenOneHalfHalfSplitFn::fullclone() const {
  return new_ptr(*this);
}

NoPIOClassDescription<HiddenOneHalfHalfSplitFn> HiddenOneHalfHalfSplitFn::initHiddenOneHalfHalfSplitFn;
// Definition of the static class description member.

void HiddenOneHalfHalfSplitFn::Init() {

  static ClassDocumentation<HiddenOneHalfHalfSplitFn> documentation
    ("There is no documentation for the HiddenOneHalfHalfSplitFn class");

}

bool HiddenOneHalfHalfSplitFn::checkColours(const IdList & ids) const {
