// -*- C++ -*-
//
// YMerge.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_YMerge_H
#define HERWIG_YMerge_H
//
...
template <>
struct BaseClassTrait<Herwig::YMerge,1> {
...
template <>
struct ClassTraits<Herwig::YMerge>
  : public ClassTraitsBase<Herwig::YMerge> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::YMerge"; }
  /**
