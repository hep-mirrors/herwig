// -*- C++ -*-
//
// EventShapes2.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_EventShapes2_H
#define HERWIG_EventShapes2_H
//
...
template <>
struct BaseClassTrait<Herwig::EventShapes2,1> {
...
template <>
struct ClassTraits<Herwig::EventShapes2>
  : public ClassTraitsBase<Herwig::EventShapes2> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::EventShapes2"; }
  /**
