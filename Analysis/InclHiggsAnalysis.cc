...
//   _y34.topdrawOutput(topdrawFile,Frame,"RED","y34");
  ...
  _ptJet0_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","pT 1st Jet");
  _ptJet1_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","pT 2nd Jet");
  _ptJet2_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","pT 3rd Jet");
  _ptJet3_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","pT 4th Jet");
  _etaJet0_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","eta 1st Jet");
  _etaJet1_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","eta 2nd Jet");
  _etaJet2_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","eta 3rd Jet");
  _etaJet3_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","eta 4th Jet");
  _delta01_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","Delta 01");
  _delta12_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","Delta 12");
  _delta23_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","Delta 23");
  _htJets_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","HT Jets");
  _htJetsPlusHiggs_Cut.topdrawOutput(topdrawFile_Cut,Frame,"RED","HT Jets plus Higgs");
