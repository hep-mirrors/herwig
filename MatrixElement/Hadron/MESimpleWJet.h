// -*- C++ -*-
#ifndef Herwig_MESimpleWJet_H
#define Herwig_MESimpleWJet_H
//
// This is the declaration of the MESimpleWJet class.
//
...
/**
 * Here is the documentation of the MESimpleWJet class.
 *
 * @see \ref MESimpleWJetInterfaces "The interfaces"
 * defined for MESimpleWJet.
 */
class MESimpleWJet: public HwMEBase {
...
protected:
   ...
   * @param me   Whether or not to calculate the matrix element for spin correlations
   **/
  double qgME(vector<SpinorWaveFunction> & fin,
   ...
   * @param me   Whether or not to calculate the matrix element for spin correlations
   **/
  double qbargME(vector<SpinorBarWaveFunction> & fin,
		 vector<VectorWaveFunction> & gin,
...
private:
   ...
   */
  MESimpleWJet & operator=(const MESimpleWJet &);
