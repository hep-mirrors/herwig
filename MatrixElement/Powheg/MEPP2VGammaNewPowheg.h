// -*- C++ -*-
#ifndef HERWIG_MEPP2VGammaNewPowheg_H
#define HERWIG_MEPP2VGammaNewPowheg_H
//
// This is the declaration of the MEPP2VGammaNewPowheg class.
//
...
/**
 * Here is the documentation of the MEPP2VGammaNewPowheg class.
 *
 * @see \ref MEPP2VGammaNewPowhegInterfaces "The interfaces"
 * defined for MEPP2VGammaNewPowheg.
 */
...
protected:
  ...
  /**
   *  Leading-order matrix element for \f$q\bar q\to V\gamma\f$
   */
  double loVGammaME(const cPDVector & particles,
		    const vector<Lorentz5Momentum> & momenta,
		    bool first=false) const;

  /**
   *  Leading-order matrix element for \f$qg\to V q\f$
   */
  double loVqME(const cPDVector & particles,
		const vector<Lorentz5Momentum> & momenta,
		bool first=false) const;

  /**
   *  Leading-order matrix element for \f$g\bar q\to V \bar q\f$
   */
  double loVqbarME(const cPDVector & particles,
		   const vector<Lorentz5Momentum> & momenta,
		   bool first=false) const;

  /**
   *  Leading-order matrix element for \f$q\bar q\to V g\f$
   */
  double loVgME(const cPDVector & particles,
		const vector<Lorentz5Momentum> & momenta,
		bool first=false) const;

  /**
   *  Real emission matrix element for \f$q\bar q\to V \gamma g\f$
   */
  InvEnergy2 realVGammagME(const cPDVector & particles,
			   const vector<Lorentz5Momentum> & momenta,
			   DipoleType dipole, RadiationType rad,
			   bool first=false) const;

  /**
   *  Real emission matrix element for \f$qg\to V \gamma q\f$
   */
  InvEnergy2 realVGammaqME(const cPDVector & particles,
			   const vector<Lorentz5Momentum> & momenta,
			   DipoleType dipole, RadiationType rad,
			   bool first=false) const;

  /**
   *  Real emission matrix element for \f$g\bar q\to V \gamma \bar q\f$
   */
  InvEnergy2 realVGammaqbarME(const cPDVector & particles,
			      const vector<Lorentz5Momentum> & momenta,
			      DipoleType dipole, RadiationType rad,
			      bool first=false) const;
  ...
  /**
   *  The H function of PRD 47,940
   */
  double H(Energy2 t, Energy2 s, Energy2 m2) const;

  /**
   *  The FW function of PRD 47,940
   */
  double FW(Energy2 t, Energy2 u, Energy2 s, Energy2 m2) const;

  /**
   *  The FZ function of PRD 47,940
   */
  double FZ(Energy2 t, Energy2 u, Energy2 s, Energy2 m2) const;

  /**
   *  The Fv function of PRD 47,940
   */
  double FV(Energy2 t, Energy2 u, Energy2 s, Energy2 m2) const;
...
private:
   ...
   */
  static ClassDescription<MEPP2VGammaNewPowheg> initMEPP2VGammaNewPowheg;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  MEPP2VGammaNewPowheg & operator=(const MEPP2VGammaNewPowheg &);
 ...
 *  base classes of MEPP2VGammaNewPowheg. */
template <>
struct BaseClassTrait<Herwig::MEPP2VGammaNewPowheg,1> {
  /** Typedef of the first base class of MEPP2VGammaNewPowheg. */
  typedef Herwig::HwMEBase NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the MEPP2VGammaNewPowheg class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::MEPP2VGammaNewPowheg>
  : public ClassTraitsBase<Herwig::MEPP2VGammaNewPowheg> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::MEPP2VGammaNewPowheg"; }
  /**
   * The name of a file containing the dynamic library where the class
   * MEPP2VGammaNewPowheg is implemented. It may also include several, space-separated,
   * libraries if the class MEPP2VGammaNewPowheg depends on other classes (base classes
...
#endif /* HERWIG_MEPP2VGammaNewPowheg_H */
