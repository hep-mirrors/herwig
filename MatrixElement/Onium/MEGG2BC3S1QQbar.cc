  ...
  for(unsigned int ih1=0;ih1<2;++ih1) {
    for(unsigned int ih2=0;ih2<2;++ih2) {
	  ...
	  for(unsigned int ih3=0;ih3<2;++ih3) {
	    ...
	    diag[14]=-0.125*M2*(2.*dot2*dot20+4.*dot2*dot21-4.*dot15*dot2*dot22+4.*dot10*(-dot11+dot13)*dot23-8.*dot15*dot2*dot23-
				4.*dot10*dot2*dot25+4.*dot16*dot2*dot26-8.*dot10*dot14*dot27+8.*dot16*dot2*dot27-
				8.*dot10*dot17*dot18*dot3-2.*dot20*dot3+4.*dot15*dot22*dot3+4.*dot10*dot25*dot3-
				4.*dot16*dot26*dot3+4.*dot17*dot29*dot3-4.*dot17*dot2*dot30+8.*dot14*dot15*dot31+
				4.*dot11*dot16*dot31-4.*dot13*dot16*dot31-8.*dot16*dot18*dot2*dot4+4.*dot10*dot23*dot4+
				4.*dot2*dot24*dot4+8.*dot16*dot18*dot3*dot4-4.*dot24*dot3*dot4+8.*dot14*dot30*dot4-
				4.*dot16*dot31*dot4-4.*dot14*dot42-2.*dot11*dot44+2.*dot13*dot44+2.*dot4*dot44+
				8.*dot15*dot18*dot2*dot5-4.*dot2*dot28*dot5-8.*dot15*dot18*dot3*dot5+4.*dot28*dot3*dot5+
				4.*dot11*dot30*dot5-4.*dot13*dot30*dot5-4.*dot30*dot4*dot5-8.*dot10*dot13*dot18*dot7+
				8.*dot15*dot18*dot2*dot7+4.*dot10*dot27*dot7-4.*dot2*dot28*dot7+4.*dot13*dot29*dot7-
				4.*dot15*dot31*dot7-4.*dot30*dot4*dot7+2.*dot42*dot7-8.*dot10*dot17*dot18*dot8-
				2.*dot20*dot8+4.*dot15*dot22*dot8+4.*dot10*dot25*dot8-4.*dot16*dot26*dot8+4.*dot17*dot29*dot8+
				8.*dot16*dot18*dot4*dot8-4.*dot24*dot4*dot8-8.*dot15*dot18*dot5*dot8+4.*dot28*dot5*dot8+
				2.*dot20*dot9-4.*dot15*dot22*dot9-4.*dot10*dot25*dot9+4.*dot16*dot26*dot9-
				8.*dot16*dot18*dot4*dot9+4.*dot24*dot4*dot9+8.*dot15*dot18*dot5*dot9-4.*dot28*dot5*dot9+
				(-2.*dot15*dot36+dot45-
				 2.*(dot33*dot4-2.*dot16*dot38*dot4-dot16*dot41+dot17*dot48+2.*dot15*dot38*dot5-
				     dot47*dot5+a1*(dot11+dot13-dot4)*(2.*dot10*dot19-dot32+2.*dot16*dot37-2.*dot39*dot5)-
				     2.*dot15*dot37*dot7+2.*dot39*dot4*dot7+dot49*dot7-dot10*(dot35-2.*dot17*dot38+2.*dot40*dot7)))*M+
				2.*dot1*(dot20+4.*dot14*(-2.*dot15*dot18+dot28)-
					 2.*(2.*dot11*dot16*dot18-2.*dot13*dot16*dot18-2.*dot10*dot17*dot18+
					     dot15*dot22-dot11*dot24+dot13*dot24+dot10*dot25-dot16*dot26+
					     dot17*dot29-2.*dot15*dot18*dot5+dot28*dot5-2.*dot15*dot18*dot7+dot28*dot7)+
					 (2.*dot15*dot19+2.*dot17*dot39-2.*dot16*dot40-dot46)*M)+
				2.*(dot20-
				    2.*a1*(2.*dot10*dot17*dot18+dot20-2.*dot15*dot22-2.*dot10*dot25+
					   2.*dot16*dot26-dot17*dot29-4.*dot16*dot18*dot4+2.*dot24*dot4+
					   4.*dot15*dot18*dot5-2.*dot28*dot5)-
				    2.*(dot15*dot22+dot10*dot25-dot16*dot26+2.*dot16*dot18*dot4-
					dot24*dot4-2.*dot15*dot18*dot5+dot28*dot5))*M2)
	    /(a1*a2*dot2*(-dot1+dot2+dot3+dot8+dot9+M2)*(-dot9-a2*M2));
	  diag[15]=M2*(2.*dot2*dot20+4.*dot12*dot2*dot25-2.*dot1*(dot20+2.*dot12*dot25)+8.*dot12*dot14*dot27+8.*dot12*dot17*dot18*dot3-
		       2.*dot20*dot3-4.*dot21*dot3-4.*dot12*dot25*dot3+4.*dot17*dot29*dot3+4.*dot17*dot3*dot30+4.*dot12*dot23*dot4-
		       4.*dot14*dot42-2.*dot4*dot44-8.*dot12*dot27*dot5+4.*dot42*dot5+8.*dot14*dot26*dot6-8.*dot17*dot18*dot3*dot6+
		       8.*dot25*dot3*dot6+4.*dot22*dot4*dot6-8.*dot26*dot5*dot6+2.*(dot11-dot13)*(2.*dot12*dot23-dot44+2.*dot22*dot6)+
		       8.*dot12*dot13*dot18*dot7-4.*dot12*dot27*dot7+4.*dot13*dot29*dot7+4.*dot28*dot3*dot7-8.*dot12*dot18*dot4*dot7-
		       4.*dot29*dot4*dot7+2.*dot42*dot7-4.*dot26*dot6*dot7+8.*dot12*dot17*dot18*dot8-2.*dot20*dot8-4.*dot12*dot25*dot8+
		       4.*dot17*dot29*dot8+2.*dot20*dot9+4.*dot12*dot25*dot9+
		       (2.*a1*(2.*dot12*dot19+dot32)*(dot11+dot13-dot4)+dot45-2.*dot34*dot6-
			2.*(dot17*dot48-2.*dot17*dot37*dot6+dot49*dot7+dot12*(dot35-2.*dot17*dot38+2.*dot40*dot7)))*M+
		       2.*(dot20+2.*dot12*dot25+2.*a1*(2.*dot12*dot17*dot18-dot20-2.*dot12*dot25+dot17*dot29))*M2)
	    /(8.*a1*dot3*(-dot1+dot2+dot3+dot8+dot9+M2)*(-(a2*dot1)+dot2+dot9-a1*(dot2+dot3+dot9)+M2+(-2.+a1)*a1*M2));
	    diag[16]=M2*(-2.*dot2*dot20-2.*dot2*dot21+4.*dot15*dot2*dot22+4.*dot15*dot2*dot23-4.*dot16*dot2*dot26-
			 4.*dot16*dot2*dot27+4.*dot17*dot2*dot29-2.*dot20*dot3-2.*dot21*dot3+4.*dot17*dot2*dot30+
			 4.*a1*(dot11+dot13)*((dot10-dot12)*(dot22+dot23)+2.*dot14*(dot29+dot30))-4.*dot14*dot15*dot31-
			 4.*dot11*dot16*dot31+4.*dot10*dot17*dot31-4.*a1*dot10*dot22*dot4+4.*a1*dot12*dot22*dot4-
			 4.*a1*dot10*dot23*dot4-4.*dot12*dot23*dot4+4.*a1*dot12*dot23*dot4-8.*a1*dot14*dot29*dot4-
			 4.*dot24*dot3*dot4+4.*dot14*dot30*dot4-8.*a1*dot14*dot30*dot4-2.*dot10*dot43-2.*dot12*dot43+
			 2.*dot11*dot44+2.*dot13*dot44+8.*a1*dot11*dot12*dot18*dot5+8.*a1*dot12*dot13*dot18*dot5+
			 4.*dot12*dot27*dot5-4.*a1*dot11*dot29*dot5-4.*a1*dot13*dot29*dot5+4.*dot28*dot3*dot5-
			 4.*a1*dot11*dot30*dot5-4.*dot13*dot30*dot5-4.*a1*dot13*dot30*dot5+4.*dot15*dot31*dot5-
			 8.*a1*dot12*dot18*dot4*dot5+4.*a1*dot29*dot4*dot5+4.*a1*dot30*dot4*dot5-2.*dot42*dot5-
			 8.*a1*dot11*dot14*dot18*dot6-8.*a1*dot13*dot14*dot18*dot6-4.*dot13*dot22*dot6+
			 4.*dot14*dot26*dot6+4.*dot25*dot3*dot6-8.*dot14*dot18*dot4*dot6+8.*a1*dot14*dot18*dot4*dot6+
			 8.*dot13*dot18*dot5*dot6+8.*a1*dot11*dot12*dot18*dot7+8.*a1*dot12*dot13*dot18*dot7-
			 4.*dot10*dot26*dot7-4.*dot10*dot27*dot7+4.*dot12*dot27*dot7+4.*dot11*dot29*dot7-
			 4.*a1*dot11*dot29*dot7-4.*a1*dot13*dot29*dot7+4.*dot28*dot3*dot7+4.*dot11*dot30*dot7-
			 4.*a1*dot11*dot30*dot7-4.*dot13*dot30*dot7-4.*a1*dot13*dot30*dot7+4.*dot15*dot31*dot7-
			 8.*a1*dot12*dot18*dot4*dot7+4.*a1*dot29*dot4*dot7+4.*a1*dot30*dot4*dot7-2.*dot42*dot7+
			 8.*dot13*dot18*dot6*dot7+
			 4.*dot1*(dot20+dot21-dot15*(dot22+dot23)+dot16*(dot26+dot27)+dot14*dot28-
				  dot17*(dot29+dot30)+dot24*(-dot13+dot4)+dot25*(dot12-dot6)-dot28*(dot5+dot7))+
			 8.*a1*dot11*dot16*dot18*dot8+8.*a1*dot13*dot16*dot18*dot8-2.*dot20*dot8-4.*dot21*dot8+
			 4.*dot15*dot23*dot8-4.*a1*dot11*dot24*dot8-4.*a1*dot13*dot24*dot8-4.*dot16*dot27*dot8+
			 4.*dot17*dot30*dot8-8.*a1*dot16*dot18*dot4*dot8-4.*dot24*dot4*dot8+4.*a1*dot24*dot4*dot8+
			 4.*dot28*dot5*dot8+4.*dot25*dot6*dot8-8.*dot15*dot18*dot7*dot8+8.*dot28*dot7*dot8-
			 2.*dot20*dot9-4.*dot21*dot9+4.*dot15*dot22*dot9+4.*dot15*dot23*dot9+
			 4.*a1*dot11*dot24*dot9+4.*a1*dot13*dot24*dot9-4.*dot16*dot26*dot9-4.*dot16*dot27*dot9+
			 4.*dot17*dot29*dot9+4.*dot17*dot30*dot9-4.*a1*dot24*dot4*dot9+4.*dot25*dot6*dot9-2.*(1.+a1)*dot1*dot46*M+
			 (2.*dot15*dot36-dot45+2.*dot17*dot48+
			  2.*(-(dot33*dot4)-dot16*dot41+dot47*dot5+2.*a12*dot19*(dot11+dot13-dot4)*(dot10+dot12-dot6)+
			      dot35*dot6+2.*dot19*dot4*dot6+(-2.*dot15*(dot37+dot38)+2.*dot47+dot49)*dot7-
			      2.*dot40*dot6*(dot5+dot7)+
			      a1*((dot10+dot12)*dot35-dot35*dot6-
				  dot11*(dot32+2.*(dot33-dot16*(dot37+dot38)-
						   2.*dot19*dot6+dot39*(dot5+dot7)))-
				  dot13*(dot32+2.*(dot33-dot16*(dot37+dot38)-2.*dot19*dot6+
						   dot39*(dot5+dot7)))+
				  dot4*(dot32+2.*(dot33-dot16*(dot37+dot38)-2.*dot19*dot6+dot39*(dot5+dot7)))+
				  dot46*(dot2+dot3+dot8+dot9))))*M+
			 2.*a1*dot46*pow<3,1>(M)+(-2.*dot20+8.*a12*(dot16*dot18-dot24)*(dot11+dot13-dot4)+
						  4.*(-dot21+dot15*(dot22+dot23)-dot16*(dot26+dot27)+dot17*(dot29+dot30)+dot25*dot6)+
						  4.*a1*(dot21+dot16*(dot26+dot27)-dot17*(dot29+dot30)+dot24*(dot11+dot13-2.*dot4)+
							 (dot17*dot18-dot25)*dot6+dot28*(dot5+dot7)-dot15*(dot22+dot23+dot18*dot7)))*M2)
	      /(16.*a1*a2*(-dot1+dot2+dot3+dot8+dot9+M2)*(-dot9-a2*M2)*(-dot1+a1*(dot8+dot9+M2)));
	    diag[17]=M2*(dot1*(4.*(2.+a1)*dot12*dot17*dot18-2.*(2.+3.*a1)*dot12*dot25+
			       2.*(dot20-2.*(dot15*dot22+dot11*dot24-dot10*dot25-dot16*dot26+dot14*dot28))-
			       4.*dot17*dot29+4.*dot24*dot4-4.*dot25*dot6-
			       a1*(dot20+dot21-2.*(-2.*dot10*dot25+dot24*(dot11+2.*dot13-2.*dot4)+3.*dot25*dot6+
						   dot17*(dot29+dot30-2.*dot18*dot6)+dot28*(-dot14+dot5+dot7))))+
			 4.*a12*(dot10+dot12-dot6)*M*(dot19*(dot11+dot13-dot4)+2.*(dot17*dot18-dot25)*M)+
			 2.*(dot21*dot3-2.*dot15*dot23*dot3+2.*dot16*dot27*dot3-2.*dot17*dot3*dot30-2.*dot14*dot15*dot31-
			     2.*dot11*dot16*dot31-2.*dot12*dot17*dot31+2.*dot12*dot23*dot4-2.*dot14*dot30*dot4+
			     2.*dot14*dot42+dot12*dot43+2.*dot11*dot44-dot4*dot44-2.*dot12*dot27*dot5-
			     2.*dot11*dot30*dot5+2.*dot15*dot31*dot5+2.*dot30*dot4*dot5-dot42*dot5-
			     2.*dot11*dot22*dot6+2.*dot11*dot23*dot6-2.*dot13*dot23*dot6-2.*dot14*dot26*dot6+
			     4.*dot14*dot27*dot6+4.*dot17*dot18*dot3*dot6-2.*dot25*dot3*dot6-2.*dot17*dot31*dot6+
			     4.*dot14*dot18*dot4*dot6+2.*dot22*dot4*dot6+2.*dot23*dot4*dot6+2.*dot43*dot6+
			     4.*dot11*dot18*dot5*dot6-4.*dot27*dot5*dot6-4.*dot18*dot4*dot5*dot6+2.*dot12*dot26*dot7+
			     4.*dot11*dot29*dot7+4.*dot15*dot18*dot3*dot7-2.*dot28*dot3*dot7-4.*dot12*dot18*dot4*dot7-
			     2.*dot29*dot4*dot7+4.*dot13*dot18*dot6*dot7+2.*dot26*dot6*dot7-2.*dot27*dot6*dot7-4.*dot18*dot4*dot6*dot7-
			     dot2*(2.*dot20+dot21-2.*dot15*dot22+2.*dot16*dot26+2.*dot24*dot4+
				   2.*dot25*(dot10-2.*dot6)-2.*dot17*(2.*dot29+dot30-2.*dot18*dot6)-
				   2.*dot28*(dot5+dot7))+4.*dot17*dot18*dot6*dot8-2.*dot25*dot6*dot8-
			     2.*dot20*dot9+2.*dot15*dot22*dot9-2.*dot16*dot26*dot9+4.*dot17*dot29*dot9-
			     2.*dot24*dot4*dot9+2.*dot28*dot5*dot9+2.*dot25*dot6*dot9-
			     dot6*(dot35-2.*dot17*dot38+2.*dot40*dot7)*M+
			     2.*(-dot20+dot15*dot22-dot16*dot26+2.*dot17*dot29-dot24*dot4+dot28*dot5+dot25*dot6)*M2+
			     dot10*(-4.*dot14*dot27-4.*dot17*dot18*dot3+2.*dot25*dot3+4.*dot17*dot31-
				    3.*dot43+4.*dot27*dot5+dot35*M-
				    2.*(dot11*dot23-dot13*dot23+dot23*dot4+2.*dot13*dot18*dot7+
					2.*dot26*dot7-dot27*dot7-2.*dot18*dot4*dot7+2.*dot17*dot18*dot8-
					dot25*dot8+dot25*dot9+dot17*dot38*M-dot40*dot7*M+dot25*M2)))+
			 a1*(4.*dot10*(dot13*(dot22-dot23)+dot11*(dot22+dot23))+8.*dot10*dot14*dot27+8.*dot11*dot14*dot29+
			     8.*dot13*dot14*dot29-8.*dot11*dot16*dot18*dot3-8.*dot13*dot16*dot18*dot3+8.*dot10*dot17*dot18*dot3+
			     dot20*dot3+dot21*dot3+6.*dot11*dot24*dot3+4.*dot13*dot24*dot3-4.*dot10*dot25*dot3+
			     2.*dot14*dot28*dot3-2.*dot17*dot29*dot3-2.*dot17*dot3*dot30+4.*dot11*dot16*dot31+
			     4.*dot13*dot16*dot31-4.*dot10*dot17*dot31-4.*dot10*dot22*dot4+4.*dot10*dot23*dot4-
			     8.*dot14*dot29*dot4+8.*dot16*dot18*dot3*dot4-4.*dot24*dot3*dot4-4.*dot16*dot31*dot4+
			     4.*dot10*dot43-4.*dot11*dot44-4.*dot13*dot44+4.*dot4*dot44-8.*dot10*dot27*dot5-
			     4.*dot11*dot29*dot5-4.*dot13*dot29*dot5-2.*dot28*dot3*dot5+4.*dot11*dot30*dot5+
			     4.*dot13*dot30*dot5+4.*dot29*dot4*dot5-4.*dot30*dot4*dot5+4.*dot11*dot22*dot6+
			     4.*dot13*dot22*dot6-4.*dot11*dot23*dot6+4.*dot13*dot23*dot6-8.*dot14*dot27*dot6-
			     4.*dot17*dot18*dot3*dot6+2.*dot25*dot3*dot6+4.*dot17*dot31*dot6-4.*dot22*dot4*dot6-
			     4.*dot23*dot4*dot6-4.*dot43*dot6-8.*dot11*dot18*dot5*dot6-8.*dot13*dot18*dot5*dot6+
			     8.*dot27*dot5*dot6+8.*dot18*dot4*dot5*dot6+8.*dot10*dot13*dot18*dot7+4.*dot10*dot26*dot7-
			     4.*dot10*dot27*dot7-8.*dot11*dot29*dot7-8.*dot13*dot29*dot7-2.*dot28*dot3*dot7-
			     8.*dot10*dot18*dot4*dot7+8.*dot29*dot4*dot7-8.*dot13*dot18*dot6*dot7-4.*dot26*dot6*dot7+
			     4.*dot27*dot6*dot7+8.*dot18*dot4*dot6*dot7+
			     dot2*(dot20+dot21-2.*(-2.*dot10*dot25+dot24*(dot11+2.*dot13-2.*dot4)+
						   3.*dot25*dot6+dot17*(dot29+dot30-2.*dot18*dot6)+dot28*(-dot14+dot5+dot7)))+
			     8.*dot10*dot17*dot18*dot8+dot20*dot8+dot21*dot8+2.*dot11*dot24*dot8-4.*dot10*dot25*dot8+
			     2.*dot14*dot28*dot8-2.*dot17*dot29*dot8-2.*dot17*dot30*dot8-2.*dot28*dot5*dot8-
			     4.*dot17*dot18*dot6*dot8+2.*dot25*dot6*dot8-2.*dot28*dot7*dot8+dot20*dot9+dot21*dot9+
			     2.*dot11*dot24*dot9+4.*dot10*dot25*dot9+2.*dot14*dot28*dot9-2.*dot17*dot29*dot9-
			     2.*dot17*dot30*dot9-2.*dot28*dot5*dot9+4.*dot17*dot18*dot6*dot9-6.*dot25*dot6*dot9-
			     2.*dot28*dot7*dot9-
			     2.*(dot10-dot6)*(dot35-2.*dot17*dot38+2.*dot19*(dot11+dot13-dot4)+2.*dot40*dot7)*M+
			     (5.*dot20+dot21-4.*dot15*dot22+4.*dot16*dot26+2.*dot24*(dot11+2.*dot4)-
			      2.*(4.*dot10*dot17*dot18-6.*dot10*dot25+5.*dot17*dot29+dot17*dot30-
				  6.*dot17*dot18*dot6+7.*dot25*dot6)+2.*dot28*(dot14-3.*dot5-dot7))*M2-
			     2.*dot12*(2.*dot11*(dot22-dot23)-4.*dot14*dot27+2.*(dot22+dot23)*(dot13-dot4)-
				       2.*dot43-4.*dot11*dot18*dot5-4.*dot13*dot18*dot5+4.*dot27*dot5+
				       4.*dot18*dot4*dot5-4.*dot13*dot18*dot7-2.*dot26*dot7+2.*dot27*dot7+
				       4.*dot18*dot4*dot7+dot35*M+2.*dot40*dot7*M+
				       dot25*(-3.*dot2+dot3+dot8-3.*(dot9+M2))+2.*dot17*(dot31-dot38*M+dot18*(dot2-dot3-dot8+dot9+M2)))))
		      /(16.*a1*a2*(-dot1+dot2+dot3+dot8+dot9+M2)*(-(a2*dot1)+dot2+dot9-a1*(dot2+dot3+dot9)+M2+(-2.+a1)*a1*M2)*(-dot9-a2*M2));
	    diag[18]=-0.125*M2*(-4.*dot2*dot20-2.*dot2*dot21+4.*dot11*(dot10-dot12)*dot22-4.*dot11*dot2*dot24-4.*dot16*dot2*dot26+
				8.*dot11*dot14*dot29+8.*dot17*dot2*dot29-8.*dot11*dot16*dot18*dot3+2.*dot21*dot3+4.*dot11*dot24*dot3+
				4.*dot16*dot27*dot3+4.*dot17*dot2*dot30-4.*dot17*dot3*dot30+4.*dot10*dot17*dot31-4.*dot12*dot17*dot31+
				4.*dot14*dot42-2.*dot10*dot43+2.*dot12*dot43+8.*dot11*dot12*dot18*dot5-4.*dot12*dot27*dot5+
				4.*dot2*dot28*dot5-4.*dot11*dot29*dot5-2.*dot42*dot5-8.*dot17*dot18*dot2*dot6-4.*dot11*dot22*dot6+
				4.*dot2*dot25*dot6-8.*dot14*dot26*dot6+8.*dot17*dot18*dot3*dot6-4.*dot25*dot3*dot6-4.*dot17*dot31*dot6+
				2.*dot43*dot6+4.*dot26*dot5*dot6-4.*dot10*dot26*dot7+4.*dot12*dot26*dot7+4.*dot2*dot28*dot7-
				4.*dot28*dot3*dot7+4.*dot26*dot6*dot7+
				2.*dot1*(2.*dot20+dot21+2.*dot11*dot24+2.*dot16*dot26-2.*dot25*dot6-
					 2.*dot17*(2.*dot29+dot30-2.*dot18*dot6)-2.*dot28*(dot5+dot7))-
				4.*dot20*dot9-4.*dot16*dot26*dot9+8.*dot17*dot29*dot9+4.*dot28*dot5*dot9+
				(-dot45-2.*a2*dot10*(2.*dot11*dot19-dot35+2.*dot17*dot38-2.*dot40*dot7)+
				 2.*(-(dot11*dot32)+dot17*dot48-2.*a2*dot11*dot19*(dot12-dot6)+dot34*dot6-a2*dot35*dot6-
				     2.*dot17*(dot37-a2*dot38)*dot6+dot49*dot7-2.*a2*dot40*dot6*dot7+
				     a2*dot12*(dot35-2.*dot17*dot38+2.*dot40*dot7)))*M-
				4.*a2*(dot20+dot16*dot26-2.*dot17*dot29-dot28*dot5)*M2)
	      /(a2*(dot1-dot2-dot3)*(-(a2*dot1)+dot2+dot9-a1*(dot2+dot3+dot9)+M2+(-2.+a1)*a1*M2)*(dot1-dot2-dot9-a2*M2));
	    diag[19]=M2*(-2.*dot2*dot21+4.*(-dot10+dot12)*dot13*dot22+4.*dot15*dot2*dot23+4.*dot13*dot2*dot24-
			 8.*dot13*dot14*dot29+8.*dot13*dot16*dot18*dot3+4.*dot20*dot3+2.*dot21*dot3-8.*dot15*dot22*dot3-
			 4.*dot15*dot23*dot3-4.*dot13*dot24*dot3+4.*dot16*dot26*dot3+4.*dot16*dot27*dot3-
			 8.*dot14*dot15*dot31-4.*dot10*dot23*dot4+4.*dot12*dot23*dot4-8.*dot16*dot18*dot3*dot4+
			 8.*dot24*dot3*dot4-8.*dot14*dot30*dot4+4.*dot14*dot42-2.*dot10*dot43+2.*dot12*dot43-
			 8.*dot12*dot13*dot18*dot5-4.*dot12*dot27*dot5+4.*dot13*dot29*dot5+8.*dot15*dot18*dot3*dot5-
			 4.*dot28*dot3*dot5+4.*dot15*dot31*dot5+4.*dot30*dot4*dot5-2.*dot42*dot5-4.*dot13*dot22*dot6-
			 4.*dot23*dot4*dot6-2.*dot43*dot6+8.*dot13*dot18*dot5*dot6+4.*dot27*dot5*dot6+
			 8.*dot13*dot29*dot7+8.*dot15*dot31*dot7+8.*dot30*dot4*dot7-4.*dot42*dot7+4.*dot20*dot8-
			 8.*dot15*dot22*dot8+4.*dot16*dot26*dot8-8.*dot16*dot18*dot4*dot8+8.*dot24*dot4*dot8+
			 8.*dot15*dot18*dot5*dot8-4.*dot28*dot5*dot8+
			 (2.*dot13*dot32+2.*a2*dot10*(2.*dot13*dot19+dot35)+2.*a2*dot12*(2.*dot13*dot19+dot35)+
			  2.*dot15*dot36+2.*dot33*dot4-dot45-2.*a2*(2.*dot13*dot19+dot35)*dot6)*M+
			 2.*dot1*(-2.*dot20-dot21+4.*dot15*dot22+2.*dot15*dot23+2.*dot13*(-2.*dot16*dot18+dot24)-
				  2.*dot16*(dot26+dot27)+dot14*(8.*dot15*dot18-4.*dot28)+
				  4.*(dot16*dot18-dot24)*dot4-8.*dot15*dot18*dot5+4.*dot28*dot5+
				  2.*dot25*(dot10-dot12+dot6)-8.*dot15*dot18*dot7+
				  4.*dot28*dot7-2.*dot15*dot19*M+dot46*M)+
			 4.*a1*(dot20-2.*dot15*dot22+dot16*dot26-2.*dot16*dot18*dot4+2.*dot24*dot4+
				2.*dot15*dot18*dot5-dot28*dot5)*M2)
	      /(8.*a1*a2*(dot1-dot2-dot3)*(dot8+a1*M2)*(-dot1+dot3+dot8+a1*M2));
	   //  diag[20]=-0.0625*M2*(-2.*dot2*dot20-2.*dot2*dot21+4.*dot15*dot2*dot22+4.*dot15*dot2*dot23-2.*dot20*dot3-
	   // 			 2.*dot21*dot3-4.*dot16*dot26*dot3-4.*dot16*dot27*dot3+4.*dot17*dot29*dot3+
	   // 			 4.*dot17*dot3*dot30-
	   // 			 4.*a2*(dot11+dot13)*((dot10-dot12)*(dot22+dot23)+2.*dot14*(dot29+dot30))-
	   // 			 4.*dot14*dot15*dot31-4.*dot13*dot16*dot31+4.*dot12*dot17*dot31-4.*a1*dot10*dot22*dot4+
	   // 			 4.*a1*dot12*dot22*dot4-4.*a1*dot10*dot23*dot4-4.*dot12*dot23*dot4+
	   // 			 4.*a1*dot12*dot23*dot4-8.*a1*dot14*dot29*dot4+8.*dot16*dot18*dot3*dot4-
	   // 			 4.*dot24*dot3*dot4+4.*dot14*dot30*dot4-8.*a1*dot14*dot30*dot4-
	   // 			 2.*dot10*dot43-2.*dot12*dot43+2.*dot11*dot44+2.*dot13*dot44-8.*dot11*dot12*dot18*dot5+
	   // 			 8.*a1*dot11*dot12*dot18*dot5-8.*dot12*dot13*dot18*dot5+8.*a1*dot12*dot13*dot18*dot5+
	   // 			 4.*dot12*dot27*dot5+4.*dot11*dot29*dot5-4.*a1*dot11*dot29*dot5+4.*dot13*dot29*dot5-
	   // 			 4.*a1*dot13*dot29*dot5+4.*dot28*dot3*dot5+4.*dot11*dot30*dot5-4.*a1*dot11*dot30*dot5-
	   // 			 4.*a1*dot13*dot30*dot5+4.*dot15*dot31*dot5-8.*a1*dot12*dot18*dot4*dot5+
	   // 			 4.*a1*dot29*dot4*dot5+4.*a1*dot30*dot4*dot5-2.*dot42*dot5+8.*dot11*dot14*dot18*dot6-
	   // 			 8.*a1*dot11*dot14*dot18*dot6+8.*dot13*dot14*dot18*dot6-8.*a1*dot13*dot14*dot18*dot6-
	   // 			 4.*dot13*dot22*dot6+4.*dot14*dot26*dot6-8.*dot17*dot18*dot3*dot6+4.*dot25*dot3*dot6-
	   // 			 8.*dot14*dot18*dot4*dot6+8.*a1*dot14*dot18*dot4*dot6+8.*dot13*dot18*dot5*dot6+
	   // 			 4.*dot1*(-(dot11*dot24)+dot10*dot25+(2.*dot15*dot18-dot28)*(dot14-dot5-dot7))-
	   // 			 8.*dot11*dot12*dot18*dot7+8.*a1*dot11*dot12*dot18*dot7-8.*dot12*dot13*dot18*dot7+
	   // 			 8.*a1*dot12*dot13*dot18*dot7-4.*dot12*dot26*dot7+4.*dot11*dot29*dot7-4.*a1*dot11*dot29*dot7+
	   // 			 8.*dot13*dot29*dot7-4.*a1*dot13*dot29*dot7+4.*dot28*dot3*dot7+4.*dot11*dot30*dot7-
	   // 			 4.*a1*dot11*dot30*dot7+4.*dot13*dot30*dot7-4.*a1*dot13*dot30*dot7+4.*dot15*dot31*dot7+
	   // 			 8.*dot12*dot18*dot4*dot7-8.*a1*dot12*dot18*dot4*dot7+4.*a1*dot29*dot4*dot7+
	   // 			 4.*a1*dot30*dot4*dot7-2.*dot42*dot7-8.*dot14*dot15*dot18*dot8+8.*a1*dot14*dot15*dot18*dot8-
	   // 			 8.*dot11*dot16*dot18*dot8+8.*a1*dot11*dot16*dot18*dot8-8.*dot12*dot17*dot18*dot8+
	   // 			 8.*a1*dot12*dot17*dot18*dot8+2.*dot20*dot8-4.*a1*dot20*dot8+4.*dot21*dot8-4.*a1*dot21*dot8-
	   // 			 4.*dot15*dot22*dot8+4.*a1*dot15*dot22*dot8-4.*dot15*dot23*dot8+4.*a1*dot15*dot23*dot8+
	   // 			 8.*dot11*dot24*dot8-8.*a1*dot11*dot24*dot8-4.*dot10*dot25*dot8+4.*a1*dot10*dot25*dot8+
	   // 			 4.*dot12*dot25*dot8-4.*a1*dot12*dot25*dot8-4.*a1*dot16*dot26*dot8+4.*dot16*dot27*dot8-
	   // 			 4.*a1*dot16*dot27*dot8+8.*dot14*dot28*dot8-8.*a1*dot14*dot28*dot8+4.*a1*dot17*dot29*dot8-
	   // 			 4.*dot17*dot30*dot8+4.*a1*dot17*dot30*dot8+8.*dot15*dot18*dot5*dot8-8.*a1*dot15*dot18*dot5*dot8-
	   // 			 4.*dot28*dot5*dot8+8.*a1*dot28*dot5*dot8+8.*dot17*dot18*dot6*dot8-8.*a1*dot17*dot18*dot6*dot8-
	   // 			 4.*dot25*dot6*dot8+4.*a1*dot25*dot6*dot8+8.*dot15*dot18*dot7*dot8-8.*a1*dot15*dot18*dot7*dot8-
	   // 			 8.*dot28*dot7*dot8+8.*a1*dot28*dot7*dot8-8.*dot14*dot15*dot18*dot9+8.*a1*dot14*dot15*dot18*dot9+
	   // 			 8.*dot13*dot16*dot18*dot9-8.*a1*dot13*dot16*dot18*dot9-8.*dot12*dot17*dot18*dot9+
	   // 			 8.*a1*dot12*dot17*dot18*dot9+2.*dot20*dot9-4.*a1*dot20*dot9+4.*dot21*dot9-4.*a1*dot21*dot9+
	   // 			 4.*a1*dot15*dot22*dot9-4.*dot15*dot23*dot9+4.*a1*dot15*dot23*dot9-8.*dot13*dot24*dot9+
	   // 			 8.*a1*dot13*dot24*dot9-4.*dot10*dot25*dot9+4.*a1*dot10*dot25*dot9+4.*dot12*dot25*dot9-
	   // 			 4.*a1*dot12*dot25*dot9+4.*dot16*dot26*dot9-4.*a1*dot16*dot26*dot9+4.*dot16*dot27*dot9-
	   // 			 4.*a1*dot16*dot27*dot9+8.*dot14*dot28*dot9-8.*a1*dot14*dot28*dot9-4.*dot17*dot29*dot9+
	   // 			 4.*a1*dot17*dot29*dot9-4.*dot17*dot30*dot9+4.*a1*dot17*dot30*dot9-8.*dot16*dot18*dot4*dot9+
	   // 			 8.*a1*dot16*dot18*dot4*dot9+4.*dot24*dot4*dot9-8.*a1*dot24*dot4*dot9+8.*dot15*dot18*dot5*dot9-
	   // 			 8.*a1*dot15*dot18*dot5*dot9-8.*dot28*dot5*dot9+8.*a1*dot28*dot5*dot9+8.*dot17*dot18*dot6*dot9-
	   // 			 8.*a1*dot17*dot18*dot6*dot9-4.*dot25*dot6*dot9+4.*a1*dot25*dot6*dot9+8.*dot15*dot18*dot7*dot9-
	   // 			 8.*a1*dot15*dot18*dot7*dot9-8.*dot28*dot7*dot9+8.*a1*dot28*dot7*dot9-
	   // 			 2.*dot1*(2.*dot15*dot19+2.*a2*(dot17*dot39-dot16*dot40)+(-2.+a1)*dot46)*M+
	   // 			 (2.*dot15*dot36-dot45-
	   // 			  2.*a2*dot10*(-2.*a2*(dot11+dot13)*dot19+dot35-2.*dot17*dot38-2.*a1*dot19*dot4+2.*dot40*dot7)+
	   // 			  2.*(dot13*dot32-a1*dot13*dot32+2.*dot13*dot33-2.*a1*dot13*dot33-2.*dot13*dot16*dot38+
	   // 			      2.*a1*dot13*dot16*dot38+2.*dot17*dot2*dot39-2.*a1*dot17*dot2*dot39+2.*dot17*dot3*dot39-
	   // 			      2.*a1*dot17*dot3*dot39+a1*dot32*dot4-dot33*dot4+2.*a1*dot33*dot4+2.*dot16*dot38*dot4-
	   // 			      2.*a1*dot16*dot38*dot4-2.*dot16*dot2*dot40+2.*a1*dot16*dot2*dot40-2.*dot16*dot3*dot40+
	   // 			      2.*a1*dot16*dot3*dot40-dot2*dot46+a1*dot2*dot46-dot3*dot46+a1*dot3*dot46-4.*dot13*dot19*dot6+
	   // 			      6.*a1*dot13*dot19*dot6-2.*a12*dot13*dot19*dot6+dot35*dot6-a1*dot35*dot6-2.*dot17*dot38*dot6+
	   // 			      2.*a1*dot17*dot38*dot6+2.*dot19*dot4*dot6-4.*a1*dot19*dot4*dot6+2.*a12*dot19*dot4*dot6+
	   // 			      2.*dot13*dot39*dot7-2.*a1*dot13*dot39*dot7-2.*dot39*dot4*dot7+2.*a1*dot39*dot4*dot7+
	   // 			      2.*dot40*dot6*dot7-2.*a1*dot40*dot6*dot7-
	   // 			      a2*dot12*(-2.*a2*dot13*dot19+dot35-2.*dot17*dot38-2.*a1*dot19*dot4+2.*dot40*dot7)-
	   // 			      a2*dot11*(-2.*a2*dot12*dot19-dot32-2.*(dot33-dot16*dot38+(-2.+a1)*dot19*dot6+dot39*dot7))+
	   // 			      2.*dot15*dot19*dot8-2.*a1*dot15*dot19*dot8+2.*dot17*dot39*dot8-2.*a1*dot17*dot39*dot8-
	   // 			      2.*dot16*dot40*dot8+2.*a1*dot16*dot40*dot8-2.*dot46*dot8+2.*a1*dot46*dot8+
	   // 			      2.*a2*(dot15*dot19+dot17*dot39-dot16*dot40-dot46)*dot9))*M+
	   // 			 4.*a2*(dot15*dot19+dot17*dot39-dot16*dot40-dot46)*pow<3,1>(M)+
	   // 			 2.*(dot20-2.*dot10*dot25-4.*a2*dot14*(dot15*dot18-dot28)+
	   // 			     4.*a12*(dot16*dot18-dot24)*(dot11+dot13-dot4)-
	   // 			     2.*a1*(2.*dot11*dot16*dot18+4.*dot13*dot16*dot18-2.*dot12*dot17*dot18+dot20-
	   // 				    2.*dot11*dot24-4.*dot13*dot24-dot10*dot25+dot12*dot25+2.*dot16*dot26-
	   // 				    2.*dot17*dot29-4.*dot16*dot18*dot4+3.*dot24*dot4+2.*dot15*dot18*dot5-
	   // 				    3.*dot28*dot5+dot17*dot18*dot6+dot15*dot18*dot7-dot28*dot7)+
	   // 			     2.*(2.*dot13*dot16*dot18-2.*dot12*dot17*dot18-2.*dot13*dot24+dot12*dot25+
	   // 				 dot16*dot26-dot17*dot29-2.*dot16*dot18*dot4+dot24*dot4+2.*dot15*dot18*dot5-
	   // 				 2.*dot28*dot5+dot17*dot18*dot6+dot15*dot18*dot7-dot28*dot7))*M2)
	   //    /(a1*a2*(dot1-dot2-dot3)*(dot8+a1*M2)*(dot1-a2*(dot8+dot9+M2)));
	   // diag[21]=-0.0625*M2*(4.*dot12*dot17*dot18*dot2-4.*a1*dot12*dot17*dot18*dot2-3.*dot2*dot20+a1*dot2*dot20-dot2*dot21+
	   // 			a1*dot2*dot21-4.*dot10*dot11*dot22+4.*a1*dot10*dot11*dot22+4.*dot11*dot12*dot22-4.*a1*dot11*dot12*dot22+
	   // 			4.*a1*dot10*dot13*dot22-4.*a1*dot12*dot13*dot22+4.*dot15*dot2*dot22-4.*dot10*dot11*dot23+
	   // 			4.*a1*dot10*dot11*dot23-4.*dot11*dot12*dot23+4.*a1*dot11*dot12*dot23+4.*dot10*dot13*dot23-
	   // 			4.*a1*dot10*dot13*dot23+4.*dot12*dot13*dot23-4.*a1*dot12*dot13*dot23+2.*dot11*dot2*dot24-
	   // 			2.*a1*dot11*dot2*dot24-4.*a1*dot13*dot2*dot24-4.*dot10*dot2*dot25+4.*a1*dot10*dot2*dot25-
	   // 			6.*dot12*dot2*dot25+6.*a1*dot12*dot2*dot25-8.*dot10*dot14*dot27+8.*a1*dot10*dot14*dot27-
	   // 			8.*dot12*dot14*dot27+8.*a1*dot12*dot14*dot27-2.*dot14*dot2*dot28+2.*a1*dot14*dot2*dot28-
	   // 			8.*dot11*dot14*dot29+8.*a1*dot11*dot14*dot29+8.*a1*dot13*dot14*dot29+2.*dot17*dot2*dot29-
	   // 			2.*a1*dot17*dot2*dot29+8.*dot11*dot16*dot18*dot3-8.*a1*dot11*dot16*dot18*dot3-
	   // 			8.*a1*dot13*dot16*dot18*dot3-8.*dot10*dot17*dot18*dot3+8.*a1*dot10*dot17*dot18*dot3-
	   // 			4.*dot12*dot17*dot18*dot3+4.*a1*dot12*dot17*dot18*dot3+dot20*dot3+a1*dot20*dot3+
	   // 			3.*dot21*dot3+a1*dot21*dot3-4.*dot15*dot23*dot3-6.*dot11*dot24*dot3+6.*a1*dot11*dot24*dot3+
	   // 			4.*a1*dot13*dot24*dot3+4.*dot10*dot25*dot3-4.*a1*dot10*dot25*dot3+2.*dot12*dot25*dot3-
	   // 			2.*a1*dot12*dot25*dot3-2.*dot14*dot28*dot3+2.*a1*dot14*dot28*dot3-2.*dot17*dot29*dot3-
	   // 			2.*a1*dot17*dot29*dot3+2.*dot17*dot2*dot30-2.*a1*dot17*dot2*dot30-2.*dot17*dot3*dot30-
	   // 			2.*a1*dot17*dot3*dot30-4.*dot14*dot15*dot31-4.*dot11*dot16*dot31+4.*a1*dot11*dot16*dot31+
	   // 			4.*a1*dot13*dot16*dot31+4.*dot10*dot17*dot31-4.*a1*dot10*dot17*dot31-4.*a1*dot12*dot17*dot31-
	   // 			4.*a1*dot10*dot22*dot4+4.*a1*dot12*dot22*dot4-4.*dot10*dot23*dot4+4.*a1*dot10*dot23*dot4+
	   // 			4.*a1*dot12*dot23*dot4-4.*dot2*dot24*dot4+4.*a1*dot2*dot24*dot4-8.*a1*dot14*dot29*dot4+
	   // 			8.*a1*dot16*dot18*dot3*dot4-4.*a1*dot24*dot3*dot4-4.*dot14*dot30*dot4-4.*a1*dot16*dot31*dot4+
	   // 			4.*dot14*dot42-4.*dot10*dot43+4.*a1*dot10*dot43+4.*a1*dot12*dot43+6.*dot11*dot44-4.*a1*dot11*dot44-
	   // 			2.*dot13*dot44-4.*a1*dot13*dot44+4.*a1*dot4*dot44-8.*dot11*dot12*dot18*dot5+
	   // 			8.*a1*dot11*dot12*dot18*dot5+8.*a1*dot12*dot13*dot18*dot5+8.*dot10*dot27*dot5-
	   // 			8.*a1*dot10*dot27*dot5+8.*dot12*dot27*dot5-8.*a1*dot12*dot27*dot5+2.*dot2*dot28*dot5-
	   // 			2.*a1*dot2*dot28*dot5+4.*dot11*dot29*dot5-4.*a1*dot11*dot29*dot5-4.*a1*dot13*dot29*dot5+
	   // 			2.*dot28*dot3*dot5-2.*a1*dot28*dot3*dot5-4.*dot11*dot30*dot5+4.*a1*dot11*dot30*dot5+
	   // 			4.*a1*dot13*dot30*dot5+4.*dot15*dot31*dot5-8.*a1*dot12*dot18*dot4*dot5+4.*a1*dot29*dot4*dot5+
	   // 			4.*dot30*dot4*dot5-4.*a1*dot30*dot4*dot5-4.*dot42*dot5-4.*dot17*dot18*dot2*dot6+
	   // 			4.*a1*dot17*dot18*dot2*dot6-4.*dot11*dot22*dot6+4.*a1*dot11*dot22*dot6+4.*dot13*dot22*dot6+
	   // 			4.*a1*dot13*dot22*dot6+4.*dot11*dot23*dot6-4.*a1*dot11*dot23*dot6-4.*dot13*dot23*dot6+
	   // 			4.*a1*dot13*dot23*dot6+6.*dot2*dot25*dot6-6.*a1*dot2*dot25*dot6-4.*dot14*dot26*dot6+
	   // 			8.*dot14*dot27*dot6-8.*a1*dot14*dot27*dot6+4.*dot17*dot18*dot3*dot6-4.*a1*dot17*dot18*dot3*dot6-
	   // 			6.*dot25*dot3*dot6+2.*a1*dot25*dot3*dot6+4.*a1*dot17*dot31*dot6+8.*dot14*dot18*dot4*dot6-
	   // 			4.*a1*dot22*dot4*dot6+4.*dot23*dot4*dot6-4.*a1*dot23*dot4*dot6+2.*dot43*dot6-4.*a1*dot43*dot6+
	   // 			8.*dot11*dot18*dot5*dot6-8.*a1*dot11*dot18*dot5*dot6-8.*a1*dot13*dot18*dot5*dot6+
	   // 			4.*dot26*dot5*dot6-8.*dot27*dot5*dot6+8.*a1*dot27*dot5*dot6-8.*dot18*dot4*dot5*dot6+
	   // 			8.*a1*dot18*dot4*dot5*dot6-8.*dot10*dot13*dot18*dot7+8.*a1*dot10*dot13*dot18*dot7-
	   // 			8.*dot12*dot13*dot18*dot7+8.*a1*dot12*dot13*dot18*dot7-4.*dot10*dot26*dot7+
	   // 			4.*a1*dot10*dot26*dot7+4.*a1*dot12*dot26*dot7+4.*dot10*dot27*dot7-4.*a1*dot10*dot27*dot7+
	   // 			4.*dot12*dot27*dot7-4.*a1*dot12*dot27*dot7+2.*dot2*dot28*dot7-2.*a1*dot2*dot28*dot7+
	   // 			8.*dot11*dot29*dot7-8.*a1*dot11*dot29*dot7-4.*dot13*dot29*dot7-8.*a1*dot13*dot29*dot7+
	   // 			8.*dot15*dot18*dot3*dot7-2.*dot28*dot3*dot7-2.*a1*dot28*dot3*dot7+8.*dot10*dot18*dot4*dot7-
	   // 			8.*a1*dot10*dot18*dot4*dot7-8.*a1*dot12*dot18*dot4*dot7+8.*a1*dot29*dot4*dot7-2.*dot42*dot7+
	   // 			8.*dot13*dot18*dot6*dot7-8.*a1*dot13*dot18*dot6*dot7+4.*dot26*dot6*dot7-4.*a1*dot26*dot6*dot7-
	   // 			4.*dot27*dot6*dot7+4.*a1*dot27*dot6*dot7-8.*dot18*dot4*dot6*dot7+8.*a1*dot18*dot4*dot6*dot7+
	   // 			dot1*(dot20-dot21-4.*dot15*dot22-6.*dot11*dot24+4.*dot10*dot25+
	   // 			      2.*dot12*(2.*(1.+a1)*dot17*dot18+dot25-3.*a1*dot25)-2.*dot14*dot28+
	   // 			      2.*(2.*dot24*dot4-dot25*dot6+dot17*(dot29+dot30-2.*dot18*dot6)+dot28*(dot5+dot7))-
	   // 			      a1*(dot20+dot21-2.*(-2.*dot10*dot25+dot24*(dot11+2.*dot13-2.*dot4)+
	   // 						  3.*dot25*dot6+dot17*(dot29+dot30-2.*dot18*dot6)+dot28*(-dot14+dot5+dot7))))-
	   // 			8.*dot10*dot17*dot18*dot8+8.*a1*dot10*dot17*dot18*dot8-8.*dot12*dot17*dot18*dot8+
	   // 			8.*a1*dot12*dot17*dot18*dot8+2.*dot20*dot8+4.*dot10*dot25*dot8-4.*a1*dot10*dot25*dot8+
	   // 			4.*dot12*dot25*dot8-4.*a1*dot12*dot25*dot8-4.*dot17*dot29*dot8+8.*dot17*dot18*dot6*dot8-
	   // 			8.*a1*dot17*dot18*dot6*dot8-4.*dot25*dot6*dot8+4.*a1*dot25*dot6*dot8-2.*dot20*dot9+
	   // 			4.*dot15*dot22*dot9-4.*dot10*dot25*dot9+4.*a1*dot10*dot25*dot9-4.*dot12*dot25*dot9+
	   // 			4.*a1*dot12*dot25*dot9-4.*dot24*dot4*dot9+4.*dot25*dot6*dot9-4.*a1*dot25*dot6*dot9+
	   // 			2.*(-(a2*dot11)+a1*(dot13-dot4))*(-dot32-2.*a2*dot19*(dot10+dot12-dot6))*M+
	   // 			2.*(-dot20+2.*dot15*dot22-2.*dot24*dot4+4.*a12*(dot17*dot18-dot25)*(dot10+dot12-dot6)-
	   // 			    2.*dot25*(dot10+dot12-dot6)+
	   // 			    2.*a1*(-2.*dot10*dot17*dot18-2.*dot12*dot17*dot18+dot20-dot15*dot22+
	   // 				   3.*dot10*dot25+3.*dot12*dot25-dot17*dot29+
	   // 				   dot24*dot4+2.*dot17*dot18*dot6-3.*dot25*dot6))*M2)
	   //   /(a1*a2*(dot1-dot2-dot3)*(dot8+a1*M2)*(-(a2*dot1)+dot2+dot9-a1*(dot2+dot3+dot9)+M2+(-2.+a1)*a1*M2));
	    ...
	    diag[28]=-0.125*M2*(-4.*dot14*dot15*dot18*dot2+4.*dot13*dot16*dot18*dot2-2.*dot1*dot20-dot2*dot20-
				3.*dot2*dot21+2.*dot15*dot2*dot22+4.*dot10*dot11*dot23-4.*dot10*dot13*dot23+
				6.*dot15*dot2*dot23-2.*dot13*dot2*dot24+2.*dot10*dot2*dot25-2.*dot16*dot2*dot26+
				8.*dot10*dot14*dot27-6.*dot16*dot2*dot27+2.*dot14*dot2*dot28+8.*dot10*dot17*dot18*dot3+
				2.*dot20*dot3-4.*dot15*dot22*dot3-4.*dot10*dot25*dot3+4.*dot16*dot26*dot3-
				4.*dot17*dot29*dot3+4.*dot17*dot2*dot30-8.*dot14*dot15*dot31-4.*dot11*dot16*dot31+
				4.*dot13*dot16*dot31+4.*dot16*dot18*dot2*dot4-4.*dot10*dot23*dot4-2.*dot2*dot24*dot4-
				8.*dot16*dot18*dot3*dot4+4.*dot24*dot3*dot4-8.*dot14*dot30*dot4+4.*dot16*dot31*dot4+
				4.*dot14*dot42+2.*dot11*dot44-2.*dot13*dot44-2.*dot4*dot44-4.*dot15*dot18*dot2*dot5+
				2.*dot2*dot28*dot5+8.*dot15*dot18*dot3*dot5-4.*dot28*dot3*dot5-4.*dot11*dot30*dot5+
				4.*dot13*dot30*dot5+4.*dot30*dot4*dot5+8.*dot10*dot13*dot18*dot7-4.*dot15*dot18*dot2*dot7-
				4.*dot10*dot27*dot7+2.*dot2*dot28*dot7-4.*dot13*dot29*dot7+4.*dot15*dot31*dot7+
				4.*dot30*dot4*dot7-2.*dot42*dot7+
				4.*dot1*(4.*dot14*dot15*dot18+2.*dot11*dot16*dot18-2.*dot13*dot16*dot18-
					 2.*dot10*dot17*dot18+dot15*dot22-dot11*dot24+dot13*dot24+dot10*dot25-
					 dot16*dot26-2.*dot14*dot28+dot17*dot29-2.*dot15*dot18*dot5+
					 dot28*dot5-2.*dot15*dot18*dot7+dot28*dot7)+
				8.*dot10*dot17*dot18*dot8+2.*dot20*dot8-4.*dot15*dot22*dot8-4.*dot10*dot25*dot8+
				4.*dot16*dot26*dot8-4.*dot17*dot29*dot8-8.*dot16*dot18*dot4*dot8+4.*dot24*dot4*dot8+
				8.*dot15*dot18*dot5*dot8-4.*dot28*dot5*dot8-2.*dot20*dot9+4.*dot15*dot22*dot9+
				4.*dot10*dot25*dot9-4.*dot16*dot26*dot9+8.*dot16*dot18*dot4*dot9-4.*dot24*dot4*dot9-
				8.*dot15*dot18*dot5*dot9+4.*dot28*dot5*dot9+
				2.*(-(a2*dot11)+a1*dot13+dot4-a1*dot4)*(2.*dot10*dot19-dot32+2.*dot16*dot37-2.*dot39*dot5)*M+
				2.*(-dot20+2.*dot15*dot22+2.*dot10*dot25-2.*dot16*dot26+4.*dot16*dot18*dot4-
				    2.*dot24*dot4-4.*dot15*dot18*dot5+2.*dot28*dot5+
				    2.*a1*(2.*dot10*dot17*dot18+dot20-2.*dot15*dot22-2.*dot10*dot25+2.*dot16*dot26-
					   dot17*dot29-4.*dot16*dot18*dot4+2.*dot24*dot4+4.*dot15*dot18*dot5-2.*dot28*dot5))*M2)
	      /(a2*dot2*(-dot9-a2*M2)*(-dot2+a1*(-dot1+dot2+dot3+dot8+a1*M2)));
