...
/**
 * The MEee2Mesons2 class is designed to simulate the production of a small
 * number of mesons via the weak current
 *
 * @see \ref MEee2Mesons2Interfaces "The interfaces"
 * defined for MEee2Mesons2.
 */
class MEee2Mesons2: public HwMEBase {
...
private:
   ...
   */
  MEee2Mesons2 & operator=(const MEee2Mesons2 &);
