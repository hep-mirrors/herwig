...
RhoDMatrix HardVertex::getRhoMatrix(int i,bool) const {
  ...
  if(debug_basis_states) {
    ...
    for(unsigned int ix=0;ix<incoming().size();++ix)
      cout << "in " << ix << " = " 
	   << dynamic_ptr_cast<tcSpinfoPtr>(incoming()[ix])
	                  ->currentMomentum()/GeV << "   ";
    cout << endl;
    for(unsigned int ix=0;ix<outgoing().size();++ix)
      cout << "out " << ix <<" = " 
	   << dynamic_ptr_cast<tcSpinfoPtr>(outgoing()[ix])
                          ->currentMomentum()/GeV << "   ";
    cout << endl;
    ...
    cout << "in 0  : p.vtx " << in0->getProductionVertex() << "  ";
    cout << " hel -: ";
    ...
    cout << endl;
    cout << "in 1  : p.vtx " << in1->getProductionVertex() << "  ";
    cout << " hel -: ";
    for(unsigned int ix=0;ix<4;ix++) 
    ...
    cout << endl;
    cout << "out 0 : p.vtx " << out0->getProductionVertex() << "  ";
    cout << " hel -: ";
    ...
    cout << "out 1 : p.vtx " << out1->getProductionVertex() << "  ";
    cout << " hel -: ";
    ...
    if(outgoing().size()>2) {
      ...
      cout << "out 2 : p.vtx " << out2->getProductionVertex() << "  ";
      cout << " hel -: ";
