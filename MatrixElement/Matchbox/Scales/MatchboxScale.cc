...
string MatchboxScale::doFunction(string in) {
  ...
  scaleFile<< "namespace Herwig {\n" ;
  scaleFile<< "using namespace ThePEG;\n" ;
  ...
  makeFile<< "THEPEG=/home/johannes/Herwigpp/Programme/ThePEG                              \n" ;
  makeFile<< "HERWIG=/home/johannes/Herwigpp/Programme/H++-general                                  \n" ;
  makeFile<< "INCLUDE=-I $(THEPEG)/include -I $(HERWIG)/include\n" ;
  makeFile<< "LIBPATH=-L/home/johannes/Herwigpp/Programme/ThePEG/lib64/ThePEG                          \n" ;
  makeFile<< "all:                                             \n" ;
  makeFile<< "    g++ --shared -g3  -fPIC -o "<<scalePath<<"Scale.so $(INCLUDE) $(LIBPATH) -lThePEG   Scale.h\n" ;
  makeFile<< flush ;	  
