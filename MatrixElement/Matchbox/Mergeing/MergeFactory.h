// -*- C++ -*-
//
// MergeFactory.h is a part of Herwig - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2012 The Herwig Collaboration
//
// Herwig is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_MergeFactory_H
#define HERWIG_MergeFactory_H
//
...
namespace Herwig {
   ...
   *
   * \brief MergeFactory automatically sets up a NLO
   * QCD calculation carried out in dipole subtraction.
   *
   * @see \ref MergeFactoryInterfaces "The interfaces"
   * defined for MergeboxFactory.
   */
  class MergeFactory : public MatchboxFactory {
  public:
...
*/
     ...
     */
    MergeFactory & operator=(const MergeFactory &);
