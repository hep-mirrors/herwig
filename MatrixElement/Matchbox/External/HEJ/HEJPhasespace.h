// -*- C++ -*-
//
// HEJPhasespace.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_HEJPhasespace_H
#define Herwig_HEJPhasespace_H
//
// This is the declaration of the HEJPhasespace class.
//
 ...
 * \brief HEJPhasespace provides an interface to HEJ's phasespace generator.
 *
 * @see \ref HEJPhasespaceInterfaces "The interfaces"
 * defined for HEJPhasespace.
 */
class HEJPhasespace: public Herwig::MatchboxPhasespace {
...
private:
   ...
   */
  HEJPhasespace & operator=(const HEJPhasespace &);

};

}

#endif /* Herwig_HEJPhasespace_H */
