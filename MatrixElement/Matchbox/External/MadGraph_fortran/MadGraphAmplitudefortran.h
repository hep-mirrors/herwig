// -*- C++ -*-
//
// MadGraphAmplitudefortran.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2012 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_MadGraphAmplitudefortran_H
#define Herwig_MadGraphAmplitudefortran_H
//
// This is the declaration of the MadGraphAmplitudefortran class.
//
 ...
 *
 * \brief MadGraphAmplitudefortran implements an interface to MadGraph
 */
class MadGraphAmplitudefortran: 
...
public:
   ...
   */
  MadGraphAmplitudefortran();

  /**
   * The destructor.
   */
  virtual ~MadGraphAmplitudefortran();
  //@}
...
private:
   ...
   */
  MadGraphAmplitudefortran & operator=(const MadGraphAmplitudefortran &);
...
#endif /* Herwig_MadGraphAmplitudefortran_H */
