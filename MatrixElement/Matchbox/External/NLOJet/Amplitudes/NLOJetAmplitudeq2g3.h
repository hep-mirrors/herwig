// -*- C++ -*-
//
// NLOJetAmplitudeq2g3.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeq2g3_H
#define Herwig_NLOJetAmplitudeq2g3_H
//
// This is the declaration of the NLOJetAmplitudeq2g3 class.
//
 ...
 *
 * \brief NLOJetAmplitudeq2g3
 *
 * @see \ref NLOJetAmplitudeq2g3Interfaces "The interfaces"
 * defined for NLOJetAmplitudeq2g3.
 */
class NLOJetAmplitudeq2g3: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeq2g3 & operator=(const NLOJetAmplitudeq2g3 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampq2g3* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeq2g3_H */
