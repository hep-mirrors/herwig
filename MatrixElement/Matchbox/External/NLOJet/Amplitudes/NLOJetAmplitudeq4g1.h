// -*- C++ -*-
//
// NLOJetAmplitudeq4g1.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeq4g1_H
#define Herwig_NLOJetAmplitudeq4g1_H
//
// This is the declaration of the NLOJetAmplitudeq4g1 class.
//
 ...
 *
 * \brief NLOJetAmplitudeq4g1
 *
 * @see \ref NLOJetAmplitudeq4g1Interfaces "The interfaces"
 * defined for NLOJetAmplitudeq4g1.
 */
class NLOJetAmplitudeq4g1: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeq4g1 & operator=(const NLOJetAmplitudeq4g1 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampq4g1* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeq4g1_H */
