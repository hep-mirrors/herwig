// -*- C++ -*-
//
// NLOJetAmplitudeq6.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeq6_H
#define Herwig_NLOJetAmplitudeq6_H
//
// This is the declaration of the NLOJetAmplitudeq6 class.
//
 ...
 *
 * \brief NLOJetAmplitudeq6
 *
 * @see \ref NLOJetAmplitudeq6Interfaces "The interfaces"
 * defined for NLOJetAmplitudeq6.
 */
class NLOJetAmplitudeq6: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeq6 & operator=(const NLOJetAmplitudeq6 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampq6* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeq6_H */
