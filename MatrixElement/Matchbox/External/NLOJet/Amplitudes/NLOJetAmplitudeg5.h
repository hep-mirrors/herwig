// -*- C++ -*-
//
// NLOJetAmplitudeg5.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeg5_H
#define Herwig_NLOJetAmplitudeg5_H
//
// This is the declaration of the NLOJetAmplitudeg5 class.
//
 ...
 *
 * \brief NLOJetAmplitudeg5
 *
 * @see \ref NLOJetAmplitudeg5Interfaces "The interfaces"
 * defined for NLOJetAmplitudeg5.
 */
class NLOJetAmplitudeg5: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeg5 & operator=(const NLOJetAmplitudeg5 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampg5* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeg5_H */
