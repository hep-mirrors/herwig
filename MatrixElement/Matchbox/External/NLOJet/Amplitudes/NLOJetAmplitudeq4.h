// -*- C++ -*-
//
// NLOJetAmplitudeq4.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeq4_H
#define Herwig_NLOJetAmplitudeq4_H
//
// This is the declaration of the NLOJetAmplitudeq4 class.
//
 ...
 *
 * \brief NLOJetAmplitudeq4
 *
 * @see \ref NLOJetAmplitudeq4Interfaces "The interfaces"
 * defined for NLOJetAmplitudeq4.
 */
class NLOJetAmplitudeq4: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeq4 & operator=(const NLOJetAmplitudeq4 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampq4* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeq4_H */
