// -*- C++ -*-
//
// NLOJetAmplitudeq4g2.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeq4g2_H
#define Herwig_NLOJetAmplitudeq4g2_H
//
// This is the declaration of the NLOJetAmplitudeq4g2 class.
//
 ...
 *
 * \brief NLOJetAmplitudeq4g2
 *
 * @see \ref NLOJetAmplitudeq4g2Interfaces "The interfaces"
 * defined for NLOJetAmplitudeq4g2.
 */
class NLOJetAmplitudeq4g2: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeq4g2 & operator=(const NLOJetAmplitudeq4g2 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampq4g2* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeq4g2_H */
