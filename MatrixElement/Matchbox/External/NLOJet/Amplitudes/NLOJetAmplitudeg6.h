// -*- C++ -*-
//
// NLOJetAmplitudeg6.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeg6_H
#define Herwig_NLOJetAmplitudeg6_H
//
// This is the declaration of the NLOJetAmplitudeg6 class.
//
 ...
 *
 * \brief NLOJetAmplitudeg6
 *
 * @see \ref NLOJetAmplitudeg6Interfaces "The interfaces"
 * defined for NLOJetAmplitudeg6.
 */
class NLOJetAmplitudeg6: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeg6 & operator=(const NLOJetAmplitudeg6 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampg6* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeg6_H */
