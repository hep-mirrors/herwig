// -*- C++ -*-
//
// NLOJetAmplitudeq2g4.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef Herwig_NLOJetAmplitudeq2g4_H
#define Herwig_NLOJetAmplitudeq2g4_H
//
// This is the declaration of the NLOJetAmplitudeq2g4 class.
//
 ...
 *
 * \brief NLOJetAmplitudeq2g4
 *
 * @see \ref NLOJetAmplitudeq2g4Interfaces "The interfaces"
 * defined for NLOJetAmplitudeq2g4.
 */
class NLOJetAmplitudeq2g4: public Herwig::NLOJetAmplitude<0,2,0> {
...
private:
   ...
   */
  NLOJetAmplitudeq2g4 & operator=(const NLOJetAmplitudeq2g4 &);

  /**
   * A pointer to the amplitude class
   */
  nlo::ampq2g4* theAmplitude;

};

}

#endif /* Herwig_NLOJetAmplitudeq2g4_H */
