// -*- C++ -*-
//
// NLOJetMEkbq2qkb.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEkbq2qkb_H
#define HERWIG_NLOJetMEkbq2qkb_H
//
// This is the declaration of the NLOJetMEkbq2qkb class.
//
 ...
 *
 * \brief NLOJetMEkbq2qkb This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEkbq2qkbInterfaces "The interfaces"
 * defined for NLOJetMEkbq2qkb.
 */
class NLOJetMEkbq2qkb: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEkbq2qkb & operator=(const NLOJetMEkbq2qkb &);

};

}

#endif /* HERWIG_NLOJetMEkbq2qkb_H */
