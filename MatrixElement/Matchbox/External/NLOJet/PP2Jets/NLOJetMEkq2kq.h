// -*- C++ -*-
//
// NLOJetMEkq2kq.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEkq2kq_H
#define HERWIG_NLOJetMEkq2kq_H
//
// This is the declaration of the NLOJetMEkq2kq class.
//
 ...
 *
 * \brief NLOJetMEkq2kq This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEkq2kqInterfaces "The interfaces"
 * defined for NLOJetMEkq2kq.
 */
class NLOJetMEkq2kq: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEkq2kq & operator=(const NLOJetMEkq2kq &);

};

}

#endif /* HERWIG_NLOJetMEkq2kq_H */
