// -*- C++ -*-
//
// NLOJetMEqbq2gg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqbq2gg_H
#define HERWIG_NLOJetMEqbq2gg_H
//
// This is the declaration of the NLOJetMEqbq2gg class.
//
 ...
 *
 * \brief NLOJetMEqbq2gg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqbq2ggInterfaces "The interfaces"
 * defined for NLOJetMEqbq2gg.
 */
class NLOJetMEqbq2gg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqbq2gg & operator=(const NLOJetMEqbq2gg &);

};

}

#endif /* HERWIG_NLOJetMEqbq2gg_H */
