// -*- C++ -*-
//
// NLOJetMEqg2qg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqg2qg_H
#define HERWIG_NLOJetMEqg2qg_H
//
// This is the declaration of the NLOJetMEqg2qg class.
//
 ...
 *
 * \brief NLOJetMEqg2qg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqg2qgInterfaces "The interfaces"
 * defined for NLOJetMEqg2qg.
 */
class NLOJetMEqg2qg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqg2qg & operator=(const NLOJetMEqg2qg &);

};

}

#endif /* HERWIG_NLOJetMEqg2qg_H */
