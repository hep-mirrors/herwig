// -*- C++ -*-
//
// NLOJetMEqbq2kkbg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEqbq2kkbg class.
//

#include "NLOJetMEqbq2kkbg.h"
...
NLOJetMEqbq2kkbg::NLOJetMEqbq2kkbg() {}

NLOJetMEqbq2kkbg::~NLOJetMEqbq2kkbg() {}

IBPtr NLOJetMEqbq2kkbg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEqbq2kkbg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEqbq2kkbg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEqbq2kkbg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEqbq2kkbg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEqbq2kkbg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEqbq2kkbg("Herwig::NLOJetMEqbq2kkbg", "HwMatchboxNLOJet.so");

void NLOJetMEqbq2kkbg::Init() {

  static ClassDocumentation<NLOJetMEqbq2kkbg> documentation
    ("NLOJetMEqbq2kkbg");

}


void NLOJetMEqbq2kkbg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    for(unsigned xi2 = 0; xi2 != quark.size(); xi2++){ 
      ...
      addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, g, 4, k, 4, kb, 3, g, -1)));
      addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, k, 4, k, 3, kb, 4, g, -2)));
      addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, kb, 3, k, 4, kb, 4, g, -3)));
      addSafe(new_ptr((Tree2toNDiagram(3), qb, qb, q, 2, g, 4, k, 4, kb, 1, g, -4)));
      addSafe(new_ptr((Tree2toNDiagram(3), qb, qb, q, 1, g, 4, k, 4, kb, 2, g, -5)));
      if( ( xi1 ==  xi2 ) ){ 
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, q, 3, q, 1, qb, 2, g, -6)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, qb, q, 2, q, 1, qb, 3, g, -7)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 2, q, 4, q, 1, qb, 4, g, -8)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, q, 3, q, 2, qb, 1, g, -9)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 1, qb, 2, q, 4, qb, 4, g, -10)));
      }
    }  
  }  
}
...
Selector <MEBase::DiagramIndex> NLOJetMEqbq2kkbg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { -1, 2, -999, 1, 3, 0, -999};
  static const int cv1at1[]  = { -1, 3, 2, -999, 1, 0, -999};
  static const int cv2at0[]  = { -1, 2, -999, 1, 3, 0, -999};
  static const int cv3at0[]  = { -1, 3, 2, -999, 1, 0, -999};
  static const int cv4at0[]  = { -1, 3, 2, -999, 1, 0, -999};
  static const int cv5at0[]  = { -1, 2, -999, 1, 3, 0, -999};
  static const int cv6at0[]  = { -1, 0, -999, 1, 3, 2, -999};
  static const int cv6at1[]  = { -1, 3, 0, -999, 1, 2, -999};
  static const int cv7at0[]  = { -1, 3, 0, -999, 1, 2, -999};
  static const int cv8at0[]  = { -1, 0, -999, 1, 3, 2, -999};
  static const int cv9at0[]  = { -1, 3, 0, -999, 1, 2, -999};
  static const int cv10at0[]  = { -1, 0, -999, 1, 3, 2, -999};
...
Selector<const ColourLines *> NLOJetMEqbq2kkbg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEqbq2kkbg
