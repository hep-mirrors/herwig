// -*- C++ -*-
//
// NLOJetMEqqb2kkb.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqqb2kkb_H
#define HERWIG_NLOJetMEqqb2kkb_H
//
// This is the declaration of the NLOJetMEqqb2kkb class.
//
 ...
 *
 * \brief NLOJetMEqqb2kkb This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqqb2kkbInterfaces "The interfaces"
 * defined for NLOJetMEqqb2kkb.
 */
class NLOJetMEqqb2kkb: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqqb2kkb & operator=(const NLOJetMEqqb2kkb &);

};

}

#endif /* HERWIG_NLOJetMEqqb2kkb_H */
