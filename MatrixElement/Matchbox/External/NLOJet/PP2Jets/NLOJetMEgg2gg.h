// -*- C++ -*-
//
// NLOJetMEgg2gg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgg2gg_H
#define HERWIG_NLOJetMEgg2gg_H
//
// This is the declaration of the NLOJetMEgg2gg class.
//
 ...
 *
 * \brief NLOJetMEgg2gg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgg2ggInterfaces "The interfaces"
 * defined for NLOJetMEgg2gg.
 */
class NLOJetMEgg2gg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgg2gg & operator=(const NLOJetMEgg2gg &);

};

}

#endif /* HERWIG_NLOJetMEgg2gg_H */
