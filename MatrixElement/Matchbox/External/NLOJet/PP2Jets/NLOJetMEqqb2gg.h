// -*- C++ -*-
//
// NLOJetMEqqb2gg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqqb2gg_H
#define HERWIG_NLOJetMEqqb2gg_H
//
// This is the declaration of the NLOJetMEqqb2gg class.
//
 ...
 *
 * \brief NLOJetMEqqb2gg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqqb2ggInterfaces "The interfaces"
 * defined for NLOJetMEqqb2gg.
 */
class NLOJetMEqqb2gg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqqb2gg & operator=(const NLOJetMEqqb2gg &);

};

}

#endif /* HERWIG_NLOJetMEqqb2gg_H */
