// -*- C++ -*-
//
// NLOJetMEgqb2qbg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgqb2qbg_H
#define HERWIG_NLOJetMEgqb2qbg_H
//
// This is the declaration of the NLOJetMEgqb2qbg class.
//
 ...
 *
 * \brief NLOJetMEgqb2qbg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgqb2qbgInterfaces "The interfaces"
 * defined for NLOJetMEgqb2qbg.
 */
class NLOJetMEgqb2qbg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgqb2qbg & operator=(const NLOJetMEgqb2qbg &);

};

}

#endif /* HERWIG_NLOJetMEgqb2qbg_H */
