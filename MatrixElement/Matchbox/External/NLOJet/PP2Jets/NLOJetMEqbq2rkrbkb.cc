// -*- C++ -*-
//
// NLOJetMEqbq2rkrbkb.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEqbq2rkrbkb class.
//

#include "NLOJetMEqbq2rkrbkb.h"
...
NLOJetMEqbq2rkrbkb::NLOJetMEqbq2rkrbkb() {}

NLOJetMEqbq2rkrbkb::~NLOJetMEqbq2rkrbkb() {}

IBPtr NLOJetMEqbq2rkrbkb::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEqbq2rkrbkb::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEqbq2rkrbkb::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEqbq2rkrbkb::persistentOutput(PersistentOStream &) const {}

void NLOJetMEqbq2rkrbkb::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEqbq2rkrbkb,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEqbq2rkrbkb("Herwig::NLOJetMEqbq2rkrbkb", "HwMatchboxNLOJet.so");

void NLOJetMEqbq2rkrbkb::Init() {

  static ClassDocumentation<NLOJetMEqbq2rkrbkb> documentation
    ("NLOJetMEqbq2rkrbkb");

}


void NLOJetMEqbq2rkrbkb::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    for(unsigned xi2 = 0; xi2 != quark.size(); xi2++){ 
      ...
      for(unsigned xi3 = 0; xi3 != quark.size(); xi3++){ 
        ...
        addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, g, 3, g, 4, r, 5, k, 4, rb, 5, kb, -1)));
        addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, kb, 4, g, 5, r, 3, k, 5, rb, 4, kb, -2)));
        addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, k, 4, g, 5, r, 4, k, 5, rb, 3, kb, -3)));
        addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, rb, 4, g, 3, r, 5, k, 4, rb, 5, kb, -4)));
        addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, r, 4, g, 4, r, 5, k, 3, rb, 5, kb, -5)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, qb, q, 1, g, 2, g, 4, r, 5, k, 4, rb, 5, kb, -6)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, qb, q, 2, g, 1, g, 4, r, 5, k, 4, rb, 5, kb, -7)));
        if( ( xi1 ==  xi2 ) ){ 
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, q, 2, g, 5, r, 3, q, 5, rb, 1, qb, -8)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, rb, g, q, 2, r, 4, q, 3, rb, 1, qb, -9)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, r, g, q, 3, r, 4, q, 2, rb, 1, qb, -10)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 2, q, 4, g, 5, r, 4, q, 5, rb, 1, qb, -11)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, qb, q, 3, g, 5, r, 2, q, 5, rb, 1, qb, -12)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 1, qb, 4, g, 5, r, 2, q, 5, rb, 4, qb, -13)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, q, 1, g, 5, r, 3, q, 5, rb, 2, qb, -14)));
        }
        if( ( xi3 ==  xi1 ) ){ 
          addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, g, 3, g, 4, k, 5, k, 5, kb, 4, kb, -15)));
          addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, kb, 4, g, 5, k, 3, k, 4, kb, 5, kb, -16)));
          addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, k, 4, g, 5, k, 4, k, 3, kb, 5, kb, -17)));
          addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, kb, 4, g, 3, k, 5, k, 5, kb, 4, kb, -18)));
          addSafe(new_ptr((Tree2toNDiagram(2), qb, q, 1, g, 3, k, 4, g, 4, k, 5, k, 5, kb, 3, kb, -19)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, qb, q, 1, g, 2, g, 4, k, 5, k, 5, kb, 4, kb, -20)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, qb, q, 2, g, 1, g, 4, k, 5, k, 5, kb, 4, kb, -21)));
        }
        if( ( xi1 ==  xi2 ) && ( xi3 ==  xi2 ) ){ 
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, q, 2, g, 3, q, 5, q, 1, qb, 5, qb, -22)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, q, 2, g, 5, q, 3, q, 1, qb, 5, qb, -23)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, q, 2, g, 3, q, 5, q, 5, qb, 1, qb, -24)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, qb, g, q, 4, q, 2, q, 1, qb, 3, qb, -25)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, q, g, q, 4, q, 3, q, 1, qb, 2, qb, -26)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, qb, g, q, 2, q, 4, q, 1, qb, 3, qb, -27)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, q, g, q, 3, q, 4, q, 1, qb, 2, qb, -28)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 2, q, 4, g, 5, q, 4, q, 1, qb, 5, qb, -29)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, qb, q, 3, g, 5, q, 2, q, 1, qb, 5, qb, -30)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 2, q, 4, g, 4, q, 5, q, 1, qb, 5, qb, -31)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, qb, q, 3, g, 2, q, 5, q, 1, qb, 5, qb, -32)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, qb, g, q, 4, q, 2, q, 3, qb, 1, qb, -33)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, q, g, q, 4, q, 3, q, 2, qb, 1, qb, -34)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 2, q, 4, g, 4, q, 5, q, 5, qb, 1, qb, -35)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, qb, q, 3, g, 2, q, 5, q, 5, qb, 1, qb, -36)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 1, qb, 4, g, 2, q, 5, q, 5, qb, 4, qb, -37)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, q, 1, g, 3, q, 5, q, 5, qb, 2, qb, -38)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 1, qb, 4, g, 2, q, 5, q, 4, qb, 5, qb, -39)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, q, 1, g, 3, q, 5, q, 2, qb, 5, qb, -40)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, q, 1, qb, 4, g, 5, q, 2, q, 4, qb, 5, qb, -41)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, q, 1, g, 5, q, 3, q, 2, qb, 5, qb, -42)));
        }
      }  
    }  
  }  
...
Selector <MEBase::DiagramIndex> NLOJetMEqbq2rkrbkb::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv1at1[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
  static const int cv2at0[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv3at0[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
  static const int cv4at0[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
  static const int cv5at0[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv6at0[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv7at0[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
  static const int cv8at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv8at1[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv9at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv10at0[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv11at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv12at0[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv13at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv14at0[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv15at0[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv15at1[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv16at0[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv17at0[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv18at0[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv19at0[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv20at0[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv21at0[]  = { -1, 3, -999, 1, 0, -999, 2, 4, -999};
  static const int cv22at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv22at1[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv23at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv23at1[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
  static const int cv24at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv24at1[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv25at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv26at0[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv27at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv28at0[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
  static const int cv29at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv30at0[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
  static const int cv31at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv32at0[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv33at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv34at0[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv35at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv36at0[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv37at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv38at0[]  = { -1, 3, -999, 2, 0, -999, 1, 4, -999};
  static const int cv39at0[]  = { -1, 0, -999, 1, 4, -999, 2, 3, -999};
  static const int cv40at0[]  = { -1, 4, -999, 2, 0, -999, 1, 3, -999};
  static const int cv41at0[]  = { -1, 0, -999, 1, 3, -999, 2, 4, -999};
  static const int cv42at0[]  = { -1, 4, -999, 1, 0, -999, 2, 3, -999};
...
Selector<const ColourLines *> NLOJetMEqbq2rkrbkb::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEqbq2rkrbkb
