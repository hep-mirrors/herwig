// -*- C++ -*-
//
// NLOJetMEgq2kqkb.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgq2kqkb_H
#define HERWIG_NLOJetMEgq2kqkb_H
//
// This is the declaration of the NLOJetMEgq2kqkb class.
//
 ...
 *
 * \brief NLOJetMEgq2kqkb This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgq2kqkbInterfaces "The interfaces"
 * defined for NLOJetMEgq2kqkb.
 */
class NLOJetMEgq2kqkb: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgq2kqkb & operator=(const NLOJetMEgq2kqkb &);

};

}

#endif /* HERWIG_NLOJetMEgq2kqkb_H */
