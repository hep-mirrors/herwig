// -*- C++ -*-
//
// NLOJetMEgq2qg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgq2qg_H
#define HERWIG_NLOJetMEgq2qg_H
//
// This is the declaration of the NLOJetMEgq2qg class.
//
 ...
 *
 * \brief NLOJetMEgq2qg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgq2qgInterfaces "The interfaces"
 * defined for NLOJetMEgq2qg.
 */
class NLOJetMEgq2qg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgq2qg & operator=(const NLOJetMEgq2qg &);

};

}

#endif /* HERWIG_NLOJetMEgq2qg_H */
