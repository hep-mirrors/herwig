// -*- C++ -*-
//
// NLOJetMEkbqb2rrbkbqb.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEkbqb2rrbkbqb class.
//

#include "NLOJetMEkbqb2rrbkbqb.h"
...
NLOJetMEkbqb2rrbkbqb::NLOJetMEkbqb2rrbkbqb() {}

NLOJetMEkbqb2rrbkbqb::~NLOJetMEkbqb2rrbkbqb() {}

IBPtr NLOJetMEkbqb2rrbkbqb::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEkbqb2rrbkbqb::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEkbqb2rrbkbqb::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEkbqb2rrbkbqb::persistentOutput(PersistentOStream &) const {}

void NLOJetMEkbqb2rrbkbqb::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEkbqb2rrbkbqb,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEkbqb2rrbkbqb("Herwig::NLOJetMEkbqb2rrbkbqb", "HwMatchboxNLOJet.so");

void NLOJetMEkbqb2rrbkbqb::Init() {

  static ClassDocumentation<NLOJetMEkbqb2rrbkbqb> documentation
    ("NLOJetMEkbqb2rrbkbqb");

}


void NLOJetMEkbqb2rrbkbqb::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    for(unsigned xi2 = 0; xi2 != quark.size(); xi2++){ 
      ...
      for(unsigned xi3 = 0; xi3 != quark.size(); xi3++){ 
        ...
        addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 2, g, 5, r, 5, rb, 1, kb, 3, qb, -1)));
        addSafe(new_ptr((Tree2toNDiagram(5), kb, g, rb, g, qb, 2, r, 3, rb, 1, kb, 4, qb, -2)));
        addSafe(new_ptr((Tree2toNDiagram(5), kb, g, r, g, qb, 3, r, 2, rb, 1, kb, 4, qb, -3)));
        addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 2, qb, 4, g, 5, r, 5, rb, 1, kb, 4, qb, -4)));
        addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 3, g, 5, r, 5, rb, 1, kb, 2, qb, -5)));
        addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 4, g, 5, r, 5, rb, 4, kb, 2, qb, -6)));
        addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 1, g, 5, r, 5, rb, 2, kb, 3, qb, -7)));
        if( ( xi1 ==  xi2 ) ){ 
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 2, g, 5, r, 5, rb, 3, qb, 1, qb, -8)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, rb, g, qb, 2, r, 3, rb, 4, qb, 1, qb, -9)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, r, g, qb, 3, r, 2, rb, 4, qb, 1, qb, -10)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 4, g, 5, r, 5, rb, 4, qb, 1, qb, -11)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 3, g, 5, r, 5, rb, 2, qb, 1, qb, -12)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 1, qb, 4, g, 5, r, 5, rb, 2, qb, 4, qb, -13)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 1, g, 5, r, 5, rb, 3, qb, 2, qb, -14)));
        }
        if( ( xi3 ==  xi2 ) ){ 
          addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 2, g, 5, q, 3, qb, 1, kb, 5, qb, -15)));
          addSafe(new_ptr((Tree2toNDiagram(5), kb, g, qb, g, qb, 2, q, 4, qb, 1, kb, 3, qb, -16)));
          addSafe(new_ptr((Tree2toNDiagram(5), kb, g, q, g, qb, 3, q, 4, qb, 1, kb, 2, qb, -17)));
          addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 2, qb, 4, g, 5, q, 4, qb, 1, kb, 5, qb, -18)));
          addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 3, g, 5, q, 2, qb, 1, kb, 5, qb, -19)));
          addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 4, g, 5, q, 2, qb, 4, kb, 5, qb, -20)));
          addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 1, g, 5, q, 3, qb, 2, kb, 5, qb, -21)));
        }
        if( ( xi3 ==  xi1 ) ){ 
          addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 2, g, 5, k, 1, kb, 5, kb, 3, qb, -22)));
          addSafe(new_ptr((Tree2toNDiagram(5), kb, g, kb, g, qb, 2, k, 1, kb, 3, kb, 4, qb, -23)));
          addSafe(new_ptr((Tree2toNDiagram(5), kb, g, k, g, qb, 3, k, 1, kb, 2, kb, 4, qb, -24)));
          addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 2, qb, 4, g, 5, k, 1, kb, 5, kb, 4, qb, -25)));
          addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 3, g, 5, k, 1, kb, 5, kb, 2, qb, -26)));
          addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 4, g, 5, k, 4, kb, 5, kb, 2, qb, -27)));
          addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 1, g, 5, k, 2, kb, 5, kb, 3, qb, -28)));
        }
        if( ( xi1 ==  xi2 ) && ( xi3 ==  xi2 ) ){ 
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 2, g, 5, q, 1, qb, 3, qb, 5, qb, -29)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 2, g, 5, q, 3, qb, 5, qb, 1, qb, -30)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, qb, g, qb, 2, q, 1, qb, 4, qb, 3, qb, -31)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, q, g, qb, 3, q, 1, qb, 4, qb, 2, qb, -32)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 4, g, 5, q, 1, qb, 4, qb, 5, qb, -33)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 3, g, 5, q, 1, qb, 2, qb, 5, qb, -34)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, qb, g, qb, 2, q, 4, qb, 3, qb, 1, qb, -35)));
          addSafe(new_ptr((Tree2toNDiagram(5), qb, g, q, g, qb, 3, q, 4, qb, 2, qb, 1, qb, -36)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 4, g, 5, q, 4, qb, 5, qb, 1, qb, -37)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 3, g, 5, q, 2, qb, 5, qb, 1, qb, -38)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 1, qb, 4, g, 5, q, 2, qb, 5, qb, 4, qb, -39)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 1, g, 5, q, 3, qb, 5, qb, 2, qb, -40)));
          addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 1, qb, 4, g, 5, q, 4, qb, 2, qb, 5, qb, -41)));
          addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 1, g, 5, q, 2, qb, 3, qb, 5, qb, -42)));
        }
      }  
    }  
  }  
...
Selector <MEBase::DiagramIndex> NLOJetMEkbqb2rrbkbqb::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
  static const int cv1at1[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv2at0[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
  static const int cv3at0[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv4at0[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv5at0[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
  static const int cv6at0[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
  static const int cv7at0[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv8at0[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv8at1[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv9at0[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv10at0[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv11at0[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv12at0[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv13at0[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv14at0[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv15at0[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv15at1[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv16at0[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv17at0[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv18at0[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv19at0[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv20at0[]  = { -1, 2, -999, 0, 4, -999, 1, 3, -999};
  static const int cv21at0[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv22at0[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv22at1[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv23at0[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv24at0[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv25at0[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv26at0[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv27at0[]  = { -1, 4, -999, 0, 3, -999, 1, 2, -999};
  static const int cv28at0[]  = { -1, 3, -999, 0, 2, -999, 1, 4, -999};
  static const int cv29at0[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv29at1[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
  static const int cv30at0[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv30at1[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv31at0[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv32at0[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
  static const int cv33at0[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
  static const int cv34at0[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv35at0[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv36at0[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv37at0[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv38at0[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv39at0[]  = { -1, 2, -999, 0, 3, -999, 1, 4, -999};
  static const int cv40at0[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv41at0[]  = { -1, 3, -999, 0, 4, -999, 1, 2, -999};
  static const int cv42at0[]  = { -1, 4, -999, 0, 2, -999, 1, 3, -999};
...
Selector<const ColourLines *> NLOJetMEkbqb2rrbkbqb::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEkbqb2rrbkbqb

  static const ColourLines diag1[2] = { 
    ColourLines("-1 -2 -3 -9, -4 3 -5 -7, 6 5 2 -8"), 
    ColourLines("-1 -2 -5 -7, -4 3 2 -8, 6 5 -3 -9")
  }; 
  static const ColourLines diag2[1] = { 
    ColourLines("-1 -2 -3 -4 -9, -5 4 -7, 6 2 -8")
  }; 
  ...
  static const ColourLines diag5[1] = { 
    ColourLines("-1 -2 -9, -4 -5 -7, 6 5 3 2 -8")
  }; 
  static const ColourLines diag6[1] = { 
    ColourLines("-1 -2 -9, -3 2 -4 -5 -7, 6 5 -8")
  }; 
  static const ColourLines diag7[1] = { 
    ColourLines("-1 -5 -7, -4 3 -8, 6 5 -2 -3 -9")
  }; 
  static const ColourLines diag8[2] = { 
    ColourLines("-1 -2 -3 -8, -4 3 -5 -7, 6 5 2 -9"), 
    ColourLines("-1 -2 -5 -7, -4 3 2 -9, 6 5 -3 -8")
  }; 
  static const ColourLines diag9[1] = { 
    ColourLines("-1 -2 -3 -4 -8, -5 4 -7, 6 2 -9")
  }; 
  static const ColourLines diag10[1] = { 
    ColourLines("-1 -2 -7, -5 4 3 2 -9, 6 -4 -8")
  }; 
  static const ColourLines diag11[1] = { 
    ColourLines("-1 -2 -4 -5 -7, -3 2 -9, 6 5 -8")
  }; 
  static const ColourLines diag12[1] = { 
    ColourLines("-1 -2 -8, -4 -5 -7, 6 5 3 2 -9")
  }; 
  static const ColourLines diag13[1] = { 
    ColourLines("-1 -2 -8, -3 2 -4 -5 -7, 6 5 -9")
  }; 
  static const ColourLines diag14[1] = { 
    ColourLines("-1 -5 -7, -4 3 -9, 6 5 -2 -3 -8")
  }; 
  static const ColourLines diag15[2] = { 
    ColourLines("-1 -2 -3 -7, -4 3 -5 -9, 6 5 2 -8"), 
    ColourLines("-1 -2 -5 -9, -4 3 2 -8, 6 5 -3 -7")
  }; 
  static const ColourLines diag16[1] = { 
    ColourLines("-1 -2 -3 -4 -7, -5 4 -9, 6 2 -8")
  }; 
  static const ColourLines diag17[1] = { 
    ColourLines("-1 -2 -9, -5 4 3 2 -8, 6 -4 -7")
  }; 
  static const ColourLines diag18[1] = { 
    ColourLines("-1 -2 -4 -5 -9, -3 2 -8, 6 5 -7")
  }; 
  static const ColourLines diag19[1] = { 
    ColourLines("-1 -2 -7, -4 -5 -9, 6 5 3 2 -8")
  }; 
  static const ColourLines diag20[1] = { 
    ColourLines("-1 -2 -7, -3 2 -4 -5 -9, 6 5 -8")
  }; 
  static const ColourLines diag21[1] = { 
    ColourLines("-1 -5 -9, -4 3 -8, 6 5 -2 -3 -7")
  }; 
  static const ColourLines diag22[2] = { 
    ColourLines("-1 -2 -3 -9, -4 3 -5 -8, 6 5 2 -7"), 
    ColourLines("-1 -2 -5 -8, -4 3 2 -7, 6 5 -3 -9")
  }; 
  static const ColourLines diag23[1] = { 
    ColourLines("-1 -2 -3 -4 -9, -5 4 -8, 6 2 -7")
  }; 
