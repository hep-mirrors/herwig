// -*- C++ -*-
//
// NLOJetMEgqb2qbgg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEgqb2qbgg class.
//

#include "NLOJetMEgqb2qbgg.h"
...
NLOJetMEgqb2qbgg::NLOJetMEgqb2qbgg() {}

NLOJetMEgqb2qbgg::~NLOJetMEgqb2qbgg() {}

IBPtr NLOJetMEgqb2qbgg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEgqb2qbgg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEgqb2qbgg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEgqb2qbgg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEgqb2qbgg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEgqb2qbgg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEgqb2qbgg("Herwig::NLOJetMEgqb2qbgg", "HwMatchboxNLOJet.so");

void NLOJetMEgqb2qbgg::Init() {

  static ClassDocumentation<NLOJetMEgqb2qbgg> documentation
    ("NLOJetMEgqb2qbgg");

}


void NLOJetMEgqb2qbgg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    addSafe(new_ptr((Tree2toNDiagram(2), g, qb, 1, qb, 3, qb, 4, qb, 4, g, 3, g, -1)));
    addSafe(new_ptr((Tree2toNDiagram(2), g, qb, 1, qb, 3, qb, 4, qb, 3, g, 4, g, -2)));
    addSafe(new_ptr((Tree2toNDiagram(2), g, qb, 1, qb, 3, g, 3, qb, 4, g, 4, g, -3)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, q, q, qb, 1, qb, 3, g, 2, g, -4)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, q, q, qb, 1, qb, 2, g, 3, g, -5)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, q, qb, 2, g, 1, qb, 4, g, 4, g, -6)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, g, qb, 3, qb, 1, g, 2, g, -7)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, q, qb, 2, qb, 1, g, 3, g, -8)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, qb, 2, qb, 4, qb, 1, g, 4, g, -9)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, g, qb, 3, qb, 2, g, 1, g, -10)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, q, qb, 2, qb, 3, g, 1, g, -11)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, qb, 2, qb, 4, qb, 4, g, 1, g, -12)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, qb, 1, g, 2, qb, 4, g, 4, g, -13)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, q, qb, 1, qb, 4, qb, 2, g, 4, g, -14)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, q, qb, 1, qb, 4, qb, 4, g, 2, g, -15)));
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEgqb2qbgg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 0, -1, 3, 2, 1, -999};
  static const int cv2at0[]  = { 0, -1, 2, 3, 1, -999};
  static const int cv3at0[]  = { 0, -1, 2, 3, 1, -999};
  static const int cv3at1[]  = { 0, -1, 3, 2, 1, -999};
  static const int cv4at0[]  = { 0, 2, 3, -1, 1, -999};
  static const int cv5at0[]  = { 0, 3, 2, -1, 1, -999};
  static const int cv6at0[]  = { 0, 2, 3, -1, 1, -999};
  static const int cv6at1[]  = { 0, 3, 2, -1, 1, -999};
  static const int cv7at0[]  = { 0, 3, -1, 2, 1, -999};
  static const int cv7at1[]  = { 0, 3, 2, -1, 1, -999};
  static const int cv7at2[]  = { 0, -1, 2, 3, 1, -999};
  static const int cv7at3[]  = { 0, 2, -1, 3, 1, -999};
  static const int cv8at0[]  = { 0, 3, -1, 2, 1, -999};
  static const int cv8at1[]  = { 0, 3, 2, -1, 1, -999};
  static const int cv9at0[]  = { 0, -1, 2, 3, 1, -999};
  static const int cv9at1[]  = { 0, 2, -1, 3, 1, -999};
  static const int cv10at0[]  = { 0, 2, -1, 3, 1, -999};
  static const int cv10at1[]  = { 0, 2, 3, -1, 1, -999};
  static const int cv10at2[]  = { 0, -1, 3, 2, 1, -999};
  static const int cv10at3[]  = { 0, 3, -1, 2, 1, -999};
  static const int cv11at0[]  = { 0, 2, -1, 3, 1, -999};
  static const int cv11at1[]  = { 0, 2, 3, -1, 1, -999};
  static const int cv12at0[]  = { 0, -1, 3, 2, 1, -999};
  static const int cv12at1[]  = { 0, 3, -1, 2, 1, -999};
  static const int cv13at0[]  = { 0, 2, 3, -1, 1, -999};
  static const int cv13at1[]  = { 0, 3, 2, -1, 1, -999};
  static const int cv13at2[]  = { 0, -1, 2, 3, 1, -999};
  static const int cv13at3[]  = { 0, -1, 3, 2, 1, -999};
  static const int cv14at0[]  = { 0, 2, -1, 3, 1, -999};
  static const int cv15at0[]  = { 0, 3, -1, 2, 1, -999};
  ...
  for(MEBase::DiagramIndex i=0; i < diags.size(); ++i){
    if( diags[i]->id() == -1 )
      ...
      sel.insert( 
        ...
        + nloJetAmplitude()->colourOrdered2(cv10at3, sizeof(cv10at3)/sizeof(int)), i);   
      ...
      sel.insert( 
        ...
        + nloJetAmplitude()->colourOrdered2(cv13at3, sizeof(cv13at3)/sizeof(int)), i);   
...
Selector<const ColourLines *> NLOJetMEgqb2qbgg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEgqb2qbgg

  static const ColourLines diag1[1] = { 
    ColourLines("1 -2, -1 -3 -7, -5 6, -6 -4 7")
  }; 
  static const ColourLines diag2[1] = { 
    ColourLines("1 -2, -1 -3 -6, -5 7, 6 -4 -7")
  }; 
  static const ColourLines diag3[2] = { 
    ColourLines("1 -2, -1 -3 -4 -6, -5 4 7, 6 -7"), 
    ColourLines("1 -2, -1 -3 -4 -7, -5 4 6, -6 7")
  }; 
  static const ColourLines diag4[1] = { 
    ColourLines("1 2 7, -1 -5, -4 -6, 6 3 -7")
  }; 
  static const ColourLines diag5[1] = { 
    ColourLines("1 2 6, -1 -5, -4 -7, -6 3 7")
  }; 
  static const ColourLines diag6[2] = { 
    ColourLines("1 2 4 7, -1 -5, -3 -4 -6, 6 -7"), 
    ColourLines("1 2 4 6, -1 -5, -3 -4 -7, -6 7")
  }; 
  static const ColourLines diag7[4] = { 
    ColourLines("1 2 7, -1 -6, -4 3 -7, -5 -3 -2 6"), 
    ColourLines("1 6, -1 -2 -3 -5, -4 3 -7, -6 2 7"), 
    ColourLines("1 2 3 -4, -1 -6, -5 -3 7, 6 -2 -7"), 
    ColourLines("1 6, -1 -2 -7, -4 3 2 -6, -5 -3 7")
  }; 
  static const ColourLines diag8[2] = { 
    ColourLines("1 2 3 7, -1 -6, -4 -7, -5 -2 6"), 
    ColourLines("1 6, -1 -2 -5, -4 -7, -6 2 3 7")
  }; 
  static const ColourLines diag9[2] = { 
    ColourLines("1 2 -3, -1 -6, -5 7, 6 -2 -4 -7"), 
    ColourLines("1 6, -1 -2 -4 -7, -3 2 -6, -5 7")
  }; 
  static const ColourLines diag10[4] = { 
    ColourLines("1 2 6, -1 -7, -4 3 -6, -5 -3 -2 7"), 
    ColourLines("1 7, -1 -2 -3 -5, -4 3 -6, 6 2 -7"), 
    ColourLines("1 2 3 -4, -1 -7, -5 -3 6, -6 -2 7"), 
    ColourLines("1 7, -1 -2 -6, -4 3 2 -7, -5 -3 6")
  }; 
  static const ColourLines diag11[2] = { 
    ColourLines("1 2 3 6, -1 -7, -4 -6, -5 -2 7"), 
    ColourLines("1 7, -1 -2 -5, -4 -6, 6 3 2 -7")
  }; 
  static const ColourLines diag12[2] = { 
    ColourLines("1 2 -3, -1 -7, -5 6, -6 -4 -2 7"), 
    ColourLines("1 7, -1 -2 -4 -6, -3 2 -7, -5 6")
  }; 
  static const ColourLines diag13[4] = { 
    ColourLines("1 4 7, -1 -2 -5, -3 2 -4 -6, 6 -7"), 
    ColourLines("1 4 6, -1 -2 -5, -3 2 -4 -7, -6 7"), 
    ColourLines("1 2 -3, -1 -4 -6, -5 -2 4 7, 6 -7"), 
    ColourLines("1 2 -3, -1 -4 -7, -5 -2 4 6, -6 7")
  }; 
  static const ColourLines diag14[1] = { 
    ColourLines("1 2 6, -1 -4 -7, -3 -6, -5 7")
  }; 
  static const ColourLines diag15[1] = { 
    ColourLines("1 2 7, -1 -4 -6, -3 -7, -5 6")
  }; 
