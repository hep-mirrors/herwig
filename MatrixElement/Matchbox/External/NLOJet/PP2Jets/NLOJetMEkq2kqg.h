// -*- C++ -*-
//
// NLOJetMEkq2kqg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEkq2kqg_H
#define HERWIG_NLOJetMEkq2kqg_H
//
// This is the declaration of the NLOJetMEkq2kqg class.
//
 ...
 *
 * \brief NLOJetMEkq2kqg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEkq2kqgInterfaces "The interfaces"
 * defined for NLOJetMEkq2kqg.
 */
class NLOJetMEkq2kqg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEkq2kqg & operator=(const NLOJetMEkq2kqg &);

};

}

#endif /* HERWIG_NLOJetMEkq2kqg_H */
