// -*- C++ -*-
//
// NLOJetMEgg2qqb.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgg2qqb_H
#define HERWIG_NLOJetMEgg2qqb_H
//
// This is the declaration of the NLOJetMEgg2qqb class.
//
 ...
 *
 * \brief NLOJetMEgg2qqb This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgg2qqbInterfaces "The interfaces"
 * defined for NLOJetMEgg2qqb.
 */
class NLOJetMEgg2qqb: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgg2qqb & operator=(const NLOJetMEgg2qqb &);

};

}

#endif /* HERWIG_NLOJetMEgg2qqb_H */
