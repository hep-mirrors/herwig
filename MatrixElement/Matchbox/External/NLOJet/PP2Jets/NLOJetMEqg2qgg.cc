// -*- C++ -*-
//
// NLOJetMEqg2qgg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEqg2qgg class.
//

#include "NLOJetMEqg2qgg.h"
...
NLOJetMEqg2qgg::NLOJetMEqg2qgg() {}

NLOJetMEqg2qgg::~NLOJetMEqg2qgg() {}

IBPtr NLOJetMEqg2qgg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEqg2qgg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEqg2qgg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEqg2qgg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEqg2qgg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEqg2qgg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEqg2qgg("Herwig::NLOJetMEqg2qgg", "HwMatchboxNLOJet.so");

void NLOJetMEqg2qgg::Init() {

  static ClassDocumentation<NLOJetMEqg2qgg> documentation
    ("NLOJetMEqg2qgg");

}


void NLOJetMEqg2qgg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    addSafe(new_ptr((Tree2toNDiagram(2), q, g, 1, q, 3, q, 4, q, 4, g, 3, g, -1)));
    addSafe(new_ptr((Tree2toNDiagram(2), q, g, 1, q, 3, q, 4, q, 3, g, 4, g, -2)));
    addSafe(new_ptr((Tree2toNDiagram(2), q, g, 1, q, 3, g, 3, q, 4, g, 4, g, -3)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, g, g, g, 1, q, 3, g, 2, g, -4)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, g, g, g, 1, q, 2, g, 3, g, -5)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, g, g, 2, g, 1, q, 4, g, 4, g, -6)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, g, 3, q, 1, g, 2, g, -7)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, g, g, 2, q, 1, g, 3, g, -8)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, g, 2, q, 4, q, 1, g, 4, g, -9)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, g, 3, q, 2, g, 1, g, -10)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, g, g, 2, q, 3, g, 1, g, -11)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, g, 2, q, 4, q, 4, g, 1, g, -12)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, g, 1, g, 2, q, 4, g, 4, g, -13)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, g, g, 1, q, 4, q, 2, g, 4, g, -14)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, g, g, 1, q, 4, q, 4, g, 2, g, -15)));
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEqg2qgg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 1, 2, 3, 0, -1, -999};
  static const int cv2at0[]  = { 1, 3, 2, 0, -1, -999};
  static const int cv3at0[]  = { 1, 2, 3, 0, -1, -999};
  static const int cv3at1[]  = { 1, 3, 2, 0, -1, -999};
  ...
  static const int cv7at0[]  = { 1, 0, 3, 2, -1, -999};
  static const int cv8at0[]  = { 1, 0, 3, 2, -1, -999};
  static const int cv8at1[]  = { 1, 3, 0, 2, -1, -999};
  static const int cv9at0[]  = { 1, 3, 0, 2, -1, -999};
  static const int cv10at0[]  = { 1, 0, 2, 3, -1, -999};
  static const int cv11at0[]  = { 1, 0, 2, 3, -1, -999};
  static const int cv11at1[]  = { 1, 2, 0, 3, -1, -999};
  static const int cv12at0[]  = { 1, 2, 0, 3, -1, -999};
  static const int cv13at0[]  = { 1, 0, 2, 3, -1, -999};
  static const int cv13at1[]  = { 1, 0, 3, 2, -1, -999};
  static const int cv14at0[]  = { 1, 3, 0, 2, -1, -999};
  static const int cv14at1[]  = { 1, 3, 2, 0, -1, -999};
  static const int cv15at0[]  = { 1, 2, 0, 3, -1, -999};
  static const int cv15at1[]  = { 1, 2, 3, 0, -1, -999};
...
Selector<const ColourLines *> NLOJetMEqg2qgg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEqg2qgg
  ...
  static const ColourLines diag4[4] = { 
    ColourLines("1 2 7, 4 -3 -2 5, -4 -6, 6 3 -7"), 
    ColourLines("1 2 7, 4 6, -4 3 -7, 5 -2 -3 -6"), 
    ColourLines("1 2 3 6, 4 -3 7, -4 -6, 5 -2 -7"), 
    ColourLines("1 2 3 -4, 4 6, 5 -2 -7, -6 -3 7")
  }; 
  static const ColourLines diag5[4] = { 
    ColourLines("1 2 6, 4 -3 -2 5, -4 -7, -6 3 7"), 
    ColourLines("1 2 6, 4 7, -4 3 -6, 5 -2 -3 -7"), 
    ColourLines("1 2 3 7, 4 -3 6, -4 -7, 5 -2 -6"), 
  ...
  static const ColourLines diag6[4] = { 
    ...
    ColourLines("1 2 4 7, 3 -2 5, -3 -4 -6, 6 -7"), 
    ColourLines("1 2 4 6, 3 -2 5, -3 -4 -7, -6 7")
  }; 
  static const ColourLines diag7[1] = { 
    ColourLines("1 6, 4 5, -4 3 -7, -6 2 7")
  }; 
  static const ColourLines diag8[2] = { 
    ColourLines("1 6, 4 -3 5, -4 -7, -6 2 3 7"), 
    ColourLines("1 6, 4 7, -4 3 2 -6, 5 -3 -7")
  }; 
  static const ColourLines diag9[1] = { 
    ColourLines("1 6, 3 4 7, -3 2 -6, 5 -7")
  }; 
  static const ColourLines diag10[1] = { 
    ColourLines("1 7, 4 5, -4 3 -6, 6 2 -7")
  }; 
  static const ColourLines diag11[2] = { 
    ColourLines("1 7, 4 -3 5, -4 -6, 6 3 2 -7"), 
    ColourLines("1 7, 4 6, -4 3 2 -7, 5 -3 -6")
  }; 
  static const ColourLines diag12[1] = { 
    ColourLines("1 7, 3 4 6, -3 2 -7, 5 -6")
  }; 
  static const ColourLines diag13[2] = { 
    ColourLines("1 4 7, 3 5, -3 2 -4 -6, 6 -7"), 
    ColourLines("1 4 6, 3 5, -3 2 -4 -7, -6 7")
  }; 
  static const ColourLines diag14[2] = { 
    ColourLines("1 2 6, 3 -2 4 7, -3 -6, 5 -7"), 
    ColourLines("1 2 -3, 3 6, 5 -7, -6 -2 4 7")
  }; 
  static const ColourLines diag15[2] = { 
    ColourLines("1 2 7, 3 -2 4 6, -3 -7, 5 -6"), 
