// -*- C++ -*-
//
// NLOJetMEgg2ggg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgg2ggg_H
#define HERWIG_NLOJetMEgg2ggg_H
//
// This is the declaration of the NLOJetMEgg2ggg class.
//
 ...
 *
 * \brief NLOJetMEgg2ggg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgg2gggInterfaces "The interfaces"
 * defined for NLOJetMEgg2ggg.
 */
class NLOJetMEgg2ggg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgg2ggg & operator=(const NLOJetMEgg2ggg &);

};

}

#endif /* HERWIG_NLOJetMEgg2ggg_H */
