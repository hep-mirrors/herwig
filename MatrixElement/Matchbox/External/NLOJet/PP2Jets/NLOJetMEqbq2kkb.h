// -*- C++ -*-
//
// NLOJetMEqbq2kkb.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqbq2kkb_H
#define HERWIG_NLOJetMEqbq2kkb_H
//
// This is the declaration of the NLOJetMEqbq2kkb class.
//
 ...
 *
 * \brief NLOJetMEqbq2kkb This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqbq2kkbInterfaces "The interfaces"
 * defined for NLOJetMEqbq2kkb.
 */
class NLOJetMEqbq2kkb: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqbq2kkb & operator=(const NLOJetMEqbq2kkb &);

};

}

#endif /* HERWIG_NLOJetMEqbq2kkb_H */
