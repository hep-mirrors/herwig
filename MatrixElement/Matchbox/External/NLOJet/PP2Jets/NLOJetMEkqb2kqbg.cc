// -*- C++ -*-
//
// NLOJetMEkqb2kqbg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEkqb2kqbg class.
//

#include "NLOJetMEkqb2kqbg.h"
...
NLOJetMEkqb2kqbg::NLOJetMEkqb2kqbg() {}

NLOJetMEkqb2kqbg::~NLOJetMEkqb2kqbg() {}

IBPtr NLOJetMEkqb2kqbg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEkqb2kqbg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEkqb2kqbg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEkqb2kqbg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEkqb2kqbg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEkqb2kqbg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEkqb2kqbg("Herwig::NLOJetMEkqb2kqbg", "HwMatchboxNLOJet.so");

void NLOJetMEkqb2kqbg::Init() {

  static ClassDocumentation<NLOJetMEkqb2kqbg> documentation
    ("NLOJetMEkqb2kqbg");

}


void NLOJetMEkqb2kqbg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
	...
	continue;
      ...
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, qb, 1, k, 3, qb, 2, g, -1)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, q, qb, 1, k, 2, qb, 3, g, -2)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 2, qb, 1, k, 4, qb, 4, g, -3)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, qb, 2, k, 3, qb, 1, g, -4)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 1, k, 4, k, 2, qb, 4, g, -5)));
    }  
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEkqb2kqbg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 0, 3, -1, -999, 1, 2, -999};
  static const int cv1at1[]  = { 0, -1, -999, 1, 3, 2, -999};
  static const int cv2at0[]  = { 0, 3, -1, -999, 1, 2, -999};
  static const int cv3at0[]  = { 0, -1, -999, 1, 3, 2, -999};
  static const int cv4at0[]  = { 0, 3, -1, -999, 1, 2, -999};
  static const int cv5at0[]  = { 0, -1, -999, 1, 3, 2, -999};
  static const int cv6at0[]  = { 0, 2, -999, 1, 3, -1, -999};
  static const int cv6at1[]  = { 1, -1, -999, 0, 3, 2, -999};
  static const int cv7at0[]  = { 0, 2, -999, 1, 3, -1, -999};
  static const int cv8at0[]  = { 1, -1, -999, 0, 3, 2, -999};
  static const int cv9at0[]  = { 0, 2, -999, 1, 3, -1, -999};
...
Selector<const ColourLines *> NLOJetMEkqb2kqbg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEkqb2kqbg
