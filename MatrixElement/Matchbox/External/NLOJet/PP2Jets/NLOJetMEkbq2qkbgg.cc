// -*- C++ -*-
//
// NLOJetMEkbq2qkbgg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEkbq2qkbgg class.
//

#include "NLOJetMEkbq2qkbgg.h"
...
NLOJetMEkbq2qkbgg::NLOJetMEkbq2qkbgg() {}

NLOJetMEkbq2qkbgg::~NLOJetMEkbq2qkbgg() {}

IBPtr NLOJetMEkbq2qkbgg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEkbq2qkbgg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEkbq2qkbgg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEkbq2qkbgg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEkbq2qkbgg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEkbq2qkbgg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEkbq2qkbgg("Herwig::NLOJetMEkbq2qkbgg", "HwMatchboxNLOJet.so");

void NLOJetMEkbq2qkbgg::Init() {

  static ClassDocumentation<NLOJetMEkbq2qkbgg> documentation
    ("NLOJetMEkbq2qkbgg");

}


void NLOJetMEkbq2qkbgg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
	...
	continue;
      ...
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, q, 2, g, 3, q, 1, kb, 5, g, 5, g, -1)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, qb, q, 2, q, 5, q, 1, kb, 3, g, 5, g, -2)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, qb, q, 2, q, 5, q, 1, kb, 5, g, 3, g, -3)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, q, 2, kb, 3, q, 5, kb, 1, g, 5, g, -4)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, q, 2, kb, 3, q, 5, kb, 5, g, 1, g, -5)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, g, q, 4, q, 1, kb, 2, g, 3, g, -6)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, g, q, 4, q, 1, kb, 3, g, 2, g, -7)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, qb, qb, q, 2, q, 1, kb, 4, g, 3, g, -8)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, qb, q, 3, q, 1, kb, 4, g, 2, g, -9)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, qb, qb, q, 2, q, 1, kb, 3, g, 4, g, -10)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, qb, q, 3, q, 1, kb, 2, g, 4, g, -11)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 2, q, 4, q, 5, q, 1, kb, 5, g, 4, g, -12)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, q, 3, q, 5, q, 1, kb, 5, g, 2, g, -13)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 2, q, 4, q, 5, q, 1, kb, 4, g, 5, g, -14)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, q, 3, q, 5, q, 1, kb, 2, g, 5, g, -15)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 2, q, 4, g, 4, q, 1, kb, 5, g, 5, g, -16)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, qb, q, 3, g, 2, q, 1, kb, 5, g, 5, g, -17)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, g, q, 4, q, 2, kb, 1, g, 3, g, -18)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, kb, g, q, 4, q, 3, kb, 1, g, 2, g, -19)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, qb, q, 3, q, 2, kb, 1, g, 4, g, -20)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, q, 3, q, 5, q, 2, kb, 1, g, 5, g, -21)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, g, q, 4, q, 2, kb, 3, g, 1, g, -22)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, kb, g, q, 4, q, 3, kb, 2, g, 1, g, -23)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, qb, q, 3, q, 2, kb, 4, g, 1, g, -24)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, q, 3, q, 5, q, 2, kb, 5, g, 1, g, -25)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 1, kb, 4, kb, 2, q, 5, kb, 5, g, 4, g, -26)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, q, 1, kb, 3, q, 5, kb, 5, g, 2, g, -27)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 1, kb, 4, kb, 2, q, 5, kb, 4, g, 5, g, -28)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, q, 1, kb, 3, q, 5, kb, 2, g, 5, g, -29)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 1, kb, 4, g, 2, q, 4, kb, 5, g, 5, g, -30)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, q, 1, g, 3, q, 2, kb, 5, g, 5, g, -31)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, qb, q, 1, kb, 2, q, 5, kb, 3, g, 5, g, -32)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, qb, q, 1, kb, 2, q, 5, kb, 5, g, 3, g, -33)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 2, q, 1, kb, 4, q, 5, kb, 4, g, 5, g, -34)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, q, 2, q, 1, kb, 4, q, 5, kb, 5, g, 4, g, -35)));
    }  
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEkbq2qkbgg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv1at1[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv1at2[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv1at3[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv2at0[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv3at0[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv4at0[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv5at0[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv6at0[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv6at1[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv6at2[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv6at3[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv7at0[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv7at1[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv7at2[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv7at3[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv8at0[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv9at0[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv9at1[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv10at0[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv11at0[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv11at1[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv12at0[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv13at0[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv13at1[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv14at0[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv15at0[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv15at1[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv16at0[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv16at1[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv17at0[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv17at1[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv18at0[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv18at1[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv19at0[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv20at0[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv21at0[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv22at0[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv22at1[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv23at0[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv24at0[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv25at0[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv26at0[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv27at0[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv27at1[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv28at0[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv29at0[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv29at1[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv30at0[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv30at1[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv31at0[]  = { -1, 3, 4, 0, -999, 1, 2, -999};
  static const int cv31at1[]  = { -1, 4, 3, 0, -999, 1, 2, -999};
  static const int cv32at0[]  = { -1, 3, 0, -999, 1, 4, 2, -999};
  static const int cv33at0[]  = { -1, 4, 0, -999, 1, 3, 2, -999};
  static const int cv34at0[]  = { -1, 0, -999, 1, 3, 4, 2, -999};
  static const int cv35at0[]  = { -1, 0, -999, 1, 4, 3, 2, -999};
  static const int cv36at0[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv36at1[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv36at2[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv36at3[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv37at0[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv38at0[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv39at0[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv40at0[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv41at0[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv41at1[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv41at2[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv41at3[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv42at0[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv42at1[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv42at2[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv42at3[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv43at0[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv44at0[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv44at1[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv45at0[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv46at0[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv46at1[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv47at0[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv48at0[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv48at1[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv49at0[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv50at0[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv50at1[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv51at0[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv51at1[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv52at0[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv52at1[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv53at0[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv53at1[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv54at0[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv55at0[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv56at0[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv57at0[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv57at1[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv58at0[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv59at0[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv60at0[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
  static const int cv61at0[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv61at1[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv62at0[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv63at0[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv64at0[]  = { -1, 4, 2, -999, 1, 3, 0, -999};
  static const int cv65at0[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv65at1[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv66at0[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv67at0[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv68at0[]  = { -1, 3, 2, -999, 1, 4, 0, -999};
  static const int cv69at0[]  = { -1, 2, -999, 1, 3, 4, 0, -999};
  static const int cv69at1[]  = { -1, 2, -999, 1, 4, 3, 0, -999};
  static const int cv70at0[]  = { -1, 3, 4, 2, -999, 1, 0, -999};
  static const int cv70at1[]  = { -1, 4, 3, 2, -999, 1, 0, -999};
...
Selector<const ColourLines *> NLOJetMEkbq2qkbgg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEkbq2qkbgg
