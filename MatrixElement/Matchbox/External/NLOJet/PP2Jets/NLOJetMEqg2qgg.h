// -*- C++ -*-
//
// NLOJetMEqg2qgg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqg2qgg_H
#define HERWIG_NLOJetMEqg2qgg_H
//
// This is the declaration of the NLOJetMEqg2qgg class.
//
 ...
 *
 * \brief NLOJetMEqg2qgg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqg2qggInterfaces "The interfaces"
 * defined for NLOJetMEqg2qgg.
 */
class NLOJetMEqg2qgg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqg2qgg & operator=(const NLOJetMEqg2qgg &);

};

}

#endif /* HERWIG_NLOJetMEqg2qgg_H */
