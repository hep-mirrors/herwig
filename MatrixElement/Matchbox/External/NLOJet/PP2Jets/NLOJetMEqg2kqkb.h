// -*- C++ -*-
//
// NLOJetMEqg2kqkb.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqg2kqkb_H
#define HERWIG_NLOJetMEqg2kqkb_H
//
// This is the declaration of the NLOJetMEqg2kqkb class.
//
 ...
 *
 * \brief NLOJetMEqg2kqkb This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqg2kqkbInterfaces "The interfaces"
 * defined for NLOJetMEqg2kqkb.
 */
class NLOJetMEqg2kqkb: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqg2kqkb & operator=(const NLOJetMEqg2kqkb &);

};

}

#endif /* HERWIG_NLOJetMEqg2kqkb_H */
