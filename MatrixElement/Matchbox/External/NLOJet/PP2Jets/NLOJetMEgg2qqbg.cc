// -*- C++ -*-
//
// NLOJetMEgg2qqbg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEgg2qqbg class.
//

#include "NLOJetMEgg2qqbg.h"
...
NLOJetMEgg2qqbg::NLOJetMEgg2qqbg() {}

NLOJetMEgg2qqbg::~NLOJetMEgg2qqbg() {}

IBPtr NLOJetMEgg2qqbg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEgg2qqbg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEgg2qqbg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEgg2qqbg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEgg2qqbg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEgg2qqbg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEgg2qqbg("Herwig::NLOJetMEgg2qqbg", "HwMatchboxNLOJet.so");

void NLOJetMEgg2qqbg::Init() {

  static ClassDocumentation<NLOJetMEgg2qqbg> documentation
    ("NLOJetMEgg2qqbg");

}


void NLOJetMEgg2qqbg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    addSafe(new_ptr((Tree2toNDiagram(2), g, g, 1, g, 3, g, 4, q, 4, qb, 3, g, -1)));
    addSafe(new_ptr((Tree2toNDiagram(2), g, g, 1, g, 3, q, 4, q, 3, qb, 4, g, -2)));
    addSafe(new_ptr((Tree2toNDiagram(2), g, g, 1, g, 3, qb, 3, q, 4, qb, 4, g, -3)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, qb, qb, g, 1, q, 3, qb, 2, g, -4)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, qb, g, g, 1, q, 2, qb, 3, g, -5)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, qb, g, 2, qb, 1, q, 4, qb, 4, g, -6)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, q, q, g, 3, q, 1, qb, 2, g, -7)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, q, g, g, 2, q, 1, qb, 3, g, -8)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, q, g, 2, q, 4, q, 1, qb, 4, g, -9)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, q, g, 3, q, 2, qb, 1, g, -10)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, qb, g, 2, q, 3, qb, 1, g, -11)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, g, 2, g, 4, q, 4, qb, 1, g, -12)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, q, g, 1, qb, 2, q, 4, qb, 4, g, -13)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, qb, g, 1, q, 4, q, 2, qb, 4, g, -14)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, g, 1, g, 4, q, 4, qb, 2, g, -15)));
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEgg2qqbg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 1, 3, -1, 0, 2, -999};
  static const int cv1at1[]  = { 1, 3, 0, -1, 2, -999};
  static const int cv1at2[]  = { 1, -1, 0, 3, 2, -999};
  static const int cv1at3[]  = { 1, 0, -1, 3, 2, -999};
  static const int cv2at0[]  = { 1, 3, -1, 0, 2, -999};
  static const int cv2at1[]  = { 1, 3, 0, -1, 2, -999};
  static const int cv3at0[]  = { 1, -1, 0, 3, 2, -999};
  static const int cv3at1[]  = { 1, 0, -1, 3, 2, -999};
  static const int cv4at0[]  = { 1, -1, 3, 0, 2, -999};
  static const int cv5at0[]  = { 1, -1, 0, 3, 2, -999};
  static const int cv5at1[]  = { 1, -1, 3, 0, 2, -999};
  static const int cv6at0[]  = { 1, -1, 0, 3, 2, -999};
  static const int cv7at0[]  = { 1, 0, 3, -1, 2, -999};
  static const int cv8at0[]  = { 1, 0, 3, -1, 2, -999};
  static const int cv8at1[]  = { 1, 3, 0, -1, 2, -999};
  static const int cv9at0[]  = { 1, 3, 0, -1, 2, -999};
  static const int cv10at0[]  = { 1, 0, -1, 3, 2, -999};
  static const int cv10at1[]  = { 1, 0, 3, -1, 2, -999};
  static const int cv11at0[]  = { 1, -1, 3, 0, 2, -999};
  static const int cv11at1[]  = { 1, 3, -1, 0, 2, -999};
  static const int cv12at0[]  = { 1, 0, -1, 3, 2, -999};
  static const int cv12at1[]  = { 1, 0, 3, -1, 2, -999};
  static const int cv12at2[]  = { 1, -1, 3, 0, 2, -999};
  static const int cv12at3[]  = { 1, 3, -1, 0, 2, -999};
  static const int cv13at0[]  = { 1, 0, -1, 3, 2, -999};
  static const int cv14at0[]  = { 1, 3, -1, 0, 2, -999};
  static const int cv15at0[]  = { 1, -1, 0, 3, 2, -999};
  static const int cv15at1[]  = { 1, -1, 3, 0, 2, -999};
  static const int cv15at2[]  = { 1, 0, 3, -1, 2, -999};
  static const int cv15at3[]  = { 1, 3, 0, -1, 2, -999};
  ...
  for(MEBase::DiagramIndex i=0; i < diags.size(); ++i){
    if( diags[i]->id() == -1 )
      ...
      sel.insert( 
        ...
        + nloJetAmplitude()->colourOrdered2(cv12at3, sizeof(cv12at3)/sizeof(int)), i);   
      ...
      sel.insert( 
        ...
        + nloJetAmplitude()->colourOrdered2(cv15at3, sizeof(cv15at3)/sizeof(int)), i);   
  }
  return sel;
}


Selector<const ColourLines *> NLOJetMEgg2qqbg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEgg2qqbg

  static const ColourLines diag1[4] = { 
    ColourLines("1 3 7, -1 2, -2 -3 -4 -6, 5 4 -7"), 
    ColourLines("1 -2, -1 -3 -4 -6, 2 3 7, 5 4 -7"), 
    ColourLines("1 3 4 5, -1 2, -2 -3 -7, -6 -4 7"), 
    ColourLines("1 -2, -1 -3 -7, 2 3 4 5, -6 -4 7")
  }; 
  static const ColourLines diag2[2] = { 
    ColourLines("1 3 4 7, -1 2, -2 -3 -6, 5 -7"), 
    ColourLines("1 -2, -1 -3 -6, 2 3 4 7, 5 -7")
  }; 
  static const ColourLines diag3[2] = { 
    ColourLines("1 3 5, -1 2, -2 -3 -4 -7, -6 7"), 
    ColourLines("1 -2, -1 -3 -4 -7, 2 3 5, -6 7")
  }; 
  static const ColourLines diag4[1] = { 
    ColourLines("1 5, -1 -2 -7, 4 -3 7, -4 -6")
  }; 
  static const ColourLines diag5[2] = { 
    ColourLines("1 5, -1 -2 -3 4, -4 -7, -6 3 7"), 
    ColourLines("1 5, -1 -2 -3 -7, 4 7, -4 3 -6")
  }; 
  static const ColourLines diag6[1] = { 
    ColourLines("1 5, -1 -2 3, -3 -4 -7, -6 7")
  }; 
  static const ColourLines diag7[1] = { 
    ColourLines("1 2 7, -1 -6, 4 5, -4 3 -7")
  }; 
  static const ColourLines diag8[2] = { 
    ColourLines("1 2 3 7, -1 -6, 4 -3 5, -4 -7"), 
    ColourLines("1 2 3 -4, -1 -6, 4 7, 5 -3 -7")
  }; 
  static const ColourLines diag9[1] = { 
    ColourLines("1 2 -3, -1 -6, 3 4 7, 5 -7")
  }; 
  static const ColourLines diag10[2] = { 
    ColourLines("1 2 3 -4, -1 -7, 4 5, -6 -2 7"), 
    ColourLines("1 7, -1 -2 -6, 4 5, -4 3 2 -7")
  }; 
  static const ColourLines diag11[2] = { 
    ColourLines("1 2 5, -1 -7, 4 -3 -2 7, -4 -6"), 
    ColourLines("1 7, -1 -2 -3 4, -4 -6, 5 2 -7")
  }; 
  static const ColourLines diag12[4] = { 
    ColourLines("1 2 -3, -1 -7, 3 4 5, -6 -4 -2 7"), 
    ColourLines("1 7, -1 -2 -4 -6, 3 4 5, -3 2 -7"), 
    ColourLines("1 2 4 5, -1 -7, 3 -2 7, -3 -4 -6"), 
    ColourLines("1 7, -1 -2 3, -3 -4 -6, 5 4 2 -7")
  }; 
  static const ColourLines diag13[1] = { 
    ColourLines("1 2 -3, -1 -4 -7, 3 5, -6 7")
  }; 
  static const ColourLines diag14[1] = { 
    ColourLines("1 4 7, -1 -2 3, -3 -6, 5 -7")
  }; 
  static const ColourLines diag15[4] = { 
    ColourLines("1 4 5, -1 -2 3, -3 -7, -6 -4 2 7"), 
    ColourLines("1 4 5, -1 -2 -7, 3 7, -3 2 -4 -6"), 
    ColourLines("1 2 7, -1 -4 -6, 3 -2 4 5, -3 -7"), 
    ColourLines("1 2 -3, -1 -4 -6, 3 7, 5 4 -2 -7")
  }; 
