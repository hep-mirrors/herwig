// -*- C++ -*-
//
// NLOJetMEkq2kqgg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEkq2kqgg class.
//

#include "NLOJetMEkq2kqgg.h"
...
NLOJetMEkq2kqgg::NLOJetMEkq2kqgg() {}

NLOJetMEkq2kqgg::~NLOJetMEkq2kqgg() {}

IBPtr NLOJetMEkq2kqgg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEkq2kqgg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEkq2kqgg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEkq2kqgg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEkq2kqgg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEkq2kqgg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEkq2kqgg("Herwig::NLOJetMEkq2kqgg", "HwMatchboxNLOJet.so");

void NLOJetMEkq2kqgg::Init() {

  static ClassDocumentation<NLOJetMEkq2kqgg> documentation
    ("NLOJetMEkq2kqgg");

}


void NLOJetMEkq2kqgg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    for(unsigned xi2 = 0; xi2 != quark.size(); xi2++){ 
      ...
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, q, 2, g, 1, k, 3, q, 5, g, 5, g, -1)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, qb, q, 2, q, 1, k, 5, q, 3, g, 5, g, -2)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, qb, q, 2, q, 1, k, 5, q, 5, g, 3, g, -3)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, q, 2, k, 5, k, 3, q, 1, g, 5, g, -4)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, q, 2, k, 5, k, 3, q, 5, g, 1, g, -5)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, g, q, 1, k, 4, q, 2, g, 3, g, -6)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, g, q, 1, k, 4, q, 3, g, 2, g, -7)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, qb, qb, q, 1, k, 2, q, 4, g, 3, g, -8)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, qb, q, 1, k, 3, q, 4, g, 2, g, -9)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, qb, qb, q, 1, k, 2, q, 3, g, 4, g, -10)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, qb, q, 1, k, 3, q, 2, g, 4, g, -11)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 2, q, 4, q, 1, k, 5, q, 5, g, 4, g, -12)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, q, 3, q, 1, k, 5, q, 5, g, 2, g, -13)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 2, q, 4, q, 1, k, 5, q, 4, g, 5, g, -14)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, q, 3, q, 1, k, 5, q, 2, g, 5, g, -15)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 2, q, 4, g, 1, k, 4, q, 5, g, 5, g, -16)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, qb, q, 3, g, 1, k, 2, q, 5, g, 5, g, -17)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, g, q, 2, k, 4, q, 1, g, 3, g, -18)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, k, g, q, 3, k, 4, q, 1, g, 2, g, -19)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, qb, q, 2, k, 3, q, 1, g, 4, g, -20)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, q, 3, q, 2, k, 5, q, 1, g, 5, g, -21)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, g, q, 2, k, 4, q, 3, g, 1, g, -22)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, k, g, q, 3, k, 4, q, 2, g, 1, g, -23)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, qb, q, 2, k, 3, q, 4, g, 1, g, -24)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, q, 3, q, 2, k, 5, q, 5, g, 1, g, -25)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 1, k, 4, k, 5, k, 2, q, 5, g, 4, g, -26)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, q, 1, k, 5, k, 3, q, 5, g, 2, g, -27)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 1, k, 4, k, 5, k, 2, q, 4, g, 5, g, -28)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, q, 1, k, 5, k, 3, q, 2, g, 5, g, -29)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 1, k, 4, g, 4, k, 2, q, 5, g, 5, g, -30)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, q, 1, g, 2, k, 3, q, 5, g, 5, g, -31)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, qb, q, 1, k, 5, k, 2, q, 3, g, 5, g, -32)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, qb, q, 1, k, 5, k, 2, q, 5, g, 3, g, -33)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 1, k, 2, q, 4, k, 5, q, 4, g, 5, g, -34)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, q, 1, k, 2, q, 4, k, 5, q, 5, g, 4, g, -35)));
      if( ( xi1 ==  xi2 ) ){ 
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, g, q, 2, g, 3, q, 1, q, 5, g, 5, g, -36)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, qb, q, 2, q, 5, q, 1, q, 3, g, 5, g, -37)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, qb, q, 2, q, 5, q, 1, q, 5, g, 3, g, -38)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, q, g, q, 2, q, 3, q, 5, q, 1, g, 5, g, -39)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, q, g, q, 2, q, 3, q, 5, q, 5, g, 1, g, -40)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, g, g, g, q, 4, q, 1, q, 2, g, 3, g, -41)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, g, g, g, q, 4, q, 1, q, 3, g, 2, g, -42)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, g, qb, qb, q, 2, q, 1, q, 4, g, 3, g, -43)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, g, g, qb, q, 3, q, 1, q, 4, g, 2, g, -44)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, g, qb, qb, q, 2, q, 1, q, 3, g, 4, g, -45)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, g, g, qb, q, 3, q, 1, q, 2, g, 4, g, -46)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 2, q, 4, q, 5, q, 1, q, 5, g, 4, g, -47)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, g, q, 3, q, 5, q, 1, q, 5, g, 2, g, -48)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 2, q, 4, q, 5, q, 1, q, 4, g, 5, g, -49)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, g, q, 3, q, 5, q, 1, q, 2, g, 5, g, -50)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 2, q, 4, g, 4, q, 1, q, 5, g, 5, g, -51)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, qb, q, 3, g, 2, q, 1, q, 5, g, 5, g, -52)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, q, g, g, q, 4, q, 2, q, 1, g, 3, g, -53)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, q, q, g, q, 4, q, 3, q, 1, g, 2, g, -54)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, q, g, qb, q, 3, q, 2, q, 1, g, 4, g, -55)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, q, g, q, 3, q, 5, q, 2, q, 1, g, 5, g, -56)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, q, g, g, q, 4, q, 2, q, 3, g, 1, g, -57)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, q, q, g, q, 4, q, 3, q, 2, g, 1, g, -58)));
        addSafe(new_ptr((Tree2toNDiagram(5), q, q, g, qb, q, 3, q, 2, q, 4, g, 1, g, -59)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, q, g, q, 3, q, 5, q, 2, q, 5, g, 1, g, -60)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 1, q, 4, q, 2, q, 5, q, 5, g, 4, g, -61)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, g, q, 1, q, 3, q, 5, q, 5, g, 2, g, -62)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 1, q, 4, q, 2, q, 5, q, 4, g, 5, g, -63)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, g, q, 1, q, 3, q, 5, q, 2, g, 5, g, -64)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 1, q, 4, g, 2, q, 4, q, 5, g, 5, g, -65)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, q, g, q, 1, g, 3, q, 2, q, 5, g, 5, g, -66)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, qb, q, 1, q, 2, q, 5, q, 3, g, 5, g, -67)));
        addSafe(new_ptr((Tree2toNDiagram(4), q, g, qb, q, 1, q, 2, q, 5, q, 5, g, 3, g, -68)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 2, q, 1, q, 4, q, 5, q, 4, g, 5, g, -69)));
        addSafe(new_ptr((Tree2toNDiagram(3), q, g, q, 2, q, 1, q, 4, q, 5, q, 5, g, 4, g, -70)));
      }
    }  
  }  
}
...
Selector <MEBase::DiagramIndex> NLOJetMEkq2kqgg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv1at1[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv1at2[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv1at3[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv2at0[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv3at0[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv4at0[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv5at0[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv6at0[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv6at1[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv6at2[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv6at3[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv7at0[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv7at1[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv7at2[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv7at3[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv8at0[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv9at0[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv9at1[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv10at0[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv11at0[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv11at1[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv12at0[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv13at0[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv13at1[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv14at0[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv15at0[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv15at1[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv16at0[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv16at1[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv17at0[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv17at1[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv18at0[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv18at1[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv19at0[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv20at0[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv21at0[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv22at0[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv22at1[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv23at0[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv24at0[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv25at0[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv26at0[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv27at0[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv27at1[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv28at0[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv29at0[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv29at1[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv30at0[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv30at1[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv31at0[]  = { 1, 0, -999, 2, 3, 4, -1, -999};
  static const int cv31at1[]  = { 1, 0, -999, 2, 4, 3, -1, -999};
  static const int cv32at0[]  = { 2, -1, -999, 1, 4, 3, 0, -999};
  static const int cv33at0[]  = { 2, -1, -999, 1, 3, 4, 0, -999};
  static const int cv34at0[]  = { 1, 3, 0, -999, 2, 4, -1, -999};
  static const int cv35at0[]  = { 1, 4, 0, -999, 2, 3, -1, -999};
  static const int cv36at0[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv36at1[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv36at2[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv36at3[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv37at0[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv38at0[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv39at0[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv40at0[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv41at0[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv41at1[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv41at2[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv41at3[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv42at0[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv42at1[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv42at2[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv42at3[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv43at0[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv44at0[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv44at1[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv45at0[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv46at0[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv46at1[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv47at0[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv48at0[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv48at1[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv49at0[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv50at0[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv50at1[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv51at0[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv51at1[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv52at0[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv52at1[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv53at0[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv53at1[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv54at0[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv55at0[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv56at0[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv57at0[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv57at1[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv58at0[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv59at0[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv60at0[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv61at0[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv62at0[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv62at1[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
  static const int cv63at0[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv64at0[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv64at1[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv65at0[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv65at1[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv66at0[]  = { 2, 0, -999, 1, 3, 4, -1, -999};
  static const int cv66at1[]  = { 2, 0, -999, 1, 4, 3, -1, -999};
  static const int cv67at0[]  = { 1, -1, -999, 2, 4, 3, 0, -999};
  static const int cv68at0[]  = { 1, -1, -999, 2, 3, 4, 0, -999};
  static const int cv69at0[]  = { 1, 3, -1, -999, 2, 4, 0, -999};
  static const int cv70at0[]  = { 1, 4, -1, -999, 2, 3, 0, -999};
...
Selector<const ColourLines *> NLOJetMEkq2kqgg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEkq2kqgg
