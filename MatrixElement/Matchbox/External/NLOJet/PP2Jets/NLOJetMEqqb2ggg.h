// -*- C++ -*-
//
// NLOJetMEqqb2ggg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqqb2ggg_H
#define HERWIG_NLOJetMEqqb2ggg_H
//
// This is the declaration of the NLOJetMEqqb2ggg class.
//
 ...
 *
 * \brief NLOJetMEqqb2ggg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqqb2gggInterfaces "The interfaces"
 * defined for NLOJetMEqqb2ggg.
 */
class NLOJetMEqqb2ggg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqqb2ggg & operator=(const NLOJetMEqqb2ggg &);

};

}

#endif /* HERWIG_NLOJetMEqqb2ggg_H */
