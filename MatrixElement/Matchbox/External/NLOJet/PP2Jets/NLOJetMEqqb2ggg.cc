// -*- C++ -*-
//
// NLOJetMEqqb2ggg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEqqb2ggg class.
//

#include "NLOJetMEqqb2ggg.h"
...
NLOJetMEqqb2ggg::NLOJetMEqqb2ggg() {}

NLOJetMEqqb2ggg::~NLOJetMEqqb2ggg() {}

IBPtr NLOJetMEqqb2ggg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEqqb2ggg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEqqb2ggg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEqqb2ggg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEqqb2ggg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEqqb2ggg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEqqb2ggg("Herwig::NLOJetMEqqb2ggg", "HwMatchboxNLOJet.so");

void NLOJetMEqqb2ggg::Init() {

  static ClassDocumentation<NLOJetMEqqb2ggg> documentation
    ("NLOJetMEqqb2ggg");

}


void NLOJetMEqqb2ggg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    addSafe(new_ptr((Tree2toNDiagram(2), q, qb, 1, g, 3, g, 4, g, 4, g, 3, g, -1)));
    addSafe(new_ptr((Tree2toNDiagram(2), q, qb, 1, g, 3, g, 4, g, 3, g, 4, g, -2)));
    addSafe(new_ptr((Tree2toNDiagram(2), q, qb, 1, g, 3, g, 3, g, 4, g, 4, g, -3)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, qb, 1, g, 3, g, 2, g, -4)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, qb, 1, g, 2, g, 3, g, -5)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, qb, 2, g, 1, g, 4, g, 4, g, -6)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, qb, 3, g, 1, g, 2, g, -7)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, qb, 2, g, 1, g, 3, g, -8)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, qb, 2, g, 4, g, 1, g, 4, g, -9)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, qb, 3, g, 2, g, 1, g, -10)));
    addSafe(new_ptr((Tree2toNDiagram(4), q, q, q, qb, 2, g, 3, g, 1, g, -11)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, qb, 2, g, 4, g, 4, g, 1, g, -12)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, qb, 1, g, 2, g, 4, g, 4, g, -13)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, qb, 1, g, 4, g, 2, g, 4, g, -14)));
    addSafe(new_ptr((Tree2toNDiagram(3), q, q, qb, 1, g, 4, g, 4, g, 2, g, -15)));
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEqqb2ggg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 0, 1, 2, 3, -1, -999};
  static const int cv1at1[]  = { 0, 2, 1, 3, -1, -999};
  static const int cv1at2[]  = { 0, 3, 1, 2, -1, -999};
  static const int cv1at3[]  = { 0, 3, 2, 1, -1, -999};
  static const int cv2at0[]  = { 0, 1, 3, 2, -1, -999};
  static const int cv2at1[]  = { 0, 3, 1, 2, -1, -999};
  static const int cv2at2[]  = { 0, 2, 1, 3, -1, -999};
  static const int cv2at3[]  = { 0, 2, 3, 1, -1, -999};
  static const int cv3at0[]  = { 0, 2, 3, 1, -1, -999};
  static const int cv3at1[]  = { 0, 3, 2, 1, -1, -999};
  static const int cv3at2[]  = { 0, 1, 2, 3, -1, -999};
  static const int cv3at3[]  = { 0, 1, 3, 2, -1, -999};
  ...
  static const int cv7at0[]  = { 0, 1, 3, 2, -1, -999};
  static const int cv8at0[]  = { 0, 3, 1, 2, -1, -999};
  static const int cv9at0[]  = { 0, 1, 3, 2, -1, -999};
  static const int cv9at1[]  = { 0, 3, 1, 2, -1, -999};
  static const int cv10at0[]  = { 0, 1, 2, 3, -1, -999};
  static const int cv11at0[]  = { 0, 2, 1, 3, -1, -999};
  static const int cv12at0[]  = { 0, 1, 2, 3, -1, -999};
  static const int cv12at1[]  = { 0, 2, 1, 3, -1, -999};
  static const int cv13at0[]  = { 0, 1, 2, 3, -1, -999};
  static const int cv13at1[]  = { 0, 1, 3, 2, -1, -999};
  static const int cv14at0[]  = { 0, 2, 1, 3, -1, -999};
  static const int cv14at1[]  = { 0, 2, 3, 1, -1, -999};
  static const int cv15at0[]  = { 0, 3, 1, 2, -1, -999};
  static const int cv15at1[]  = { 0, 3, 2, 1, -1, -999};
...
Selector<const ColourLines *> NLOJetMEqqb2ggg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEqqb2ggg

  static const ColourLines diag1[4] = { 
    ColourLines("1 3 7, -2 -3 -4 -5, 5 -6, 6 4 -7"), 
    ColourLines("1 3 7, -2 -3 -4 -6, 5 4 -7, -5 6"), 
    ColourLines("1 3 4 6, -2 -3 -7, 5 -6, -5 -4 7"), 
    ColourLines("1 3 4 5, -2 -3 -7, -5 6, -6 -4 7")
  }; 
  static const ColourLines diag2[4] = { 
    ColourLines("1 3 6, -2 -3 -4 -5, 5 -7, -6 4 7"), 
    ColourLines("1 3 6, -2 -3 -4 -7, 5 4 -6, -5 7"), 
    ColourLines("1 3 4 7, -2 -3 -6, 5 -7, -5 -4 6"), 
  ...
  static const ColourLines diag14[2] = { 
    ColourLines("1 4 7, -3 -6, 5 -7, -5 -4 2 6"), 
    ColourLines("1 4 5, -3 -6, -5 7, 6 2 -4 -7")
  }; 
  static const ColourLines diag15[2] = { 
    ColourLines("1 4 6, -3 -7, 5 -6, -5 -4 2 7"), 
