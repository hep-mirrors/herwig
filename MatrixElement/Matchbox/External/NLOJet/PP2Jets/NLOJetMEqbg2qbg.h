// -*- C++ -*-
//
// NLOJetMEqbg2qbg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqbg2qbg_H
#define HERWIG_NLOJetMEqbg2qbg_H
//
// This is the declaration of the NLOJetMEqbg2qbg class.
//
 ...
 *
 * \brief NLOJetMEqbg2qbg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqbg2qbgInterfaces "The interfaces"
 * defined for NLOJetMEqbg2qbg.
 */
class NLOJetMEqbg2qbg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqbg2qbg & operator=(const NLOJetMEqbg2qbg &);

};

}

#endif /* HERWIG_NLOJetMEqbg2qbg_H */
