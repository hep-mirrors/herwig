// -*- C++ -*-
//
// NLOJetMEgq2qgg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEgq2qgg class.
//

#include "NLOJetMEgq2qgg.h"
...
NLOJetMEgq2qgg::NLOJetMEgq2qgg() {}

NLOJetMEgq2qgg::~NLOJetMEgq2qgg() {}

IBPtr NLOJetMEgq2qgg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEgq2qgg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEgq2qgg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEgq2qgg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEgq2qgg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEgq2qgg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEgq2qgg("Herwig::NLOJetMEgq2qgg", "HwMatchboxNLOJet.so");

void NLOJetMEgq2qgg::Init() {

  static ClassDocumentation<NLOJetMEgq2qgg> documentation
    ("NLOJetMEgq2qgg");

}


void NLOJetMEgq2qgg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    addSafe(new_ptr((Tree2toNDiagram(2), g, q, 1, q, 3, q, 4, q, 4, g, 3, g, -1)));
    addSafe(new_ptr((Tree2toNDiagram(2), g, q, 1, q, 3, q, 4, q, 3, g, 4, g, -2)));
    addSafe(new_ptr((Tree2toNDiagram(2), g, q, 1, q, 3, g, 3, q, 4, g, 4, g, -3)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, qb, qb, q, 1, q, 3, g, 2, g, -4)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, qb, qb, q, 1, q, 2, g, 3, g, -5)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, qb, q, 2, g, 1, q, 4, g, 4, g, -6)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, g, q, 3, q, 1, g, 2, g, -7)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, qb, q, 2, q, 1, g, 3, g, -8)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, q, 2, q, 4, q, 1, g, 4, g, -9)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, g, q, 3, q, 2, g, 1, g, -10)));
    addSafe(new_ptr((Tree2toNDiagram(4), g, g, qb, q, 2, q, 3, g, 1, g, -11)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, q, 2, q, 4, q, 4, g, 1, g, -12)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, g, q, 1, g, 2, q, 4, g, 4, g, -13)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, qb, q, 1, q, 4, q, 2, g, 4, g, -14)));
    addSafe(new_ptr((Tree2toNDiagram(3), g, qb, q, 1, q, 4, q, 4, g, 2, g, -15)));
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEgq2qgg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 1, 2, 3, -1, 0, -999};
  static const int cv2at0[]  = { 1, 3, 2, -1, 0, -999};
  ...
  static const int cv7at0[]  = { 1, 3, -1, 2, 0, -999};
  static const int cv7at1[]  = { 1, 3, 2, -1, 0, -999};
  static const int cv7at2[]  = { 1, -1, 2, 3, 0, -999};
  static const int cv7at3[]  = { 1, 2, -1, 3, 0, -999};
  static const int cv8at0[]  = { 1, -1, 2, 3, 0, -999};
  static const int cv8at1[]  = { 1, 2, -1, 3, 0, -999};
  static const int cv9at0[]  = { 1, 3, -1, 2, 0, -999};
  static const int cv9at1[]  = { 1, 3, 2, -1, 0, -999};
  static const int cv10at0[]  = { 1, 2, -1, 3, 0, -999};
  static const int cv10at1[]  = { 1, 2, 3, -1, 0, -999};
  static const int cv10at2[]  = { 1, -1, 3, 2, 0, -999};
  static const int cv10at3[]  = { 1, 3, -1, 2, 0, -999};
  static const int cv11at0[]  = { 1, -1, 3, 2, 0, -999};
  static const int cv11at1[]  = { 1, 3, -1, 2, 0, -999};
  static const int cv12at0[]  = { 1, 2, -1, 3, 0, -999};
  static const int cv12at1[]  = { 1, 2, 3, -1, 0, -999};
  static const int cv13at0[]  = { 1, 2, 3, -1, 0, -999};
  static const int cv13at1[]  = { 1, 3, 2, -1, 0, -999};
  static const int cv13at2[]  = { 1, -1, 2, 3, 0, -999};
  static const int cv13at3[]  = { 1, -1, 3, 2, 0, -999};
  static const int cv14at0[]  = { 1, 3, -1, 2, 0, -999};
  static const int cv15at0[]  = { 1, 2, -1, 3, 0, -999};
...
Selector<const ColourLines *> NLOJetMEgq2qgg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEgq2qgg

  static const ColourLines diag1[1] = { 
    ColourLines("1 3 7, -1 2, 5 -6, 6 4 -7")
  }; 
  static const ColourLines diag2[1] = { 
    ColourLines("1 3 6, -1 2, 5 -7, -6 4 7")
  }; 
  static const ColourLines diag3[2] = { 
    ColourLines("1 3 4 7, -1 2, 5 -4 -6, 6 -7"), 
    ColourLines("1 3 4 6, -1 2, 5 -4 -7, -6 7")
  }; 
  static const ColourLines diag4[1] = { 
    ColourLines("1 5, -1 -2 -7, 4 6, -6 -3 7")
  }; 
  static const ColourLines diag5[1] = { 
    ColourLines("1 5, -1 -2 -6, 4 7, 6 -3 -7")
  }; 
  static const ColourLines diag6[2] = { 
    ColourLines("1 5, -1 -2 -4 -6, 3 4 7, 6 -7"), 
    ColourLines("1 5, -1 -2 -4 -7, 3 4 6, -6 7")
  }; 
  static const ColourLines diag7[4] = { 
    ColourLines("1 2 7, -1 -6, 4 -3 -2 6, 5 3 -7"), 
    ColourLines("1 6, -1 -2 -3 4, 5 3 -7, -6 2 7"), 
    ColourLines("1 2 3 5, -1 -6, 4 -3 7, 6 -2 -7"), 
    ColourLines("1 6, -1 -2 -7, 4 -3 7, 5 3 2 -6")
  }; 
  static const ColourLines diag8[2] = { 
    ColourLines("1 2 5, -1 -6, 4 7, 6 -2 -3 -7"), 
    ColourLines("1 6, -1 -2 -3 -7, 4 7, 5 2 -6")
  }; 
  static const ColourLines diag9[2] = { 
    ColourLines("1 2 4 7, -1 -6, 3 -2 6, 5 -7"), 
    ColourLines("1 6, -1 -2 3, 5 -7, -6 2 4 7")
  }; 
  static const ColourLines diag10[4] = { 
    ColourLines("1 2 6, -1 -7, 4 -3 -2 7, 5 3 -6"), 
    ColourLines("1 7, -1 -2 -3 4, 5 3 -6, 6 2 -7"), 
    ColourLines("1 2 3 5, -1 -7, 4 -3 6, -6 -2 7"), 
    ColourLines("1 7, -1 -2 -6, 4 -3 6, 5 3 2 -7")
  }; 
  static const ColourLines diag11[2] = { 
    ColourLines("1 2 5, -1 -7, 4 6, -6 -3 -2 7"), 
    ColourLines("1 7, -1 -2 -3 -6, 4 6, 5 2 -7")
  }; 
  static const ColourLines diag12[2] = { 
    ColourLines("1 2 4 6, -1 -7, 3 -2 7, 5 -6"), 
    ColourLines("1 7, -1 -2 3, 5 -6, 6 4 2 -7")
  }; 
  static const ColourLines diag13[4] = { 
    ColourLines("1 4 7, -1 -2 3, 5 2 -4 -6, 6 -7"), 
    ColourLines("1 4 6, -1 -2 3, 5 2 -4 -7, -6 7"), 
    ColourLines("1 2 5, -1 -4 -6, 3 -2 4 7, 6 -7"), 
    ColourLines("1 2 5, -1 -4 -7, 3 -2 4 6, -6 7")
  }; 
  static const ColourLines diag14[1] = { 
    ColourLines("1 4 7, -1 -2 -6, 3 6, 5 -7")
  }; 
  static const ColourLines diag15[1] = { 
    ColourLines("1 4 6, -1 -2 -7, 3 7, 5 -6")
  }; 
