// -*- C++ -*-
//
// NLOJetMEgg2qqbg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgg2qqbg_H
#define HERWIG_NLOJetMEgg2qqbg_H
//
// This is the declaration of the NLOJetMEgg2qqbg class.
//
 ...
 *
 * \brief NLOJetMEgg2qqbg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgg2qqbgInterfaces "The interfaces"
 * defined for NLOJetMEgg2qqbg.
 */
class NLOJetMEgg2qqbg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgg2qqbg & operator=(const NLOJetMEgg2qqbg &);

};

}

#endif /* HERWIG_NLOJetMEgg2qqbg_H */
