// -*- C++ -*-
//
// NLOJetMEkqb2kqbgg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEkqb2kqbgg class.
//

#include "NLOJetMEkqb2kqbgg.h"
...
NLOJetMEkqb2kqbgg::NLOJetMEkqb2kqbgg() {}

NLOJetMEkqb2kqbgg::~NLOJetMEkqb2kqbgg() {}

IBPtr NLOJetMEkqb2kqbgg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEkqb2kqbgg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEkqb2kqbgg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEkqb2kqbgg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEkqb2kqbgg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEkqb2kqbgg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEkqb2kqbgg("Herwig::NLOJetMEkqb2kqbgg", "HwMatchboxNLOJet.so");

void NLOJetMEkqb2kqbgg::Init() {

  static ClassDocumentation<NLOJetMEkqb2kqbgg> documentation
    ("NLOJetMEkqb2kqbgg");

}


void NLOJetMEkqb2kqbgg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
	...
	continue;
      ...
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, qb, 2, g, 1, k, 3, qb, 5, g, 5, g, -1)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, q, qb, 2, qb, 1, k, 5, qb, 3, g, 5, g, -2)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, q, qb, 2, qb, 1, k, 5, qb, 5, g, 3, g, -3)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, qb, 2, k, 5, k, 3, qb, 1, g, 5, g, -4)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, qb, 2, k, 5, k, 3, qb, 5, g, 1, g, -5)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, g, qb, 1, k, 4, qb, 2, g, 3, g, -6)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, g, qb, 1, k, 4, qb, 3, g, 2, g, -7)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, q, q, qb, 1, k, 2, qb, 4, g, 3, g, -8)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, q, qb, 1, k, 3, qb, 4, g, 2, g, -9)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, q, q, qb, 1, k, 2, qb, 3, g, 4, g, -10)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, g, g, q, qb, 1, k, 3, qb, 2, g, 4, g, -11)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 2, qb, 4, qb, 1, k, 5, qb, 5, g, 4, g, -12)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, qb, 3, qb, 1, k, 5, qb, 5, g, 2, g, -13)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 2, qb, 4, qb, 1, k, 5, qb, 4, g, 5, g, -14)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, qb, 3, qb, 1, k, 5, qb, 2, g, 5, g, -15)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 2, qb, 4, g, 1, k, 4, qb, 5, g, 5, g, -16)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, q, qb, 3, g, 1, k, 2, qb, 5, g, 5, g, -17)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, g, qb, 2, k, 4, qb, 1, g, 3, g, -18)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, k, g, qb, 3, k, 4, qb, 1, g, 2, g, -19)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, q, qb, 2, k, 3, qb, 1, g, 4, g, -20)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, qb, 3, qb, 2, k, 5, qb, 1, g, 5, g, -21)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, g, qb, 2, k, 4, qb, 3, g, 1, g, -22)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, k, g, qb, 3, k, 4, qb, 2, g, 1, g, -23)));
      addSafe(new_ptr((Tree2toNDiagram(5), k, k, g, q, qb, 2, k, 3, qb, 4, g, 1, g, -24)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, qb, 3, qb, 2, k, 5, qb, 5, g, 1, g, -25)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 1, k, 4, k, 5, k, 2, qb, 5, g, 4, g, -26)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, qb, 1, k, 5, k, 3, qb, 5, g, 2, g, -27)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 1, k, 4, k, 5, k, 2, qb, 4, g, 5, g, -28)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, g, qb, 1, k, 5, k, 3, qb, 2, g, 5, g, -29)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 1, k, 4, g, 4, k, 2, qb, 5, g, 5, g, -30)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, k, g, qb, 1, g, 2, k, 3, qb, 5, g, 5, g, -31)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, q, qb, 1, k, 5, k, 2, qb, 3, g, 5, g, -32)));
      addSafe(new_ptr((Tree2toNDiagram(4), k, g, q, qb, 1, k, 5, k, 2, qb, 5, g, 3, g, -33)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 1, k, 2, qb, 4, k, 5, qb, 4, g, 5, g, -34)));
      addSafe(new_ptr((Tree2toNDiagram(3), k, g, qb, 1, k, 2, qb, 4, k, 5, qb, 5, g, 4, g, -35)));
    }  
  }  
}


Selector <MEBase::DiagramIndex> NLOJetMEkqb2kqbgg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv1at1[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv1at2[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv1at3[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv2at0[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv3at0[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv4at0[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv5at0[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv6at0[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv6at1[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv6at2[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv6at3[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv7at0[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv7at1[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv7at2[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv7at3[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv8at0[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv9at0[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv9at1[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv10at0[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv11at0[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv11at1[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv12at0[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv13at0[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv13at1[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv14at0[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv15at0[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv15at1[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv16at0[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv16at1[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv17at0[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv17at1[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv18at0[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv18at1[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv19at0[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv20at0[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv21at0[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv22at0[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv22at1[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv23at0[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv24at0[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv25at0[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv26at0[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv27at0[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv27at1[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv28at0[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv29at0[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv29at1[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv30at0[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv30at1[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv31at0[]  = { 0, 3, 4, -1, -999, 1, 2, -999};
  static const int cv31at1[]  = { 0, 4, 3, -1, -999, 1, 2, -999};
  static const int cv32at0[]  = { 0, 3, -1, -999, 1, 4, 2, -999};
  static const int cv33at0[]  = { 0, 4, -1, -999, 1, 3, 2, -999};
  static const int cv34at0[]  = { 0, -1, -999, 1, 3, 4, 2, -999};
  static const int cv35at0[]  = { 0, -1, -999, 1, 4, 3, 2, -999};
  static const int cv36at0[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv36at1[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv36at2[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv36at3[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv37at0[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv38at0[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv39at0[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv40at0[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv41at0[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv41at1[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv41at2[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv41at3[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv42at0[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv42at1[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv42at2[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv42at3[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv43at0[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv44at0[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv44at1[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv45at0[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv46at0[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv46at1[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv47at0[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv48at0[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv48at1[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv49at0[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv50at0[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv50at1[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv51at0[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv51at1[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv52at0[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv52at1[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv53at0[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv53at1[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv54at0[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv55at0[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
  static const int cv56at0[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv57at0[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv57at1[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv58at0[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv59at0[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv60at0[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv61at0[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv61at1[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv62at0[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv63at0[]  = { 0, 3, 2, -999, 1, 4, -1, -999};
  static const int cv64at0[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv65at0[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv65at1[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv66at0[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv67at0[]  = { 0, 4, 2, -999, 1, 3, -1, -999};
  static const int cv68at0[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv69at0[]  = { 1, -1, -999, 0, 3, 4, 2, -999};
  static const int cv69at1[]  = { 1, -1, -999, 0, 4, 3, 2, -999};
  static const int cv70at0[]  = { 0, 2, -999, 1, 3, 4, -1, -999};
  static const int cv70at1[]  = { 0, 2, -999, 1, 4, 3, -1, -999};
...
Selector<const ColourLines *> NLOJetMEkqb2kqbgg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEkqb2kqbgg
