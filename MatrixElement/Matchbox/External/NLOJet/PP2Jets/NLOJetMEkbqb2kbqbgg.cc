// -*- C++ -*-
//
// NLOJetMEkbqb2kbqbgg.cc is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
// functions of the NLOJetMEkbqb2kbqbgg class.
//

#include "NLOJetMEkbqb2kbqbgg.h"
...
NLOJetMEkbqb2kbqbgg::NLOJetMEkbqb2kbqbgg() {}

NLOJetMEkbqb2kbqbgg::~NLOJetMEkbqb2kbqbgg() {}

IBPtr NLOJetMEkbqb2kbqbgg::clone() const {
  return new_ptr(*this);
}

IBPtr NLOJetMEkbqb2kbqbgg::fullclone() const {
  return new_ptr(*this);
}
...
void NLOJetMEkbqb2kbqbgg::doinit() {
  NLOJetMEBase<0,2,0>::doinit();
}

void NLOJetMEkbqb2kbqbgg::persistentOutput(PersistentOStream &) const {}

void NLOJetMEkbqb2kbqbgg::persistentInput(PersistentIStream &, int) {}
...
DescribeClass<Herwig::NLOJetMEkbqb2kbqbgg,Herwig::NLOJetMEBase<0,2,0> >
  describeNLOJetMEkbqb2kbqbgg("Herwig::NLOJetMEkbqb2kbqbgg", "HwMatchboxNLOJet.so");

void NLOJetMEkbqb2kbqbgg::Init() {

  static ClassDocumentation<NLOJetMEkbqb2kbqbgg> documentation
    ("NLOJetMEkbqb2kbqbgg");

}


void NLOJetMEkbqb2kbqbgg::doGetDiagrams() const {
  ...
  for(unsigned xi1 = 0; xi1 != quark.size(); xi1++){ 
    ...
    for(unsigned xi2 = 0; xi2 != quark.size(); xi2++){ 
      ...
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 2, g, 1, kb, 3, qb, 5, g, 5, g, -1)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 2, qb, 1, kb, 5, qb, 3, g, 5, g, -2)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 2, qb, 1, kb, 5, qb, 5, g, 3, g, -3)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 2, kb, 5, kb, 3, qb, 1, g, 5, g, -4)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 2, kb, 5, kb, 3, qb, 5, g, 1, g, -5)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, g, qb, 1, kb, 4, qb, 2, g, 3, g, -6)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, g, qb, 1, kb, 4, qb, 3, g, 2, g, -7)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, q, q, qb, 1, kb, 2, qb, 4, g, 3, g, -8)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, q, qb, 1, kb, 3, qb, 4, g, 2, g, -9)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, q, q, qb, 1, kb, 2, qb, 3, g, 4, g, -10)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, g, g, q, qb, 1, kb, 3, qb, 2, g, 4, g, -11)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 2, qb, 4, qb, 1, kb, 5, qb, 5, g, 4, g, -12)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 3, qb, 1, kb, 5, qb, 5, g, 2, g, -13)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 2, qb, 4, qb, 1, kb, 5, qb, 4, g, 5, g, -14)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 3, qb, 1, kb, 5, qb, 2, g, 5, g, -15)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 2, qb, 4, g, 1, kb, 4, qb, 5, g, 5, g, -16)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 3, g, 1, kb, 2, qb, 5, g, 5, g, -17)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, g, qb, 2, kb, 4, qb, 1, g, 3, g, -18)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, kb, g, qb, 3, kb, 4, qb, 1, g, 2, g, -19)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, q, qb, 2, kb, 3, qb, 1, g, 4, g, -20)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 3, qb, 2, kb, 5, qb, 1, g, 5, g, -21)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, g, qb, 2, kb, 4, qb, 3, g, 1, g, -22)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, kb, g, qb, 3, kb, 4, qb, 2, g, 1, g, -23)));
      addSafe(new_ptr((Tree2toNDiagram(5), kb, kb, g, q, qb, 2, kb, 3, qb, 4, g, 1, g, -24)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 3, qb, 2, kb, 5, qb, 5, g, 1, g, -25)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 4, kb, 5, kb, 2, qb, 5, g, 4, g, -26)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 1, kb, 5, kb, 3, qb, 5, g, 2, g, -27)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 4, kb, 5, kb, 2, qb, 4, g, 5, g, -28)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, g, qb, 1, kb, 5, kb, 3, qb, 2, g, 5, g, -29)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 4, g, 4, kb, 2, qb, 5, g, 5, g, -30)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, kb, g, qb, 1, g, 2, kb, 3, qb, 5, g, 5, g, -31)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 1, kb, 5, kb, 2, qb, 3, g, 5, g, -32)));
      addSafe(new_ptr((Tree2toNDiagram(4), kb, g, q, qb, 1, kb, 5, kb, 2, qb, 5, g, 3, g, -33)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 2, qb, 4, kb, 5, qb, 4, g, 5, g, -34)));
      addSafe(new_ptr((Tree2toNDiagram(3), kb, g, qb, 1, kb, 2, qb, 4, kb, 5, qb, 5, g, 4, g, -35)));
      if( ( xi1 ==  xi2 ) ){ 
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 2, g, 3, qb, 1, qb, 5, g, 5, g, -36)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 2, qb, 5, qb, 1, qb, 3, g, 5, g, -37)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 2, qb, 5, qb, 1, qb, 5, g, 3, g, -38)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 2, qb, 3, qb, 5, qb, 1, g, 5, g, -39)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 2, qb, 3, qb, 5, qb, 5, g, 1, g, -40)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, g, g, g, qb, 4, qb, 1, qb, 2, g, 3, g, -41)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, g, g, g, qb, 4, qb, 1, qb, 3, g, 2, g, -42)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, g, q, q, qb, 2, qb, 1, qb, 4, g, 3, g, -43)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, g, g, q, qb, 3, qb, 1, qb, 4, g, 2, g, -44)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, g, q, q, qb, 2, qb, 1, qb, 3, g, 4, g, -45)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, g, g, q, qb, 3, qb, 1, qb, 2, g, 4, g, -46)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 4, qb, 5, qb, 1, qb, 5, g, 4, g, -47)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 3, qb, 5, qb, 1, qb, 5, g, 2, g, -48)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 4, qb, 5, qb, 1, qb, 4, g, 5, g, -49)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 3, qb, 5, qb, 1, qb, 2, g, 5, g, -50)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 4, g, 4, qb, 1, qb, 5, g, 5, g, -51)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 3, g, 2, qb, 1, qb, 5, g, 5, g, -52)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, qb, g, g, qb, 4, qb, 2, qb, 1, g, 3, g, -53)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, qb, qb, g, qb, 4, qb, 3, qb, 1, g, 2, g, -54)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, qb, g, q, qb, 3, qb, 2, qb, 1, g, 4, g, -55)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 3, qb, 5, qb, 2, qb, 1, g, 5, g, -56)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, qb, g, g, qb, 4, qb, 2, qb, 3, g, 1, g, -57)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, qb, qb, g, qb, 4, qb, 3, qb, 2, g, 1, g, -58)));
        addSafe(new_ptr((Tree2toNDiagram(5), qb, qb, g, q, qb, 3, qb, 2, qb, 4, g, 1, g, -59)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 3, qb, 5, qb, 2, qb, 5, g, 1, g, -60)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 1, qb, 4, qb, 2, qb, 5, qb, 5, g, 4, g, -61)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 1, qb, 3, qb, 5, qb, 5, g, 2, g, -62)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 1, qb, 4, qb, 2, qb, 5, qb, 4, g, 5, g, -63)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, g, qb, 1, qb, 3, qb, 5, qb, 2, g, 5, g, -64)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 1, qb, 4, g, 2, qb, 4, qb, 5, g, 5, g, -65)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, qb, g, qb, 1, g, 3, qb, 2, qb, 5, g, 5, g, -66)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 1, qb, 2, qb, 5, qb, 3, g, 5, g, -67)));
        addSafe(new_ptr((Tree2toNDiagram(4), qb, g, q, qb, 1, qb, 2, qb, 5, qb, 5, g, 3, g, -68)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 1, qb, 4, qb, 5, qb, 4, g, 5, g, -69)));
        addSafe(new_ptr((Tree2toNDiagram(3), qb, g, qb, 2, qb, 1, qb, 4, qb, 5, qb, 5, g, 4, g, -70)));
      }
    }  
  }  
}
...
Selector <MEBase::DiagramIndex> NLOJetMEkbqb2kbqbgg::diagrams(const DiagramVector & diags) const {
  // select the diagram
  matchboxAmplitude()->prepareAmplitudes(this);

  static const int cv1at0[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv1at1[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv1at2[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv1at3[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv2at0[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv3at0[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv4at0[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv5at0[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv6at0[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv6at1[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv6at2[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv6at3[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv7at0[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv7at1[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv7at2[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv7at3[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv8at0[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv9at0[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv9at1[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv10at0[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv11at0[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv11at1[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv12at0[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv13at0[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv13at1[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv14at0[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv15at0[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv15at1[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv16at0[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv16at1[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv17at0[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv17at1[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv18at0[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv18at1[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv19at0[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv20at0[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv21at0[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv22at0[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv22at1[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv23at0[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv24at0[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv25at0[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv26at0[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv27at0[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv27at1[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv28at0[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv29at0[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv29at1[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv30at0[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv30at1[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv31at0[]  = { -1, 3, 4, 2, -999, 0, 1, -999};
  static const int cv31at1[]  = { -1, 4, 3, 2, -999, 0, 1, -999};
  static const int cv32at0[]  = { -1, 2, -999, 0, 3, 4, 1, -999};
  static const int cv33at0[]  = { -1, 2, -999, 0, 4, 3, 1, -999};
  static const int cv34at0[]  = { -1, 4, 2, -999, 0, 3, 1, -999};
  static const int cv35at0[]  = { -1, 3, 2, -999, 0, 4, 1, -999};
  static const int cv36at0[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv36at1[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv36at2[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv36at3[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv37at0[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv38at0[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv39at0[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv40at0[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv41at0[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv41at1[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv41at2[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv41at3[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv42at0[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv42at1[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv42at2[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv42at3[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv43at0[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv44at0[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv44at1[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv45at0[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv46at0[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv46at1[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv47at0[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv48at0[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv48at1[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv49at0[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv50at0[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv50at1[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv51at0[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv51at1[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv52at0[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv52at1[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv53at0[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv53at1[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv54at0[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv55at0[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv56at0[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv57at0[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv57at1[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv58at0[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv59at0[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv60at0[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv61at0[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv62at0[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
  static const int cv62at1[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv63at0[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv64at0[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv64at1[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv65at0[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv65at1[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv66at0[]  = { -1, 3, 4, 1, -999, 0, 2, -999};
  static const int cv66at1[]  = { -1, 4, 3, 1, -999, 0, 2, -999};
  static const int cv67at0[]  = { -1, 1, -999, 0, 3, 4, 2, -999};
  static const int cv68at0[]  = { -1, 1, -999, 0, 4, 3, 2, -999};
  static const int cv69at0[]  = { -1, 3, 1, -999, 0, 4, 2, -999};
  static const int cv70at0[]  = { -1, 4, 1, -999, 0, 3, 2, -999};
...
Selector<const ColourLines *> NLOJetMEkbqb2kbqbgg::colourGeometries(tcDiagPtr diag) const {
  // colour lines for NLOJetMEkbqb2kbqbgg

  static const ColourLines diag1[4] = { 
    ColourLines("-1 -2 -3 -7, -4 3 -5 -8, -6 2 5 9, 8 -9"), 
    ColourLines("-1 -2 -3 -7, -4 3 -5 -9, -6 2 5 8, -8 9"), 
    ColourLines("-1 -2 -5 -8, -4 3 2 -6, -7 -3 5 9, 8 -9"), 
    ColourLines("-1 -2 -5 -9, -4 3 2 -6, -7 -3 5 8, -8 9")
  }; 
  static const ColourLines diag2[1] = { 
    ColourLines("-1 -2 -5 -9, -4 -8, -6 2 3 8, -7 9")
  }; 
  static const ColourLines diag3[1] = { 
    ColourLines("-1 -2 -5 -8, -4 -9, -6 2 3 9, -7 8")
  }; 
  static const ColourLines diag4[1] = { 
    ColourLines("-1 -8, -4 3 -5 -9, -6 9, -7 -3 -2 8")
  }; 
  static const ColourLines diag5[1] = { 
    ColourLines("-1 -9, -4 3 -5 -8, -6 8, -7 -3 -2 9")
  }; 
  static const ColourLines diag6[4] = { 
    ColourLines("-1 -2 -3 -9, -5 4 3 -8, -6 2 8, -7 -4 9"), 
    ColourLines("-1 -2 -8, -5 4 3 2 -6, -7 -4 9, 8 -3 -9"), 
    ColourLines("-1 -2 -3 -4 -7, -5 4 -9, -6 2 8, -8 3 9"), 
    ColourLines("-1 -2 -8, -5 4 -9, -6 2 3 9, -7 -4 -3 8")
  }; 
  static const ColourLines diag7[4] = { 
    ColourLines("-1 -2 -3 -8, -5 4 3 -9, -6 2 9, -7 -4 8"), 
    ColourLines("-1 -2 -9, -5 4 3 2 -6, -7 -4 8, -8 -3 9"), 
    ColourLines("-1 -2 -3 -4 -7, -5 4 -8, -6 2 9, 8 3 -9"), 
    ColourLines("-1 -2 -9, -5 4 -8, -6 2 3 8, -7 -4 -3 9")
  }; 
  static const ColourLines diag8[1] = { 
    ColourLines("-1 -2 -7, -5 -8, -6 2 3 9, 8 4 -9")
  }; 
  static const ColourLines diag9[2] = { 
    ColourLines("-1 -2 -3 -7, -5 -8, -6 2 9, 8 4 3 -9"), 
    ColourLines("-1 -2 -9, -5 -8, -6 2 3 4 8, -7 -3 9")
  }; 
  static const ColourLines diag10[1] = { 
    ColourLines("-1 -2 -7, -5 -9, -6 2 3 8, -8 4 9")
  }; 
  static const ColourLines diag11[2] = { 
    ColourLines("-1 -2 -3 -7, -5 -9, -6 2 8, -8 3 4 9"), 
    ColourLines("-1 -2 -8, -5 -9, -6 2 3 4 9, -7 -3 8")
  }; 
  static const ColourLines diag12[1] = { 
    ColourLines("-1 -2 -4 -9, -3 2 -6, -7 8, -8 -5 9")
  }; 
  static const ColourLines diag13[2] = { 
    ColourLines("-1 -2 -3 -5 -8, -4 3 -9, -6 2 9, -7 8"), 
    ColourLines("-1 -2 -9, -4 3 2 -6, -7 8, -8 -5 -3 9")
  }; 
  static const ColourLines diag14[1] = { 
    ColourLines("-1 -2 -4 -8, -3 2 -6, -7 9, 8 -5 -9")
  }; 
  static const ColourLines diag15[2] = { 
    ColourLines("-1 -2 -3 -5 -9, -4 3 -8, -6 2 8, -7 9"), 
    ColourLines("-1 -2 -8, -4 3 2 -6, -7 9, 8 -3 -5 -9")
  }; 
  static const ColourLines diag16[2] = { 
    ColourLines("-1 -2 -4 -5 -8, -3 2 -6, -7 5 9, 8 -9"), 
    ColourLines("-1 -2 -4 -5 -9, -3 2 -6, -7 5 8, -8 9")
  }; 
  static const ColourLines diag17[2] = { 
    ColourLines("-1 -2 -7, -4 -5 -8, -6 2 3 5 9, 8 -9"), 
    ColourLines("-1 -2 -7, -4 -5 -9, -6 2 3 5 8, -8 9")
  }; 
  static const ColourLines diag18[2] = { 
    ColourLines("-1 -8, -5 4 3 -6, -7 -4 9, 8 -2 -3 -9"), 
    ColourLines("-1 -8, -5 4 -9, -6 3 9, -7 -4 -3 -2 8")
  }; 
  static const ColourLines diag19[1] = { 
    ColourLines("-1 -8, -5 4 -6, -7 -4 -3 9, 8 -2 -9")
  }; 
  static const ColourLines diag20[1] = { 
    ColourLines("-1 -8, -5 -9, -6 3 4 9, -7 -3 -2 8")
  }; 
  static const ColourLines diag21[1] = { 
    ColourLines("-1 -8, -4 3 -6, -7 9, 8 -2 -3 -5 -9")
  }; 
  static const ColourLines diag22[2] = { 
    ColourLines("-1 -9, -5 4 3 -6, -7 -4 8, -8 -3 -2 9"), 
    ColourLines("-1 -9, -5 4 -8, -6 3 8, -7 -4 -3 -2 9")
  }; 
  static const ColourLines diag23[1] = { 
    ColourLines("-1 -9, -5 4 -6, -7 -4 -3 8, -8 -2 9")
  }; 
  static const ColourLines diag24[1] = { 
    ColourLines("-1 -9, -5 -8, -6 3 4 8, -7 -3 -2 9")
  }; 
  static const ColourLines diag25[1] = { 
    ColourLines("-1 -9, -4 3 -6, -7 8, -8 -5 -3 -2 9")
  }; 
  static const ColourLines diag26[1] = { 
    ColourLines("-1 -2 -7, -3 2 -4 -9, -6 8, -8 -5 9")
  }; 
  static const ColourLines diag27[2] = { 
    ColourLines("-1 -2 -9, -4 3 2 -5 -8, -6 8, -7 -3 9"), 
    ColourLines("-1 -2 -3 -7, -4 3 -9, -6 8, -8 -5 2 9")
  }; 
  static const ColourLines diag28[1] = { 
    ColourLines("-1 -2 -7, -3 2 -4 -8, -6 9, 8 -5 -9")
  }; 
  static const ColourLines diag29[2] = { 
    ColourLines("-1 -2 -8, -4 3 2 -5 -9, -6 9, -7 -3 8"), 
    ColourLines("-1 -2 -3 -7, -4 3 -8, -6 9, 8 2 -5 -9")
  }; 
  static const ColourLines diag30[2] = { 
    ColourLines("-1 -2 -7, -3 2 -4 -5 -8, -6 5 9, 8 -9"), 
    ColourLines("-1 -2 -7, -3 2 -4 -5 -9, -6 5 8, -8 9")
  }; 
  static const ColourLines diag31[2] = { 
    ColourLines("-1 -5 -8, -4 3 -6, -7 -3 -2 5 9, 8 -9"), 
    ColourLines("-1 -5 -9, -4 3 -6, -7 -3 -2 5 8, -8 9")
  }; 
  static const ColourLines diag32[1] = { 
    ColourLines("-1 -2 -7, -4 -8, -6 9, 8 3 2 -5 -9")
  }; 
  static const ColourLines diag33[1] = { 
    ColourLines("-1 -2 -7, -4 -9, -6 8, -8 -5 2 3 9")
  }; 
  static const ColourLines diag34[1] = { 
    ColourLines("-1 -2 -5 -9, -3 2 -4 -8, -6 8, -7 9")
  }; 
  static const ColourLines diag35[1] = { 
    ColourLines("-1 -2 -5 -8, -3 2 -4 -9, -6 9, -7 8")
  }; 
  static const ColourLines diag36[4] = { 
    ColourLines("-1 -2 -3 -6, -4 3 -5 -8, -7 2 5 9, 8 -9"), 
    ColourLines("-1 -2 -3 -6, -4 3 -5 -9, -7 2 5 8, -8 9"), 
    ColourLines("-1 -2 -5 -8, -4 3 2 -7, -6 -3 5 9, 8 -9"), 
    ColourLines("-1 -2 -5 -9, -4 3 2 -7, -6 -3 5 8, -8 9")
  }; 
  static const ColourLines diag37[1] = { 
    ColourLines("-1 -2 -5 -9, -4 -8, -6 9, -7 2 3 8")
  }; 
  static const ColourLines diag38[1] = { 
    ColourLines("-1 -2 -5 -8, -4 -9, -6 8, -7 2 3 9")
  }; 
  static const ColourLines diag39[1] = { 
    ColourLines("-1 -8, -4 3 -5 -9, -6 -3 -2 8, -7 9")
  }; 
  static const ColourLines diag40[1] = { 
    ColourLines("-1 -9, -4 3 -5 -8, -6 -3 -2 9, -7 8")
  }; 
  static const ColourLines diag41[4] = { 
    ColourLines("-1 -2 -3 -9, -5 4 3 -8, -6 -4 9, -7 2 8"), 
    ColourLines("-1 -2 -8, -5 4 3 2 -7, -6 -4 9, 8 -3 -9"), 
    ColourLines("-1 -2 -3 -4 -6, -5 4 -9, -7 2 8, -8 3 9"), 
    ColourLines("-1 -2 -8, -5 4 -9, -6 -4 -3 8, -7 2 3 9")
  }; 
  static const ColourLines diag42[4] = { 
    ColourLines("-1 -2 -3 -8, -5 4 3 -9, -6 -4 8, -7 2 9"), 
    ColourLines("-1 -2 -9, -5 4 3 2 -7, -6 -4 8, -8 -3 9"), 
    ColourLines("-1 -2 -3 -4 -6, -5 4 -8, -7 2 9, 8 3 -9"), 
    ColourLines("-1 -2 -9, -5 4 -8, -6 -4 -3 9, -7 2 3 8")
  }; 
  static const ColourLines diag43[1] = { 
    ColourLines("-1 -2 -6, -5 -8, -7 2 3 9, 8 4 -9")
  }; 
  static const ColourLines diag44[2] = { 
    ColourLines("-1 -2 -3 -6, -5 -8, -7 2 9, 8 4 3 -9"), 
    ColourLines("-1 -2 -9, -5 -8, -6 -3 9, -7 2 3 4 8")
  }; 
  static const ColourLines diag45[1] = { 
    ColourLines("-1 -2 -6, -5 -9, -7 2 3 8, -8 4 9")
  }; 
  static const ColourLines diag46[2] = { 
    ColourLines("-1 -2 -3 -6, -5 -9, -7 2 8, -8 3 4 9"), 
    ColourLines("-1 -2 -8, -5 -9, -6 -3 8, -7 2 3 4 9")
  }; 
  static const ColourLines diag47[1] = { 
    ColourLines("-1 -2 -4 -9, -3 2 -7, -6 8, -8 -5 9")
  }; 
  static const ColourLines diag48[2] = { 
    ColourLines("-1 -2 -3 -5 -8, -4 3 -9, -6 8, -7 2 9"), 
    ColourLines("-1 -2 -9, -4 3 2 -7, -6 8, -8 -5 -3 9")
  }; 
  static const ColourLines diag49[1] = { 
    ColourLines("-1 -2 -4 -8, -3 2 -7, -6 9, 8 -5 -9")
  }; 
  static const ColourLines diag50[2] = { 
    ColourLines("-1 -2 -3 -5 -9, -4 3 -8, -6 9, -7 2 8"), 
    ColourLines("-1 -2 -8, -4 3 2 -7, -6 9, 8 -3 -5 -9")
  }; 
  static const ColourLines diag51[2] = { 
    ColourLines("-1 -2 -4 -5 -8, -3 2 -7, -6 5 9, 8 -9"), 
    ColourLines("-1 -2 -4 -5 -9, -3 2 -7, -6 5 8, -8 9")
  }; 
  static const ColourLines diag52[2] = { 
    ColourLines("-1 -2 -6, -4 -5 -8, -7 2 3 5 9, 8 -9"), 
    ColourLines("-1 -2 -6, -4 -5 -9, -7 2 3 5 8, -8 9")
  }; 
  static const ColourLines diag53[2] = { 
    ColourLines("-1 -8, -5 4 3 -7, -6 -4 9, 8 -2 -3 -9"), 
    ColourLines("-1 -8, -5 4 -9, -6 -4 -3 -2 8, -7 3 9")
  }; 
  static const ColourLines diag54[1] = { 
    ColourLines("-1 -8, -5 4 -7, -6 -4 -3 9, 8 -2 -9")
  }; 
  static const ColourLines diag55[1] = { 
    ColourLines("-1 -8, -5 -9, -6 -3 -2 8, -7 3 4 9")
  }; 
  static const ColourLines diag56[1] = { 
    ColourLines("-1 -8, -4 3 -7, -6 9, 8 -2 -3 -5 -9")
  }; 
  static const ColourLines diag57[2] = { 
    ColourLines("-1 -9, -5 4 3 -7, -6 -4 8, -8 -3 -2 9"), 
    ColourLines("-1 -9, -5 4 -8, -6 -4 -3 -2 9, -7 3 8")
  }; 
  static const ColourLines diag58[1] = { 
    ColourLines("-1 -9, -5 4 -7, -6 -4 -3 8, -8 -2 9")
  }; 
  static const ColourLines diag59[1] = { 
    ColourLines("-1 -9, -5 -8, -6 -3 -2 9, -7 3 4 8")
  }; 
  static const ColourLines diag60[1] = { 
    ColourLines("-1 -9, -4 3 -7, -6 8, -8 -5 -3 -2 9")
  }; 
  static const ColourLines diag61[1] = { 
    ColourLines("-1 -2 -6, -3 2 -4 -9, -7 8, -8 -5 9")
  }; 
  static const ColourLines diag62[2] = { 
    ColourLines("-1 -2 -9, -4 3 2 -5 -8, -6 -3 9, -7 8"), 
    ColourLines("-1 -2 -3 -6, -4 3 -9, -7 8, -8 -5 2 9")
  }; 
  static const ColourLines diag63[1] = { 
    ColourLines("-1 -2 -6, -3 2 -4 -8, -7 9, 8 -5 -9")
  }; 
  static const ColourLines diag64[2] = { 
    ColourLines("-1 -2 -8, -4 3 2 -5 -9, -6 -3 8, -7 9"), 
    ColourLines("-1 -2 -3 -6, -4 3 -8, -7 9, 8 2 -5 -9")
  }; 
  static const ColourLines diag65[2] = { 
    ColourLines("-1 -2 -6, -3 2 -4 -5 -8, -7 5 9, 8 -9"), 
    ColourLines("-1 -2 -6, -3 2 -4 -5 -9, -7 5 8, -8 9")
  }; 
  static const ColourLines diag66[2] = { 
    ColourLines("-1 -5 -8, -4 3 -7, -6 -3 -2 5 9, 8 -9"), 
    ColourLines("-1 -5 -9, -4 3 -7, -6 -3 -2 5 8, -8 9")
  }; 
  static const ColourLines diag67[1] = { 
    ColourLines("-1 -2 -6, -4 -8, -7 9, 8 3 2 -5 -9")
  }; 
  static const ColourLines diag68[1] = { 
    ColourLines("-1 -2 -6, -4 -9, -7 8, -8 -5 2 3 9")
  }; 
  static const ColourLines diag69[1] = { 
    ColourLines("-1 -2 -4 -8, -3 2 -5 -9, -6 8, -7 9")
  }; 
  static const ColourLines diag70[1] = { 
    ColourLines("-1 -2 -4 -9, -3 2 -5 -8, -6 9, -7 8")
  }; 
