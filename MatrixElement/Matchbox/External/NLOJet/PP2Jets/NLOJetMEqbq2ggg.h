// -*- C++ -*-
//
// NLOJetMEqbq2ggg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEqbq2ggg_H
#define HERWIG_NLOJetMEqbq2ggg_H
//
// This is the declaration of the NLOJetMEqbq2ggg class.
//
 ...
 *
 * \brief NLOJetMEqbq2ggg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEqbq2gggInterfaces "The interfaces"
 * defined for NLOJetMEqbq2ggg.
 */
class NLOJetMEqbq2ggg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEqbq2ggg & operator=(const NLOJetMEqbq2ggg &);

};

}

#endif /* HERWIG_NLOJetMEqbq2ggg_H */
