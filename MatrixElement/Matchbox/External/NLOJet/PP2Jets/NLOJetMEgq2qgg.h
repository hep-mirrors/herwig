// -*- C++ -*-
//
// NLOJetMEgq2qgg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEgq2qgg_H
#define HERWIG_NLOJetMEgq2qgg_H
//
// This is the declaration of the NLOJetMEgq2qgg class.
//
 ...
 *
 * \brief NLOJetMEgq2qgg This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEgq2qggInterfaces "The interfaces"
 * defined for NLOJetMEgq2qgg.
 */
class NLOJetMEgq2qgg: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEgq2qgg & operator=(const NLOJetMEgq2qgg &);

};

}

#endif /* HERWIG_NLOJetMEgq2qgg_H */
