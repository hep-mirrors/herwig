// -*- C++ -*-
//
// NLOJetMEkqb2kqb.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_NLOJetMEkqb2kqb_H
#define HERWIG_NLOJetMEkqb2kqb_H
//
// This is the declaration of the NLOJetMEkqb2kqb class.
//
 ...
 *
 * \brief NLOJetMEkqb2kqb This code has been produced automatically
 * using ConvDiag written by Jan Kotanski.
 *
 * @see \ref NLOJetMEkqb2kqbInterfaces "The interfaces"
 * defined for NLOJetMEkqb2kqb.
 */
class NLOJetMEkqb2kqb: public NLOJetMEBase<0,2,0> {
...
private:
   ...
   */
  NLOJetMEkqb2kqb & operator=(const NLOJetMEkqb2kqb &);

};

}

#endif /* HERWIG_NLOJetMEkqb2kqb_H */
