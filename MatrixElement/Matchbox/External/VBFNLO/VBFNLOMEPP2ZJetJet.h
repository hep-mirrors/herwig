// -*- C++ -*-
//
// VBFNLOMEPP2ZJetJet.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_VBFNLOMEPP2ZJetJet_H
#define HERWIG_VBFNLOMEPP2ZJetJet_H
//
// This is the declaration of the VBFNLOMEPP2ZJetJet class.
//
 ...
 * \author Ken Arnold
 *
 * VBFNLOMEPP2ZJetJet is the concrete implementation of an interface to
 * the PP -> Z0 Jet Jet matrix element of VBFNLO.
 *
 * @see \ref VBFNLOMEPP2ZJetJetInterfaces "The interfaces"
 * defined for VBFNLOMEPP2ZJetJet.
 */
class VBFNLOMEPP2ZJetJet: public VBFNLOMEVVJJNeutralBase {
...
private:
   ...
   */
  static ClassDescription<VBFNLOMEPP2ZJetJet> initVBFNLOMEPP2ZJetJet;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  VBFNLOMEPP2ZJetJet & operator=(const VBFNLOMEPP2ZJetJet &);
 ...
 *  base classes of VBFNLOMEPP2ZJetJet. */
template <>
struct BaseClassTrait<Herwig::VBFNLOMEPP2ZJetJet,1> {
  /** Typedef of the first base class of VBFNLOMEPP2ZJetJet. */
  typedef Herwig::VBFNLOMEVVJJNeutralBase NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the VBFNLOMEPP2ZJetJet class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::VBFNLOMEPP2ZJetJet>
  : public ClassTraitsBase<Herwig::VBFNLOMEPP2ZJetJet> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::VBFNLOMEPP2ZJetJet"; }
  /**
   * The name of a file containing the dynamic library where the class
   * VBFNLOMEPP2ZJetJet is implemented. It may also include several, space-separated,
   * libraries if the class VBFNLOMEPP2ZJetJet depends on other classes (base classes
...
#endif /* HERWIG_VBFNLOMEPP2ZJetJet_H */
