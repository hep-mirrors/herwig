...
#include "DC_Hjjj_NC_qqB.h"

using namespace Herwig;

IBPtr DC_Hjjj_NC_qqB::clone() const {
  return new_ptr(*this);
}
IBPtr DC_Hjjj_NC_qqB::fullclone() const {
  return new_ptr(*this);
}

vector<DiagPtr> DC_Hjjj_NC_qqB::getDiagrams() const {
  ...
  for (int genU = 0; genU < 2; genU++) {
    for (int genL = 0; genL < 2; genL++) {
      ...
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qd, Z0, Z0, kd, kdB, 1, qd, 3, kdB, 4, g, 2, h0, -1)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qd, Z0, Z0, kdB, 3, kdB, 1, qd, 5, kdB, 5, g, 2, h0, -2)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qd, qd, Z0, Z0, kdB, 2, qd, 4, kdB, 1, g, 3, h0, -3)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qd, Z0, Z0, kdB, 1, qd, 5, qd, 3, kdB, 5, g, 2, h0, -4)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qd, Z0, Z0, ku, kuB, 1, qd, 3, kuB, 4, g, 2, h0, -5)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qd, Z0, Z0, kuB, 3, kuB, 1, qd, 5, kuB, 5, g, 2, h0, -6)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qd, qd, Z0, Z0, kuB, 2, qd, 4, kuB, 1, g, 3, h0, -7)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qd, Z0, Z0, kuB, 1, qd, 5, qd, 3, kuB, 5, g, 2, h0, -8)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qu, Z0, Z0, kd, kdB, 1, qu, 3, kdB, 4, g, 2, h0, -9)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qu, Z0, Z0, kdB, 3, kdB, 1, qu, 5, kdB, 5, g, 2, h0, -10)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qu, qu, Z0, Z0, kdB, 2, qu, 4, kdB, 1, g, 3, h0, -11)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qu, Z0, Z0, kdB, 1, qu, 5, qu, 3, kdB, 5, g, 2, h0, -12)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qu, Z0, Z0, ku, kuB, 1, qu, 3, kuB, 4, g, 2, h0, -13)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qu, Z0, Z0, kuB, 3, kuB, 1, qu, 5, kuB, 5, g, 2, h0, -14)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qu, qu, Z0, Z0, kuB, 2, qu, 4, kuB, 1, g, 3, h0, -15)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qu, Z0, Z0, kuB, 1, qu, 5, qu, 3, kuB, 5, g, 2, h0, -16)));
    }
  }
...
Selector<const ColourLines *> DC_Hjjj_NC_qqB::colourGeometries(tcDiagPtr diag) const {
  // colour lines for DC_Hjjj_NC_qqB
