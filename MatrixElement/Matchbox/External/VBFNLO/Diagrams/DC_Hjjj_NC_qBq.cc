...
#include "DC_Hjjj_NC_qBq.h"

using namespace Herwig;

IBPtr DC_Hjjj_NC_qBq::clone() const {
  return new_ptr(*this);
}
IBPtr DC_Hjjj_NC_qBq::fullclone() const {
  return new_ptr(*this);
}

vector<DiagPtr> DC_Hjjj_NC_qBq::getDiagrams() const {
  ...
  for (int genU = 0; genU < 2; genU++) {
    for (int genL = 0; genL < 2; genL++) {
      ...
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qdB, Z0, Z0, kdB, kd, 1, qdB, 3, kd, 4, g, 2, h0, -1)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qdB, Z0, Z0, kd, 3, kd, 1, qdB, 5, kd, 5, g, 2, h0, -2)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qdB, qdB, Z0, Z0, kd, 2, qdB, 4, kd, 1, g, 3, h0, -3)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qdB, Z0, Z0, kd, 1, qdB, 5, qdB, 3, kd, 5, g, 2, h0, -4)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qdB, Z0, Z0, kuB, ku, 1, qdB, 3, ku, 4, g, 2, h0, -5)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qdB, Z0, Z0, ku, 3, ku, 1, qdB, 5, ku, 5, g, 2, h0, -6)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), qdB, qdB, Z0, Z0, ku, 2, qdB, 4, ku, 1, g, 3, h0, -7)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), qdB, Z0, Z0, ku, 1, qdB, 5, qdB, 3, ku, 5, g, 2, h0, -8)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), quB, Z0, Z0, kdB, kd, 1, quB, 3, kd, 4, g, 2, h0, -9)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), quB, Z0, Z0, kd, 3, kd, 1, quB, 5, kd, 5, g, 2, h0, -10)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), quB, quB, Z0, Z0, kd, 2, quB, 4, kd, 1, g, 3, h0, -11)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), quB, Z0, Z0, kd, 1, quB, 5, quB, 3, kd, 5, g, 2, h0, -12)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), quB, Z0, Z0, kuB, ku, 1, quB, 3, ku, 4, g, 2, h0, -13)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), quB, Z0, Z0, ku, 3, ku, 1, quB, 5, ku, 5, g, 2, h0, -14)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(5), quB, quB, Z0, Z0, ku, 2, quB, 4, ku, 1, g, 3, h0, -15)));
      allPossibleDiagrams.push_back(new_ptr((Tree2toNDiagram(4), quB, Z0, Z0, ku, 1, quB, 5, quB, 3, ku, 5, g, 2, h0, -16)));
    }
  }
...
Selector<const ColourLines *> DC_Hjjj_NC_qBq::colourGeometries(tcDiagPtr diag) const {
  // colour lines for DC_Hjjj_NC_qBq
