// -*- C++ -*-
//
// VBFNLOAmplitudeqq2hqqg.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_VBFNLOAmplitudeqq2hqqg_H
#define HERWIG_VBFNLOAmplitudeqq2hqqg_H
//
// This is the declaration of the VBFNLOAmplitudeqq2hqqg class.
//
 ...
 * \author Ken Arnold
 *
 * VBFNLOAmplitudeqq2hqqg is the concrete implementation of an interface to
 * the PP -> Higgs Jet Jet matrix element of VBFNLO.
 *
 * @see \ref VBFNLOAmplitudeqq2hqqgInterfaces "The interfaces"
 * defined for VBFNLOAmplitudeqq2hqqg.
 */
class VBFNLOAmplitudeqq2hqqg: public VBFNLOAmplitudePP2hJetJetJet {
...
public:
   ...
   * The destructor.
   */
  virtual ~VBFNLOAmplitudeqq2hqqg();
  //@}
...
private:
   ...
   */
  static ClassDescription<VBFNLOAmplitudeqq2hqqg> initVBFNLOAmplitudeqq2hqqg;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  VBFNLOAmplitudeqq2hqqg & operator=(const VBFNLOAmplitudeqq2hqqg &);
 ...
 *  base classes of VBFNLOAmplitudeqq2hqqg. */
template <>
struct BaseClassTrait<Herwig::VBFNLOAmplitudeqq2hqqg,1> {
  /** Typedef of the first base class of VBFNLOAmplitudeqq2hqqg. */
  typedef Herwig::VBFNLOAmplitudePP2hJetJetJet NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the VBFNLOAmplitudeqq2hqqg class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::VBFNLOAmplitudeqq2hqqg>
  : public ClassTraitsBase<Herwig::VBFNLOAmplitudeqq2hqqg> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::VBFNLOAmplitudeqq2hqqg"; }
  /**
   * The name of a file containing the dynamic library where the class
   * VBFNLOAmplitudeqq2hqqg is implemented. It may also include several, space-separated,
   * libraries if the class VBFNLOAmplitudeqq2hqqg depends on other classes (base classes
...
#endif /* HERWIG_VBFNLOAmplitudeqq2hqqg_H */
