// -*- C++ -*-
//
// VBFNLOMEPP2hJetJet.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2007 The Herwig Collaboration
//
// Herwig++ is licenced under version 2 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_VBFNLOMEPP2hJetJet_H
#define HERWIG_VBFNLOMEPP2hJetJet_H
//
// This is the declaration of the VBFNLOMEPP2hJetJet class.
//
 ...
 * \author Ken Arnold
 *
 * VBFNLOMEPP2hJetJet is the concrete implementation of an interface to
 * the PP -> Higgs Jet Jet matrix element of VBFNLO.
 *
 * @see \ref VBFNLOMEPP2hJetJetInterfaces "The interfaces"
 * defined for VBFNLOMEPP2hJetJet.
 */
class VBFNLOMEPP2hJetJet: public VBFNLOMEVVJJNeutralBase {
...
public:
   ...
   * The default constructor.
   */
  VBFNLOMEPP2hJetJet(int, bool, bool, int, bool);

  /**
   * The destructor.
   */
  virtual ~VBFNLOMEPP2hJetJet();
  //@}
...
private:
   ...
   */
  static ClassDescription<VBFNLOMEPP2hJetJet> initVBFNLOMEPP2hJetJet;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  VBFNLOMEPP2hJetJet & operator=(const VBFNLOMEPP2hJetJet &);
 ...
 *  base classes of VBFNLOMEPP2hJetJet. */
template <>
struct BaseClassTrait<Herwig::VBFNLOMEPP2hJetJet,1> {
  /** Typedef of the first base class of VBFNLOMEPP2hJetJet. */
  typedef Herwig::VBFNLOMEVVJJNeutralBase NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the VBFNLOMEPP2hJetJet class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::VBFNLOMEPP2hJetJet>
  : public ClassTraitsBase<Herwig::VBFNLOMEPP2hJetJet> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::VBFNLOMEPP2hJetJet"; }
  /**
   * The name of a file containing the dynamic library where the class
   * VBFNLOMEPP2hJetJet is implemented. It may also include several, space-separated,
   * libraries if the class VBFNLOMEPP2hJetJet depends on other classes (base classes
...
#endif /* HERWIG_VBFNLOMEPP2hJetJet_H */
