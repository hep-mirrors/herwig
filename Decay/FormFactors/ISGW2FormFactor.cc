...
void ISGW2FormFactor::dataBaseOutput(ofstream & output,bool header,bool create) const {
  ...
  output << "set " << name() << ":Beta1S0ud " << _beta1S0ud/GeV  << "\n";
  output << "set " << name() << ":Beta1S0us " << _beta1S0us/GeV  << "\n";
  output << "set " << name() << ":Beta1S0ss " << _beta1S0ss/GeV  << "\n";
  output << "set " << name() << ":Beta1S0cu " << _beta1S0cu/GeV  << "\n";
  output << "set " << name() << ":Beta1S0cs " << _beta1S0cs/GeV  << "\n";
  output << "set " << name() << ":Beta1S0ub " << _beta1S0ub/GeV  << "\n";
  output << "set " << name() << ":Beta1S0sb " << _beta1S0sb/GeV  << "\n";
  output << "set " << name() << ":Beta1S0cc " << _beta1S0cc/GeV  << "\n";
  output << "set " << name() << ":Beta1S0bc " << _beta1S0bc/GeV  << "\n";
  output << "set " << name() << ":Beta1Pud  " << _beta1Pud/GeV   << "\n";
  output << "set " << name() << ":Beta1Pus  " << _beta1Pus/GeV   << "\n";
  output << "set " << name() << ":Beta1Pss  " << _beta1Pss/GeV   << "\n";
  output << "set " << name() << ":Beta1Pcu  " << _beta1Pcu/GeV   << "\n";
  output << "set " << name() << ":Beta1Pcs  " << _beta1Pcs/GeV   << "\n";
  output << "set " << name() << ":Beta1Pub  " << _beta1Pub/GeV   << "\n";
  output << "set " << name() << ":Beta1Psb  " << _beta1Psb/GeV   << "\n";
  output << "set " << name() << ":Beta1Pcc  " << _beta1Pcc/GeV   << "\n";
  output << "set " << name() << ":Beta1Pbc  " << _beta1Pbc/GeV   << "\n";
  output << "set " << name() << ":Beta3S1ud " << _beta3S1ud/GeV  << "\n";
  output << "set " << name() << ":Beta3S1us " << _beta3S1us/GeV  << "\n";
  output << "set " << name() << ":Beta3S1ss " << _beta3S1ss/GeV  << "\n";
  output << "set " << name() << ":Beta3S1cu " << _beta3S1cu/GeV  << "\n";
  output << "set " << name() << ":Beta3S1cs " << _beta3S1cs/GeV  << "\n";
  output << "set " << name() << ":Beta3S1ub " << _beta3S1ub/GeV  << "\n";
  output << "set " << name() << ":Beta3S1sb " << _beta3S1sb/GeV  << "\n";
  output << "set " << name() << ":Beta3S1cc " << _beta3S1cc/GeV  << "\n";
  output << "set " << name() << ":Beta3S1bc " << _beta3S1bc/GeV  << "\n";
  output << "set " << name() << ":AlphaCutOff " << _alphamuQM    << "\n";
  output << "set " << name() << ":CfDrho "      << _CfDrho       << "\n";
  output << "set " << name() << ":CfDKstar "    << _CfDKstar     << "\n";
  output << "set " << name() << ":CfDsKstar "   << _CfDsKstar    << "\n";
  output << "set " << name() << ":CfDsphi "     << _CfDsphi      << "\n";
  output << "set " << name() << ":CfBrho "      << _CfBrho       << "\n";
  output << "set " << name() << ":CfBDstar "    << _CfBDstar     << "\n";
  output << "set " << name() << ":CfBsKstar "   << _CfBsKstar    << "\n";
  output << "set " << name() << ":CfBsDstar "   << _CfBsDstar    << "\n";
  output << "set " << name() << ":CfBcDstar "   << _CfBcDstar    << "\n";
  output << "set " << name() << ":CfBcpsi "     << _CfBcpsi      << "\n";
  output << "set " << name() << ":CfBcBsstar "  << _CfBcBsstar   << "\n";
  output << "set " << name() << ":CfBcBstar "   << _CfBcBstar    << "\n";
