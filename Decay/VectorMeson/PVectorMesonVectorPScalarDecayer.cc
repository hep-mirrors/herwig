...
PVectorMesonVectorPScalarDecayer::PVectorMesonVectorPScalarDecayer() 
  ...
  _coupling[1] = 4.051/GeV; _maxweight[1] = 11.; 
  ...
  _coupling[37] = 1.993/GeV; _maxweight[37] = 3.; 
