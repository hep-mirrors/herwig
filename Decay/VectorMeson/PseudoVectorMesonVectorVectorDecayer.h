 ...
 *
 * @see DecayIntegrator.
 * @see \ref PseudoVectorMesonVectorVectorDecayerInterfaces "The interfaces"
 * defined for PseudoVectorMesonVectorVectorDecayer.
 */
class PseudoVectorMesonVectorVectorDecayer: public DecayIntegrator {
...
private:
   ...
   */
  PseudoVectorMesonVectorVectorDecayer & operator=(const PseudoVectorMesonVectorVectorDecayer &) = delete;
...
#endif /* HERWIG_PseudoVectorMesonVectorVectorDecayer_H */
