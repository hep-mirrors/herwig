...
void SU3BaryonSingletOctetPhotonDecayer::doinit() throw(InitException) {
...
ClassDescription<SU3BaryonSingletOctetPhotonDecayer> 
SU3BaryonSingletOctetPhotonDecayer::initSU3BaryonSingletOctetPhotonDecayer;
