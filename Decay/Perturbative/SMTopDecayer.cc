...
void SMTopDecayer::Init() {
  ...
  static Parameter<SMTopDecayer,Energy> interfacepTmin
    ("pTmin",
     "Minimum transverse momentum from gluon radiation",
     &SMTopDecayer::pTmin_, GeV, 1.0*GeV, 0.0*GeV, 10.0*GeV,
     false, false, Interface::limited);
}
...
RealEmissionProcessPtr SMTopDecayer::generateHardest(RealEmissionProcessPtr born) {
...
vector<Lorentz5Momentum>  SMTopDecayer::hardMomenta() {
  double C    = 6.3;
  double ymax = 10.;
  double ymin = -ymax;
...
double SMTopDecayer::matrixElementRatio( 
...
bool SMTopDecayer::calcMomenta(int j, Energy pT, double y, double phi,
...
bool SMTopDecayer::psCheck(double xg, double xw) {
