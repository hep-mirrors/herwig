// -*- C++ -*-
//
// PseudoTensorMesonVectorVectorDecayer.h is a part of Herwig - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2019 The Herwig Collaboration
//
// Herwig is licenced under version 3 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_PseudoTensorMesonVectorVectorDecayer_H
#define HERWIG_PseudoTensorMesonVectorVectorDecayer_H
//
// This is the declaration of the PseudoTensorMesonVectorVectorDecayer class.
//
 ...
 *
 * @see DecayIntegrator
 * @see \ref PseudoTensorMesonVectorVectorDecayerInterfaces "The interfaces"
 * defined for PseudoTensorMesonVectorVectorDecayer.
 */
class PseudoTensorMesonVectorVectorDecayer: public DecayIntegrator {
...
#endif /* HERWIG_PseudoTensorMesonVectorVectorDecayer_H */
