// -*- C++ -*-
//
// PseudoTensorMesonTensorVectorDecayer.h is a part of Herwig - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2019 The Herwig Collaboration
//
// Herwig is licenced under version 3 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_PseudoTensorMesonTensorVectorDecayer_H
#define HERWIG_PseudoTensorMesonTensorVectorDecayer_H
//
// This is the declaration of the PseudoTensorMesonTensorVectorDecayer class.
//
...
/** \ingroup Decay
 *
 *  The <code>PseudoTensorMesonTensorVectorDecayer</code> class handles the decay of
 ...
 *
 * @see DecayIntegrator
 * @see \ref PseudoTensorMesonTensorVectorDecayerInterfaces "The interfaces"
 * defined for PseudoTensorMesonTensorVectorDecayer.
 */
class PseudoTensorMesonTensorVectorDecayer: public DecayIntegrator {
...
#endif /* HERWIG_PseudoTensorMesonTensorVectorDecayer_H */
