// -*- C++ -*-
//
// TensorMesonTensorPScalarDecayer.h is a part of Herwig - A multi-purpose Monte Carlo event generator
// Copyright (C) 2002-2019 The Herwig Collaboration
//
// Herwig is licenced under version 3 of the GPL, see COPYING for details.
// Please respect the MCnet academic guidelines, see GUIDELINES for details.
//
#ifndef HERWIG_TensorMesonTensorPScalarDecayer_H
#define HERWIG_TensorMesonTensorPScalarDecayer_H
//
// This is the declaration of the TensorMesonTensorPScalarDecayer class.
//
...
/** \ingroup Decay
 *
 *  The <code>TensorMesonTensorPScalarDecayer</code> class handles the decay of
 ...
 *
 * @see DecayIntegrator
 * @see \ref TensorMesonTensorPScalarDecayerInterfaces "The interfaces"
 * defined for TensorMesonTensorPScalarDecayer.
 */
class TensorMesonTensorPScalarDecayer: public DecayIntegrator {
...
private:
   ...
   */
  TensorMesonTensorPScalarDecayer & operator=(const TensorMesonTensorPScalarDecayer &) = delete;
...
#endif /* HERWIG_TensorMesonTensorPScalarDecayer_H */
