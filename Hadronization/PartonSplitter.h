...
private:
   ...
   */
  vector<int> colSingletSize;

  /**
   *   Vector that stores the masses of the colour-singlets or of a colourless
   *   particle
   */
  vector<Energy2> colSingletm2;

  /**
   *   Method to calculate the mass/lambda measure of a colour singlet
   */
  Energy2 singletMass2(const Lorentz5Momentum& pIn);
