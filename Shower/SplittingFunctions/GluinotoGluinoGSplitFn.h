// -*- C++ -*-
//
// GluinotoGluinoGSplitFn.h is a part of Herwig++ - A multi-purpose Monte Carlo event generator
...
public:
   ...
   */
  inline GluinotoGluinoGSplitFn() : SplittingFunction(ShowerInteraction::QCD,1) {}
