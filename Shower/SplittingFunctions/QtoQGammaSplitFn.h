 ...
 * \f[P(z,t) = Q^2\left(\frac{1+z^2}{1-z}-2\frac{m^2_q}{t}\right),\f]
 * where \f$Q\f$ is the electric charge of the particle.
 * Our choice for the overestimate is 
 * \f[P_{\rm over}(z) = \frac{2Q^2}{1-z},\f]
 * therefore the integral is
 * \f[\int P_{\rm over}(z) {\rm d}z = -2Q^2\ln(1-z),\f]
 * and its inverse is
 * \f[1-\exp\left(\frac{r}{2Q^2}\right).\f]
 *
 *
