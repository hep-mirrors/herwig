...
public:
  ...
  // products is created and filled.  Note that only <I>alpha</I> and
  // <I>p_perp</I> can be reconstructed at this moment and we will
  // obtain beta only later, using <!id>updateParent()<!!id>
