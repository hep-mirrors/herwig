...
private:
  ...
  static ClassDescription<FS_QtoQGSplitFun> initFS_QtoQGSplitFun;
...
// base class of FS_QtoQGSplitFun.
template <>
struct BaseClassTrait<Herwig::FS_QtoQGSplitFun,1> {
...
template <>
struct ClassTraits<Herwig::FS_QtoQGSplitFun>: public ClassTraitsBase<Herwig::FS_QtoQGSplitFun> {
  static string className() { return "/Herwig++/FS_QtoQGSplitFun"; }
