...
describeHerwigQtoQP3D1SplitFn("Herwig::QtoQP3D1SplitFn", "HwOniumShower.so HwOniumParameters.so");
...
void QtoQP3D1SplitFn::Init() {
  ...
  static Parameter<QtoQP3D1SplitFn,Energy7> interfaceO1
    ("O1",
     "The colour singlet excpetation value",
     &QtoQP3D1SplitFn::O1_, GeV*GeV2*GeV2*GeV2, 0.131*GeV*GeV2*GeV2*GeV2, 0.0*GeV*GeV2*GeV2*GeV2, 10.0*GeV*GeV2*GeV2*GeV2,
