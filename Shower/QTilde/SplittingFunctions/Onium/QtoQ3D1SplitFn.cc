...
void QtoQ3D1SplitFn::doinit() {
  Sudakov1to2FormFactor::doinit();
  O1_ = params_->singletME<2>(state_,n_,1,1);
}

// The following static variable is needed for the type
// description system in ThePEG.
DescribeClass<QtoQ3D1SplitFn,Sudakov1to2FormFactor>
describeHerwigQtoQ3D1SplitFn("Herwig::QtoQ3D1SplitFn", "HwOniumShower.so HwOniumParameters.so");
...
void QtoQ3D1SplitFn::Init() {
  ...
  static Reference<QtoQ3D1SplitFn,OniumParameters> interfaceParameters
    ("Parameters",
     "Quarkonium parameters",
     &QtoQ3D1SplitFn::params_, false, false, true, false, false);
  ...
  static Switch<QtoQ3D1SplitFn,OniumState> interfaceState
    ("State",
     "The type of onium state",
     &QtoQ3D1SplitFn::state_, ccbar, false, false);
