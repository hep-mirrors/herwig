// -*- C++ -*-
#ifndef Herwig_Gto3P2OctetSplitFn_H
#define Herwig_Gto3P2OctetSplitFn_H
//
// This is the declaration of the Gto3P2OctetSplitFn class.
//
...
/**
 * The Gto3P2OctetSplitFn class implements the \f$1\to1\f$ octet splitting \f$g\to J\Psi,\Upsilon\f$
 *
 * @see \ref Gto3P2OctetSplitFnInterfaces "The interfaces"
 * defined for Gto3P2OctetSplitFn.
 */
class Gto3P2OctetSplitFn: public SudakovFormFactor {
...
public:
   ...
   */
  Gto3P2OctetSplitFn() : O8_(0.015*GeV2*GeV), state_(ccbar), n_(1),
...
private:
   ...
   */
  Gto3P2OctetSplitFn & operator=(const Gto3P2OctetSplitFn &) = delete;
...
#endif /* Herwig_Gto3P2OctetSplitFn_H */
