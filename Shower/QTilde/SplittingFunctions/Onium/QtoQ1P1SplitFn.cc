...
void QtoQ1P1SplitFn::doinit() {
  Sudakov1to2FormFactor::doinit();
  O1_ = params_->singletME<1>(state_,n_,0,1);
}

// The following static variable is needed for the type
// description system in ThePEG.
DescribeClass<QtoQ1P1SplitFn,Sudakov1to2FormFactor>
describeHerwigQtoQ1P1SplitFn("Herwig::QtoQ1P1SplitFn", "HwOniumShower.so HwOniumParameters.so");
...
void QtoQ1P1SplitFn::Init() {
  ...
  static Reference<QtoQ1P1SplitFn,OniumParameters> interfaceParameters
    ("Parameters",
     "Quarkonium parameters",
     &QtoQ1P1SplitFn::params_, false, false, true, false, false);
  ...
  static Switch<QtoQ1P1SplitFn,OniumState> interfaceState
    ("State",
     "The type of onium state",
     &QtoQ1P1SplitFn::state_, ccbar, false, false);
