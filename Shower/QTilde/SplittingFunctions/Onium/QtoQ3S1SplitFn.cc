...
void QtoQ3S1SplitFn::doinit() {
  Sudakov1to2FormFactor::doinit();
  O1_ = params_->singletME<0>(state_,n_,1,1);
}

// The following static variable is needed for the type
// description system in ThePEG.
DescribeClass<QtoQ3S1SplitFn,Sudakov1to2FormFactor>
describeHerwigQtoQ3S1SplitFn("Herwig::QtoQ3S1SplitFn", "HwOniumShower.so HwOniumParameters.so");
...
void QtoQ3S1SplitFn::Init() {
  ...
  static Reference<QtoQ3S1SplitFn,OniumParameters> interfaceParameters
    ("Parameters",
     "Quarkonium parameters",
     &QtoQ3S1SplitFn::params_, false, false, true, false, false);
  ...
  static Switch<QtoQ3S1SplitFn,OniumState> interfaceState
    ("State",
     "The type of onium state",
     &QtoQ3S1SplitFn::state_, ccbar, false, false);
