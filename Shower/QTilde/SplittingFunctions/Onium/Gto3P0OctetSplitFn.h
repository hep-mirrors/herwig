// -*- C++ -*-
#ifndef Herwig_Gto3P0OctetSplitFn_H
#define Herwig_Gto3P0OctetSplitFn_H
//
// This is the declaration of the Gto3P0OctetSplitFn class.
//
...
/**
 * The Gto3P0OctetSplitFn class implements the \f$1\to1\f$ octet splitting \f$g\to J\Psi,\Upsilon\f$
 *
 * @see \ref Gto3P0OctetSplitFnInterfaces "The interfaces"
 * defined for Gto3P0OctetSplitFn.
 */
class Gto3P0OctetSplitFn: public SudakovFormFactor {
...
public:
   ...
   */
  Gto3P0OctetSplitFn() : O8_(0.015*GeV2*GeV), state_(ccbar), n_(1),
...
private:
   ...
   */
  Gto3P0OctetSplitFn & operator=(const Gto3P0OctetSplitFn &) = delete;
...
#endif /* Herwig_Gto3P0OctetSplitFn_H */
