...
describeHerwigQtoQ3P0SplitFn("Herwig::QtoQ3P0SplitFn", "HwOniumShower.so");
...
void QtoQ3P0SplitFn::Init() {
  ...
  static Parameter<QtoQ3P0SplitFn,Energy5> interfaceO1
    ("O1",
     "The colour singlet excpetation value",
     &QtoQ3P0SplitFn::O1_, GeV*GeV2*GeV2, 0.794*GeV*GeV2*GeV2, 0.0*GeV*GeV2*GeV2, 10.0*GeV*GeV2*GeV2,
