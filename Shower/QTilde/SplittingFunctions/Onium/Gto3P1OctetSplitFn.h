// -*- C++ -*-
#ifndef Herwig_Gto3P1OctetSplitFn_H
#define Herwig_Gto3P1OctetSplitFn_H
//
// This is the declaration of the Gto3P1OctetSplitFn class.
//
...
/**
 * The Gto3P1OctetSplitFn class implements the \f$1\to1\f$ octet splitting \f$g\to J\Psi,\Upsilon\f$
 *
 * @see \ref Gto3P1OctetSplitFnInterfaces "The interfaces"
 * defined for Gto3P1OctetSplitFn.
 */
class Gto3P1OctetSplitFn: public SudakovFormFactor {
...
public:
   ...
   */
  Gto3P1OctetSplitFn() : O8_(0.015*GeV2*GeV), state_(ccbar), n_(1),
...
private:
   ...
   */
  Gto3P1OctetSplitFn & operator=(const Gto3P1OctetSplitFn &) = delete;
...
#endif /* Herwig_Gto3P1OctetSplitFn_H */
