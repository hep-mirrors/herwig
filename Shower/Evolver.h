...
public:
  ...
  // subprocess. The <!id>ParticleCollisionHandler<!!id> object is needed to 
  // access the PDF. If <!id>skipKinReco<!!id> is true, then the kinematics 
  ...
  // The <!id>ParticleCollisionHandler<!!id> object is needed to access the 
  // PDF. If <!id>skipKinReco<!!id> is true, then the kinematics 
  // reconstruction is skipped.
