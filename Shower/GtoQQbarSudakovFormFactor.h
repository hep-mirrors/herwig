...
private:
  ...
  static ClassDescription<GtoQQbarSudakovFormFactor> initGtoQQbarSudakovFormFactor;
...
// base class of GtoQQbarSudakovFormFactor.
template <>
struct BaseClassTrait<Herwig::GtoQQbarSudakovFormFactor,1> {
...
template <>
struct ClassTraits<Herwig::GtoQQbarSudakovFormFactor>: public ClassTraitsBase<Herwig::GtoQQbarSudakovFormFactor> {
  static string className() { return "/Herwig++/GtoQQbarSudakovFormFactor"; }
