// -*- C++ -*-
#ifndef HERWIG_VBFHardGenerator_H
#define HERWIG_VBFHardGenerator_H
//
// This is the declaration of the VBFHardGenerator class.
//
 ...
 */
class VBFHardGenerator: public HardestEmissionGenerator {
...
private:
   ...
   */
  static ClassDescription<VBFHardGenerator> initVBFHardGenerator;

  /**
   * The assignment operator is private and must never be called.
   * In fact, it should not even be implemented.
   */
  VBFHardGenerator & operator=(const VBFHardGenerator &);
 ...
 *  base classes of VBFHardGenerator. */
template <>
struct BaseClassTrait<Herwig::VBFHardGenerator,1> {
  /** Typedef of the first base class of VBFHardGenerator. */
  typedef Herwig::HardestEmissionGenerator NthBase;
};

/** This template specialization informs ThePEG about the name of
 *  the VBFHardGenerator class and the shared object where it is defined. */
template <>
struct ClassTraits<Herwig::VBFHardGenerator>
  : public ClassTraitsBase<Herwig::VBFHardGenerator> {
  /** Return a platform-independent class name */
  static string className() { return "Herwig::VBFHardGenerator"; }
  /**
   * The name of a file containing the dynamic library where the class
   * VBFHardGenerator is implemented. It may also include several, space-separated,
   * libraries if the class VBFHardGenerator depends on other classes (base classes
...
#endif /* HERWIG_VBFHardGenerator_H */
